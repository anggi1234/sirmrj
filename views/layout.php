...
<script>
loadjs(ew.PATH_BASE + "timepicker/jquery.timepicker.min.css");
ew.ready("head", [ew.PATH_BASE + "timepicker/jquery.timepicker.min.js", ew.PATH_BASE + "js/ewtimepicker.js"], "timepicker");
</script>
<!-- Navbar -->
...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/hospital.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/hospital.ico">
    ...
    <nav class="<?= Config("NAVBAR_CLASS") ?>">
        ...
        <ul id="ew-navbar" class="navbar-nav">
            ...
            <a class="navbar-brand d-none" href="#"  onclick="return false;">
                <span class="brand-text"><i class="fa fa-chain-broken" aria-hidden="true"></i> Sistem Informasi</span>
            </a>
        </ul>
        <!-- Right navbar links -->

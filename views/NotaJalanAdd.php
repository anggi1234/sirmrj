...
loadjs.ready("head", function () {
    ...
    fnota_jalanadd = currentForm = new ew.Form("fnota_jalanadd", "add");
    ...
    // Validate form
    fnota_jalanadd.validate = function () {
    ...
    // Form_CustomValidate
    fnota_jalanadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fnota_jalanadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fnota_jalanadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fnota_jalanadd" id="fnota_jalanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fnota_jalanadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fnota_jalanadd", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fnota_jalanadd", "timepicker"], function() {
    ew.createTimePicker("fnota_jalanadd", "x_jam", {"timeFormat":"H:i:s","step":15});
});
</script>
<?php } ?>
</span>

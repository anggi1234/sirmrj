...
// Page object
$DiagnosaPasienAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fdiagnosa_pasienadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fdiagnosa_pasienadd = currentForm = new ew.Form("fdiagnosa_pasienadd", "add");
    ...
    // Validate form
    fdiagnosa_pasienadd.validate = function () {
    ...
    // Form_CustomValidate
    fdiagnosa_pasienadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fdiagnosa_pasienadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fdiagnosa_pasienadd.lists.kd_penyakit = <?= $Page->kd_penyakit->toClientList($Page) ?>;
    fdiagnosa_pasienadd.lists.status = <?= $Page->status->toClientList($Page) ?>;
    fdiagnosa_pasienadd.lists.status_penyakit = <?= $Page->status_penyakit->toClientList($Page) ?>;
    fdiagnosa_pasienadd.lists.kd_icd9 = <?= $Page->kd_icd9->toClientList($Page) ?>;
    loadjs.done("fdiagnosa_pasienadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fdiagnosa_pasienadd" id="fdiagnosa_pasienadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">

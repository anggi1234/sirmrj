...
loadjs.ready("head", function () {
    ...
    fm_icd9edit = currentForm = new ew.Form("fm_icd9edit", "edit");
    ...
    // Form_CustomValidate
    fm_icd9edit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fm_icd9edit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fm_icd9edit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fm_icd9edit" id="fm_icd9edit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="m_icd9" data-field="x_kode" data-hidden="1" name="o_kode" id="o_kode" value="<?= HtmlEncode($Page->kode->OldValue ?? $Page->kode->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>

...
// Page object
$CatatanPasienAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcatatan_pasienadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcatatan_pasienadd = currentForm = new ew.Form("fcatatan_pasienadd", "add");
    ...
    // Validate form
    fcatatan_pasienadd.validate = function () {
    ...
    // Form_CustomValidate
    fcatatan_pasienadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcatatan_pasienadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcatatan_pasienadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcatatan_pasienadd" id="fcatatan_pasienadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">

...
// Page object
$PenilaianMedisIgdEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpenilaian_medis_igdedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fpenilaian_medis_igdedit = currentForm = new ew.Form("fpenilaian_medis_igdedit", "edit");
    ...
    fpenilaian_medis_igdedit.addFields([
        ["id_penilaian_medis_igd", [fields.id_penilaian_medis_igd.visible && fields.id_penilaian_medis_igd.required ? ew.Validators.required(fields.id_penilaian_medis_igd.caption) : null], fields.id_penilaian_medis_igd.isInvalid],
    ...
    // Set invalid fields
    $(function() {
        var f = fpenilaian_medis_igdedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fpenilaian_medis_igdedit.validate = function () {
    ...
    // Form_CustomValidate
    fpenilaian_medis_igdedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpenilaian_medis_igdedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpenilaian_medis_igdedit.lists.anamnesis = <?= $Page->anamnesis->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.keadaan = <?= $Page->keadaan->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.kesadaran = <?= $Page->kesadaran->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.kepala = <?= $Page->kepala->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.mata = <?= $Page->mata->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.gigi = <?= $Page->gigi->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.leher = <?= $Page->leher->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.thoraks = <?= $Page->thoraks->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.abdomen = <?= $Page->abdomen->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.genital = <?= $Page->genital->toClientList($Page) ?>;
    fpenilaian_medis_igdedit.lists.ekstremitas = <?= $Page->ekstremitas->toClientList($Page) ?>;
    loadjs.done("fpenilaian_medis_igdedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpenilaian_medis_igdedit" id="fpenilaian_medis_igdedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id_penilaian_medis_igd->Visible) { // id_penilaian_medis_igd ?>
    <div id="r_id_penilaian_medis_igd" class="form-group row">
        <label id="elh_penilaian_medis_igd_id_penilaian_medis_igd" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_penilaian_medis_igd->caption() ?><?= $Page->id_penilaian_medis_igd->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_penilaian_medis_igd->cellAttributes() ?>>
<span id="el_penilaian_medis_igd_id_penilaian_medis_igd">
<span<?= $Page->id_penilaian_medis_igd->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id_penilaian_medis_igd->getDisplayValue($Page->id_penilaian_medis_igd->EditValue))) ?>"></span>
</span>
<input type="hidden" data-table="penilaian_medis_igd" data-field="x_id_penilaian_medis_igd" data-hidden="1" name="x_id_penilaian_medis_igd" id="x_id_penilaian_medis_igd" value="<?= HtmlEncode($Page->id_penilaian_medis_igd->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>

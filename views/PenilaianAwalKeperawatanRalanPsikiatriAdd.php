...
// Page object
$PenilaianAwalKeperawatanRalanPsikiatriAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpenilaian_awal_keperawatan_ralan_psikiatriadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpenilaian_awal_keperawatan_ralan_psikiatriadd = currentForm = new ew.Form("fpenilaian_awal_keperawatan_ralan_psikiatriadd", "add");
    ...
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpenilaian_awal_keperawatan_ralan_psikiatriadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.validate = function () {
    ...
    // Form_CustomValidate
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.informasi = <?= $Page->informasi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rkd_berobat = <?= $Page->rkd_berobat->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rkd_hasil_pengobatan = <?= $Page->rkd_hasil_pengobatan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.fp_putus_obat = <?= $Page->fp_putus_obat->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.fp_ekonomi = <?= $Page->fp_ekonomi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.fp_masalah_fisik = <?= $Page->fp_masalah_fisik->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.fp_masalah_psikososial = <?= $Page->fp_masalah_psikososial->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rh_keluarga = <?= $Page->rh_keluarga->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.resiko_bunuh_diri = <?= $Page->resiko_bunuh_diri->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rbd_ide = <?= $Page->rbd_ide->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rbd_rencana = <?= $Page->rbd_rencana->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rbd_alat = <?= $Page->rbd_alat->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rbd_percobaan = <?= $Page->rbd_percobaan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rbd_keinginan = <?= $Page->rbd_keinginan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rpo_penggunaan = <?= $Page->rpo_penggunaan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rpo_efek_samping = <?= $Page->rpo_efek_samping->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rpo_napza = <?= $Page->rpo_napza->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rpo_penggunaan_obat_lainnya = <?= $Page->rpo_penggunaan_obat_lainnya->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rpo_alergi_obat = <?= $Page->rpo_alergi_obat->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rpo_merokok = <?= $Page->rpo_merokok->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.rpo_minum_kopi = <?= $Page->rpo_minum_kopi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.pf_keluhan_fisik = <?= $Page->pf_keluhan_fisik->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.skala_nyeri = <?= $Page->skala_nyeri->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.nyeri = <?= $Page->nyeri->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.provokes = <?= $Page->provokes->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.quality = <?= $Page->quality->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.menyebar = <?= $Page->menyebar->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.pada_dokter = <?= $Page->pada_dokter->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.nyeri_hilang = <?= $Page->nyeri_hilang->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.lapor_status_nutrisi = <?= $Page->lapor_status_nutrisi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sg1 = <?= $Page->sg1->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.nilai1 = <?= $Page->nilai1->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sg2 = <?= $Page->sg2->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.nilai2 = <?= $Page->nilai2->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.resikojatuh = <?= $Page->resikojatuh->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.bjm = <?= $Page->bjm->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.msa = <?= $Page->msa->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.hasil = <?= $Page->hasil->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.lapor = <?= $Page->lapor->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.adl_mandi = <?= $Page->adl_mandi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.adl_berpakaian = <?= $Page->adl_berpakaian->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.adl_makan = <?= $Page->adl_makan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.adl_bak = <?= $Page->adl_bak->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.adl_bab = <?= $Page->adl_bab->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.adl_hobi = <?= $Page->adl_hobi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.adl_sosialisasi = <?= $Page->adl_sosialisasi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.adl_kegiatan = <?= $Page->adl_kegiatan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_penampilan = <?= $Page->sk_penampilan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_alam_perasaan = <?= $Page->sk_alam_perasaan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_pembicaraan = <?= $Page->sk_pembicaraan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_afek = <?= $Page->sk_afek->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_aktifitas_motorik = <?= $Page->sk_aktifitas_motorik->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_gangguan_ringan = <?= $Page->sk_gangguan_ringan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_proses_pikir = <?= $Page->sk_proses_pikir->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_orientasi = <?= $Page->sk_orientasi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_tingkat_kesadaran_orientasi = <?= $Page->sk_tingkat_kesadaran_orientasi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_memori = <?= $Page->sk_memori->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_interaksi = <?= $Page->sk_interaksi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_konsentrasi = <?= $Page->sk_konsentrasi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_persepsi = <?= $Page->sk_persepsi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_isi_pikir = <?= $Page->sk_isi_pikir->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_waham = <?= $Page->sk_waham->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.sk_daya_tilik_diri = <?= $Page->sk_daya_tilik_diri->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.kk_pembelajaran = <?= $Page->kk_pembelajaran->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.ket_kk_pembelajaran = <?= $Page->ket_kk_pembelajaran->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.kk_Penerjamah = <?= $Page->kk_Penerjamah->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.kk_bahasa_isyarat = <?= $Page->kk_bahasa_isyarat->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralan_psikiatriadd.lists.kk_kebutuhan_edukasi = <?= $Page->kk_kebutuhan_edukasi->toClientList($Page) ?>;
    loadjs.done("fpenilaian_awal_keperawatan_ralan_psikiatriadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpenilaian_awal_keperawatan_ralan_psikiatriadd" id="fpenilaian_awal_keperawatan_ralan_psikiatriadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpenilaian_awal_keperawatan_ralan_psikiatriadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenilaian_awal_keperawatan_ralan_psikiatriadd", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->nilai2->isInvalidClass() ?>" data-table="penilaian_awal_keperawatan_ralan_psikiatri" data-field="x_nilai2" name="x_nilai2[]" id="x_nilai2_689630" value="1"<?= ConvertToBool($Page->nilai2->CurrentValue) ? " checked" : "" ?><?= $Page->nilai2->editAttributes() ?> aria-describedby="x_nilai2_help">
    <label class="custom-control-label" for="x_nilai2_689630"></label>
</div>

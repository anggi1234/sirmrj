...
loadjs.ready("head", function () {
    ...
    fvrajalview = currentForm = new ew.Form("fvrajalview", "view");
    loadjs.done("fvrajalview");
});
</script>
<script>
loadjs.ready("head", function () {
...
<?php } ?>
<script>
if (!ew.vars.tables.vrajal) ew.vars.tables.vrajal = <?= JsonEncode(GetClientVar("tables", "vrajal")) ?>;
</script>
<?php if (!$Page->isExport()) { ?>
...
$Page->showMessage();
?>
<form name="fvrajalview" id="fvrajalview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id_reg->Visible) { // id_reg ?>
    <tr id="r_id_reg">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_vrajal_id_reg"><?= $Page->id_reg->caption() ?></span></td>
...
<?php if ($Page->no_rkm_medis->Visible) { // no_rkm_medis ?>
    <tr id="r_no_rkm_medis">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_vrajal_no_rkm_medis"><?= $Page->no_rkm_medis->caption() ?></span></td>
...
<?php if ($Page->kd_poli->Visible) { // kd_poli ?>
    <tr id="r_kd_poli">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_vrajal_kd_poli"><?= $Page->kd_poli->caption() ?></span></td>
...
<?php if ($Page->kd_dokter->Visible) { // kd_dokter ?>
    <tr id="r_kd_dokter">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_vrajal_kd_dokter"><?= $Page->kd_dokter->caption() ?></span></td>
...
<?php if ($Page->tgl_registrasi->Visible) { // tgl_registrasi ?>
    <tr id="r_tgl_registrasi">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_vrajal_tgl_registrasi"><?= $Page->tgl_registrasi->caption() ?></span></td>
...
<?php if ($Page->stts->Visible) { // stts ?>
    <tr id="r_stts">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_vrajal_stts"><?= $Page->stts->caption() ?></span></td>
...
<?php if ($Page->umurdaftar->Visible) { // umurdaftar ?>
    <tr id="r_umurdaftar">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_vrajal_umurdaftar"><?= $Page->umurdaftar->caption() ?></span></td>
...
<?php if ($Page->cetak->Visible) { // cetak ?>
    <tr id="r_cetak">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_vrajal_cetak"><?= $Page->cetak->caption() ?></span></td>
...
?>
<?php
    if (in_array("cppt", explode(",", $Page->getCurrentDetailTable())) && $cppt->DetailView) {
...
?>
<?php
    if (in_array("billing", explode(",", $Page->getCurrentDetailTable())) && $billing->DetailView) {
...
?>
<?php
    if (in_array("konsul", explode(",", $Page->getCurrentDetailTable())) && $konsul->DetailView) {
...
?>
<?php
    if (in_array("resep_dokter", explode(",", $Page->getCurrentDetailTable())) && $resep_dokter->DetailView) {
...
?>
<?php
    if (in_array("prmrj", explode(",", $Page->getCurrentDetailTable())) && $prmrj->DetailView) {

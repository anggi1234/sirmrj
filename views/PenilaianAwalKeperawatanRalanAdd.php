...
// Page object
$PenilaianAwalKeperawatanRalanAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpenilaian_awal_keperawatan_ralanadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpenilaian_awal_keperawatan_ralanadd = currentForm = new ew.Form("fpenilaian_awal_keperawatan_ralanadd", "add");
    ...
    fpenilaian_awal_keperawatan_ralanadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpenilaian_awal_keperawatan_ralanadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fpenilaian_awal_keperawatan_ralanadd.validate = function () {
    ...
    // Form_CustomValidate
    fpenilaian_awal_keperawatan_ralanadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpenilaian_awal_keperawatan_ralanadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpenilaian_awal_keperawatan_ralanadd.lists.informasi = <?= $Page->informasi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.alat_bantu = <?= $Page->alat_bantu->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.prothesa = <?= $Page->prothesa->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.adl = <?= $Page->adl->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.status_psiko = <?= $Page->status_psiko->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.hub_keluarga = <?= $Page->hub_keluarga->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.tinggal_dengan = <?= $Page->tinggal_dengan->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.ekonomi = <?= $Page->ekonomi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.budaya = <?= $Page->budaya->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.edukasi = <?= $Page->edukasi->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.berjalan_a = <?= $Page->berjalan_a->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.berjalan_b = <?= $Page->berjalan_b->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.berjalan_c = <?= $Page->berjalan_c->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.hasil = <?= $Page->hasil->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.lapor = <?= $Page->lapor->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.sg1 = <?= $Page->sg1->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.nilai1 = <?= $Page->nilai1->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.sg2 = <?= $Page->sg2->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.nilai2 = <?= $Page->nilai2->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.nyeri = <?= $Page->nyeri->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.provokes = <?= $Page->provokes->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.quality = <?= $Page->quality->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.menyebar = <?= $Page->menyebar->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.skala_nyeri = <?= $Page->skala_nyeri->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.nyeri_hilang = <?= $Page->nyeri_hilang->toClientList($Page) ?>;
    fpenilaian_awal_keperawatan_ralanadd.lists.pada_dokter = <?= $Page->pada_dokter->toClientList($Page) ?>;
    loadjs.done("fpenilaian_awal_keperawatan_ralanadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpenilaian_awal_keperawatan_ralanadd" id="fpenilaian_awal_keperawatan_ralanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<div class="custom-control custom-checkbox d-inline-block">
    <input type="checkbox" class="custom-control-input<?= $Page->nilai2->isInvalidClass() ?>" data-table="penilaian_awal_keperawatan_ralan" data-field="x_nilai2" name="x_nilai2[]" id="x_nilai2_824806" value="1"<?= ConvertToBool($Page->nilai2->CurrentValue) ? " checked" : "" ?><?= $Page->nilai2->editAttributes() ?> aria-describedby="x_nilai2_help">
    <label class="custom-control-label" for="x_nilai2_824806"></label>
</div>
...
<?php } ?>
    ...
    <?php if (strval($Page->no_rawat->getSessionValue()) != "") { ?>
    <input type="hidden" name="x_no_rawat" id="x_no_rawat" value="<?= HtmlEncode(strval($Page->no_rawat->getSessionValue())) ?>">
    <?php } ?>
<?php if (!$Page->IsModal) { ?>

...
// Page object
$PenilaianMedisRalanAnakAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpenilaian_medis_ralan_anakadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fpenilaian_medis_ralan_anakadd = currentForm = new ew.Form("fpenilaian_medis_ralan_anakadd", "add");
    ...
    fpenilaian_medis_ralan_anakadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpenilaian_medis_ralan_anakadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fpenilaian_medis_ralan_anakadd.validate = function () {
    ...
    // Form_CustomValidate
    fpenilaian_medis_ralan_anakadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpenilaian_medis_ralan_anakadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpenilaian_medis_ralan_anakadd.lists.anamnesis = <?= $Page->anamnesis->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.keadaan = <?= $Page->keadaan->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.kesadaran = <?= $Page->kesadaran->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.kepala = <?= $Page->kepala->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.mata = <?= $Page->mata->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.gigi = <?= $Page->gigi->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.tht = <?= $Page->tht->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.thoraks = <?= $Page->thoraks->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.abdomen = <?= $Page->abdomen->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.genital = <?= $Page->genital->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.ekstremitas = <?= $Page->ekstremitas->toClientList($Page) ?>;
    fpenilaian_medis_ralan_anakadd.lists.kulit = <?= $Page->kulit->toClientList($Page) ?>;
    loadjs.done("fpenilaian_medis_ralan_anakadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpenilaian_medis_ralan_anakadd" id="fpenilaian_medis_ralan_anakadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpenilaian_medis_ralan_anakadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenilaian_medis_ralan_anakadd", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>

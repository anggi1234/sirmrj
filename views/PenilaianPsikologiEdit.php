...
// Page object
$PenilaianPsikologiEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fpenilaian_psikologiedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fpenilaian_psikologiedit = currentForm = new ew.Form("fpenilaian_psikologiedit", "edit");
    ...
    fpenilaian_psikologiedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fpenilaian_psikologiedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fpenilaian_psikologiedit.validate = function () {
    ...
    // Form_CustomValidate
    fpenilaian_psikologiedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpenilaian_psikologiedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fpenilaian_psikologiedit.lists.anamnesis = <?= $Page->anamnesis->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.dikirim_dari = <?= $Page->dikirim_dari->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.tujuan_pemeriksaan = <?= $Page->tujuan_pemeriksaan->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.rupa = <?= $Page->rupa->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.bentuk_tubuh = <?= $Page->bentuk_tubuh->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.tindakan = <?= $Page->tindakan->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.pakaian = <?= $Page->pakaian->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.ekspresi = <?= $Page->ekspresi->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.berbicara = <?= $Page->berbicara->toClientList($Page) ?>;
    fpenilaian_psikologiedit.lists.penggunaan_kata = <?= $Page->penggunaan_kata->toClientList($Page) ?>;
    loadjs.done("fpenilaian_psikologiedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpenilaian_psikologiedit" id="fpenilaian_psikologiedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fpenilaian_psikologiedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fpenilaian_psikologiedit", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php } ?>
    ...
    <input type="hidden" data-table="penilaian_psikologi" data-field="x_id_penilaian_psikologi" data-hidden="1" name="x_id_penilaian_psikologi" id="x_id_penilaian_psikologi" value="<?= HtmlEncode($Page->id_penilaian_psikologi->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>

...
loadjs.ready("head", function () {
    ...
    fvrajaladd = currentForm = new ew.Form("fvrajaladd", "add");
    ...
    // Form_CustomValidate
    fvrajaladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fvrajaladd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fvrajaladd.lists.no_rkm_medis = <?= $Page->no_rkm_medis->toClientList($Page) ?>;
    fvrajaladd.lists.kd_poli = <?= $Page->kd_poli->toClientList($Page) ?>;
    fvrajaladd.lists.kd_dokter = <?= $Page->kd_dokter->toClientList($Page) ?>;
    fvrajaladd.lists.stts = <?= $Page->stts->toClientList($Page) ?>;
    fvrajaladd.lists.stts_daftar = <?= $Page->stts_daftar->toClientList($Page) ?>;
    fvrajaladd.lists.status_lanjut = <?= $Page->status_lanjut->toClientList($Page) ?>;
    fvrajaladd.lists.sttsumur = <?= $Page->sttsumur->toClientList($Page) ?>;
    loadjs.done("fvrajaladd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fvrajaladd" id="fvrajaladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_vrajal_kd_dokter">
    <select
        ...
        data-select2-id="vrajal_x_kd_dokter"
        data-table="vrajal"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='vrajal_x_kd_dokter']"),
        options = { name: "x_kd_dokter", selectId: "vrajal_x_kd_dokter", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.vrajal.fields.kd_dokter.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.vrajal.fields.kd_dokter.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->p_jawab->Visible) { // p_jawab ?>
    <div id="r_p_jawab" class="form-group row">
        <label id="elh_vrajal_p_jawab" for="x_p_jawab" class="<?= $Page->LeftColumnClass ?>"><?= $Page->p_jawab->caption() ?><?= $Page->p_jawab->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->p_jawab->cellAttributes() ?>>
<span id="el_vrajal_p_jawab">
<input type="<?= $Page->p_jawab->getInputTextType() ?>" data-table="vrajal" data-field="x_p_jawab" name="x_p_jawab" id="x_p_jawab" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->p_jawab->getPlaceHolder()) ?>" value="<?= $Page->p_jawab->EditValue ?>"<?= $Page->p_jawab->editAttributes() ?> aria-describedby="x_p_jawab_help">
...
<?php if ($Page->hubunganpj->Visible) { // hubunganpj ?>
    <div id="r_hubunganpj" class="form-group row">
        <label id="elh_vrajal_hubunganpj" for="x_hubunganpj" class="<?= $Page->LeftColumnClass ?>"><?= $Page->hubunganpj->caption() ?><?= $Page->hubunganpj->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->hubunganpj->cellAttributes() ?>>
<span id="el_vrajal_hubunganpj">
<input type="<?= $Page->hubunganpj->getInputTextType() ?>" data-table="vrajal" data-field="x_hubunganpj" name="x_hubunganpj" id="x_hubunganpj" size="30" maxlength="20" placeholder="<?= HtmlEncode($Page->hubunganpj->getPlaceHolder()) ?>" value="<?= $Page->hubunganpj->EditValue ?>"<?= $Page->hubunganpj->editAttributes() ?> aria-describedby="x_hubunganpj_help">
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='vrajal_x_stts']"),
        options = { name: "x_stts", selectId: "vrajal_x_stts", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.vrajal.fields.stts.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.vrajal.fields.stts.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->stts_daftar->Visible) { // stts_daftar ?>
    <div id="r_stts_daftar" class="form-group row">
        <label id="elh_vrajal_stts_daftar" for="x_stts_daftar" class="<?= $Page->LeftColumnClass ?>"><?= $Page->stts_daftar->caption() ?><?= $Page->stts_daftar->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->stts_daftar->cellAttributes() ?>>
<span id="el_vrajal_stts_daftar">
    <select
        id="x_stts_daftar"
        name="x_stts_daftar"
        class="form-control ew-select<?= $Page->stts_daftar->isInvalidClass() ?>"
        data-select2-id="vrajal_x_stts_daftar"
        data-table="vrajal"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='vrajal_x_stts_daftar']"),
        options = { name: "x_stts_daftar", selectId: "vrajal_x_stts_daftar", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.vrajal.fields.stts_daftar.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.vrajal.fields.stts_daftar.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->status_lanjut->Visible) { // status_lanjut ?>
    <div id="r_status_lanjut" class="form-group row">
        <label id="elh_vrajal_status_lanjut" for="x_status_lanjut" class="<?= $Page->LeftColumnClass ?>"><?= $Page->status_lanjut->caption() ?><?= $Page->status_lanjut->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<span id="el_vrajal_status_lanjut">
    <select
        ...
        data-select2-id="vrajal_x_status_lanjut"
        data-table="vrajal"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='vrajal_x_status_lanjut']"),
        options = { name: "x_status_lanjut", selectId: "vrajal_x_status_lanjut", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.vrajal.fields.status_lanjut.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.vrajal.fields.status_lanjut.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<input type="<?= $Page->umurdaftar->getInputTextType() ?>" data-table="vrajal" data-field="x_umurdaftar" name="x_umurdaftar" id="x_umurdaftar" size="30" placeholder="<?= HtmlEncode($Page->umurdaftar->getPlaceHolder()) ?>" value="<?= $Page->umurdaftar->EditValue ?>"<?= $Page->umurdaftar->editAttributes() ?> aria-describedby="x_umurdaftar_help">
...
<?php if ($Page->sttsumur->Visible) { // sttsumur ?>
    <div id="r_sttsumur" class="form-group row">
        <label id="elh_vrajal_sttsumur" for="x_sttsumur" class="<?= $Page->LeftColumnClass ?>"><?= $Page->sttsumur->caption() ?><?= $Page->sttsumur->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->sttsumur->cellAttributes() ?>>
<span id="el_vrajal_sttsumur">
    <select
        id="x_sttsumur"
        name="x_sttsumur"
        class="form-control ew-select<?= $Page->sttsumur->isInvalidClass() ?>"
        data-select2-id="vrajal_x_sttsumur"
        data-table="vrajal"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='vrajal_x_sttsumur']"),
        options = { name: "x_sttsumur", selectId: "vrajal_x_sttsumur", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.data = ew.vars.tables.vrajal.fields.sttsumur.lookupOptions;
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.vrajal.fields.sttsumur.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
?>
<?php
    if (in_array("cppt", explode(",", $Page->getCurrentDetailTable())) && $cppt->DetailAdd) {
...
?>
<?php
    if (in_array("billing", explode(",", $Page->getCurrentDetailTable())) && $billing->DetailAdd) {
...
?>
<?php
    if (in_array("konsul", explode(",", $Page->getCurrentDetailTable())) && $konsul->DetailAdd) {
...
?>
<?php
    if (in_array("resep_dokter", explode(",", $Page->getCurrentDetailTable())) && $resep_dokter->DetailAdd) {
...
?>
<?php
    if (in_array("prmrj", explode(",", $Page->getCurrentDetailTable())) && $prmrj->DetailAdd) {

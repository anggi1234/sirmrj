...
// Page object
$TindakLanjutAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var ftindak_lanjutadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    ftindak_lanjutadd = currentForm = new ew.Form("ftindak_lanjutadd", "add");
    ...
    // Validate form
    ftindak_lanjutadd.validate = function () {
    ...
    // Form_CustomValidate
    ftindak_lanjutadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftindak_lanjutadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    ftindak_lanjutadd.lists.tindak_lanjut = <?= $Page->tindak_lanjut->toClientList($Page) ?>;
    loadjs.done("ftindak_lanjutadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="ftindak_lanjutadd" id="ftindak_lanjutadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["ftindak_lanjutadd", "datetimepicker"], function() {
    ew.createDateTimePicker("ftindak_lanjutadd", "x_tgl_kontrol", {"ignoreReadonly":true,"useCurrent":false,"format":7});
});
</script>
<?php } ?>
</span>

...
// Page object
$MasterPasienAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fmaster_pasienadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fmaster_pasienadd = currentForm = new ew.Form("fmaster_pasienadd", "add");
    ...
    // Validate form
    fmaster_pasienadd.validate = function () {
    ...
    // Form_CustomValidate
    fmaster_pasienadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmaster_pasienadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmaster_pasienadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmaster_pasienadd" id="fmaster_pasienadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fmaster_pasienadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fmaster_pasienadd", "x_tanggal_lahir", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmaster_pasienadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fmaster_pasienadd", "x_tgl_daftar", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>

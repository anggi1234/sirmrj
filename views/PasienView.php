...
<?php if ($Page->no_rkm_medis->Visible) { // no_rkm_medis ?>
    <tr id="r_no_rkm_medis">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_no_rkm_medis"><?= $Page->no_rkm_medis->caption() ?></span></td>
...
<?php if ($Page->nm_pasien->Visible) { // nm_pasien ?>
    <tr id="r_nm_pasien">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_nm_pasien"><?= $Page->nm_pasien->caption() ?></span></td>
...
<?php if ($Page->no_ktp->Visible) { // no_ktp ?>
    <tr id="r_no_ktp">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_no_ktp"><?= $Page->no_ktp->caption() ?></span></td>
...
<?php if ($Page->jk->Visible) { // jk ?>
    <tr id="r_jk">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_jk"><?= $Page->jk->caption() ?></span></td>
...
<?php if ($Page->tmp_lahir->Visible) { // tmp_lahir ?>
    <tr id="r_tmp_lahir">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_tmp_lahir"><?= $Page->tmp_lahir->caption() ?></span></td>
...
<?php if ($Page->tgl_lahir->Visible) { // tgl_lahir ?>
    <tr id="r_tgl_lahir">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_tgl_lahir"><?= $Page->tgl_lahir->caption() ?></span></td>
...
<?php if ($Page->nm_ibu->Visible) { // nm_ibu ?>
    <tr id="r_nm_ibu">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_nm_ibu"><?= $Page->nm_ibu->caption() ?></span></td>
...
<?php if ($Page->gol_darah->Visible) { // gol_darah ?>
    <tr id="r_gol_darah">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_gol_darah"><?= $Page->gol_darah->caption() ?></span></td>
...
<?php if ($Page->stts_nikah->Visible) { // stts_nikah ?>
    <tr id="r_stts_nikah">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_stts_nikah"><?= $Page->stts_nikah->caption() ?></span></td>
...
<?php if ($Page->tgl_daftar->Visible) { // tgl_daftar ?>
    <tr id="r_tgl_daftar">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_tgl_daftar"><?= $Page->tgl_daftar->caption() ?></span></td>
...
<?php if ($Page->pnd->Visible) { // pnd ?>
    <tr id="r_pnd">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_pnd"><?= $Page->pnd->caption() ?></span></td>
        <td data-name="pnd" <?= $Page->pnd->cellAttributes() ?>>
<span id="el_pasien_pnd">
<span<?= $Page->pnd->viewAttributes() ?>>
<?= $Page->pnd->getViewValue() ?></span>
</span>
</td>
    </tr>
<?php } ?>
<?php if ($Page->kd_pj->Visible) { // kd_pj ?>
    <tr id="r_kd_pj">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_kd_pj"><?= $Page->kd_pj->caption() ?></span></td>
...
<?php if ($Page->no_peserta->Visible) { // no_peserta ?>
    <tr id="r_no_peserta">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_no_peserta"><?= $Page->no_peserta->caption() ?></span></td>
...
<?php if ($Page->kd_kel->Visible) { // kd_kel ?>
    <tr id="r_kd_kel">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_kd_kel"><?= $Page->kd_kel->caption() ?></span></td>
...
<?php if ($Page->kd_kec->Visible) { // kd_kec ?>
    <tr id="r_kd_kec">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_kd_kec"><?= $Page->kd_kec->caption() ?></span></td>
...
<?php if ($Page->kd_kab->Visible) { // kd_kab ?>
    <tr id="r_kd_kab">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_kd_kab"><?= $Page->kd_kab->caption() ?></span></td>
...
<?php if ($Page->kd_prop->Visible) { // kd_prop ?>
    <tr id="r_kd_prop">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_kd_prop"><?= $Page->kd_prop->caption() ?></span></td>
...
<?php if ($Page->suku_bangsa->Visible) { // suku_bangsa ?>
    <tr id="r_suku_bangsa">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_suku_bangsa"><?= $Page->suku_bangsa->caption() ?></span></td>
...
<?php if ($Page->bahasa_pasien->Visible) { // bahasa_pasien ?>
    <tr id="r_bahasa_pasien">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_bahasa_pasien"><?= $Page->bahasa_pasien->caption() ?></span></td>
...
<?php if ($Page->cacat_fisik->Visible) { // cacat_fisik ?>
    <tr id="r_cacat_fisik">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_pasien_cacat_fisik"><?= $Page->cacat_fisik->caption() ?></span></td>

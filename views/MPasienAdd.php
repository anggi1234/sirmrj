...
loadjs.ready("head", function () {
    ...
    fm_pasienadd = currentForm = new ew.Form("fm_pasienadd", "add");
    ...
    // Form_CustomValidate
    fm_pasienadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fm_pasienadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fm_pasienadd.lists.jk = <?= $Page->jk->toClientList($Page) ?>;
    fm_pasienadd.lists.kd_pj = <?= $Page->kd_pj->toClientList($Page) ?>;
    fm_pasienadd.lists.kd_kel = <?= $Page->kd_kel->toClientList($Page) ?>;
    fm_pasienadd.lists.kd_kec = <?= $Page->kd_kec->toClientList($Page) ?>;
    fm_pasienadd.lists.kd_kab = <?= $Page->kd_kab->toClientList($Page) ?>;
    fm_pasienadd.lists.kd_prop = <?= $Page->kd_prop->toClientList($Page) ?>;
    fm_pasienadd.lists.perusahaan_pasien = <?= $Page->perusahaan_pasien->toClientList($Page) ?>;
    fm_pasienadd.lists.suku_bangsa = <?= $Page->suku_bangsa->toClientList($Page) ?>;
    fm_pasienadd.lists.bahasa_pasien = <?= $Page->bahasa_pasien->toClientList($Page) ?>;
    fm_pasienadd.lists.cacat_fisik = <?= $Page->cacat_fisik->toClientList($Page) ?>;
    loadjs.done("fm_pasienadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fm_pasienadd" id="fm_pasienadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->jk->Visible) { // jk ?>
    <div id="r_jk" class="form-group row">
        <label id="elh_m_pasien_jk" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jk->caption() ?><?= $Page->jk->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->jk->cellAttributes() ?>>
<span id="el_m_pasien_jk">
<template id="tp_x_jk">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="m_pasien" data-field="x_jk" name="x_jk" id="x_jk"<?= $Page->jk->editAttributes() ?>>
...
<?php if ($Page->nm_ibu->Visible) { // nm_ibu ?>
    <div id="r_nm_ibu" class="form-group row">
        <label id="elh_m_pasien_nm_ibu" for="x_nm_ibu" class="<?= $Page->LeftColumnClass ?>"><?= $Page->nm_ibu->caption() ?><?= $Page->nm_ibu->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->nm_ibu->cellAttributes() ?>>
<span id="el_m_pasien_nm_ibu">
<input type="<?= $Page->nm_ibu->getInputTextType() ?>" data-table="m_pasien" data-field="x_nm_ibu" name="x_nm_ibu" id="x_nm_ibu" size="30" maxlength="40" placeholder="<?= HtmlEncode($Page->nm_ibu->getPlaceHolder()) ?>" value="<?= $Page->nm_ibu->EditValue ?>"<?= $Page->nm_ibu->editAttributes() ?> aria-describedby="x_nm_ibu_help">
...
<?php if ($Page->alamat->Visible) { // alamat ?>
    <div id="r_alamat" class="form-group row">
        <label id="elh_m_pasien_alamat" for="x_alamat" class="<?= $Page->LeftColumnClass ?>"><?= $Page->alamat->caption() ?><?= $Page->alamat->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->alamat->cellAttributes() ?>>
<span id="el_m_pasien_alamat">
<input type="<?= $Page->alamat->getInputTextType() ?>" data-table="m_pasien" data-field="x_alamat" name="x_alamat" id="x_alamat" size="30" maxlength="200" placeholder="<?= HtmlEncode($Page->alamat->getPlaceHolder()) ?>" value="<?= $Page->alamat->EditValue ?>"<?= $Page->alamat->editAttributes() ?> aria-describedby="x_alamat_help">
...
<span id="el_m_pasien_kd_kel">
    <select
        ...
        data-select2-id="m_pasien_x_kd_kel"
        data-table="m_pasien"
        data-field="x_kd_kel"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='m_pasien_x_kd_kel']"),
        options = { name: "x_kd_kel", selectId: "m_pasien_x_kd_kel", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.m_pasien.fields.kd_kel.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<span id="el_m_pasien_kd_kec">
    <select
        ...
        data-select2-id="m_pasien_x_kd_kec"
        data-table="m_pasien"
        data-field="x_kd_kec"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='m_pasien_x_kd_kec']"),
        options = { name: "x_kd_kec", selectId: "m_pasien_x_kd_kec", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.m_pasien.fields.kd_kec.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<span id="el_m_pasien_kd_kab">
    <select
        ...
        data-select2-id="m_pasien_x_kd_kab"
        data-table="m_pasien"
        data-field="x_kd_kab"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='m_pasien_x_kd_kab']"),
        options = { name: "x_kd_kab", selectId: "m_pasien_x_kd_kab", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.m_pasien.fields.kd_kab.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<span id="el_m_pasien_kd_prop">
    <select
        ...
        data-select2-id="m_pasien_x_kd_prop"
        data-table="m_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='m_pasien_x_kd_prop']"),
        options = { name: "x_kd_prop", selectId: "m_pasien_x_kd_prop", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.m_pasien.fields.kd_prop.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->perusahaan_pasien->Visible) { // perusahaan_pasien ?>
    <div id="r_perusahaan_pasien" class="form-group row">
        <label id="elh_m_pasien_perusahaan_pasien" for="x_perusahaan_pasien" class="<?= $Page->LeftColumnClass ?>"><?= $Page->perusahaan_pasien->caption() ?><?= $Page->perusahaan_pasien->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->perusahaan_pasien->cellAttributes() ?>>
<span id="el_m_pasien_perusahaan_pasien">
    <select
        id="x_perusahaan_pasien"
        name="x_perusahaan_pasien"
        class="form-control ew-select<?= $Page->perusahaan_pasien->isInvalidClass() ?>"
        data-select2-id="m_pasien_x_perusahaan_pasien"
        data-table="m_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='m_pasien_x_perusahaan_pasien']"),
        options = { name: "x_perusahaan_pasien", selectId: "m_pasien_x_perusahaan_pasien", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.m_pasien.fields.perusahaan_pasien.selectOptions);
    ew.createSelect(options);
});
</script>
</span>

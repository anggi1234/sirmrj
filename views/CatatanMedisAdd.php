...
// Page object
$CatatanMedisAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fcatatan_medisadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fcatatan_medisadd = currentForm = new ew.Form("fcatatan_medisadd", "add");
    ...
    // Validate form
    fcatatan_medisadd.validate = function () {
    ...
    // Form_CustomValidate
    fcatatan_medisadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcatatan_medisadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fcatatan_medisadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fcatatan_medisadd" id="fcatatan_medisadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">

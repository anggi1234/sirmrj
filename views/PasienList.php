...
loadjs.ready("head", function () {
    ...
    fpasienlistsrch.addFields([
        ...
        ["no_peserta", [], fields.no_peserta.isInvalid]
    ]);
...
<input type="hidden" name="z_no_rkm_medis" id="z_no_rkm_medis" value="LIKE">
        ...
        <span id="el_pasien_no_rkm_medis" class="ew-search-field">
<input type="<?= $Page->no_rkm_medis->getInputTextType() ?>" data-table="pasien" data-field="x_no_rkm_medis" name="x_no_rkm_medis" id="x_no_rkm_medis" size="30" maxlength="15" placeholder="<?= HtmlEncode($Page->no_rkm_medis->getPlaceHolder()) ?>" value="<?= $Page->no_rkm_medis->EditValue ?>"<?= $Page->no_rkm_medis->editAttributes() ?>>
...
<input type="hidden" name="z_nm_pasien" id="z_nm_pasien" value="LIKE">
        ...
        <span id="el_pasien_nm_pasien" class="ew-search-field">
<input type="<?= $Page->nm_pasien->getInputTextType() ?>" data-table="pasien" data-field="x_nm_pasien" name="x_nm_pasien" id="x_nm_pasien" size="30" maxlength="40" placeholder="<?= HtmlEncode($Page->nm_pasien->getPlaceHolder()) ?>" value="<?= $Page->nm_pasien->EditValue ?>"<?= $Page->nm_pasien->editAttributes() ?>>
...
<input type="hidden" name="z_nm_ibu" id="z_nm_ibu" value="LIKE">
        ...
        <span id="el_pasien_nm_ibu" class="ew-search-field">
<input type="<?= $Page->nm_ibu->getInputTextType() ?>" data-table="pasien" data-field="x_nm_ibu" name="x_nm_ibu" id="x_nm_ibu" size="30" maxlength="40" placeholder="<?= HtmlEncode($Page->nm_ibu->getPlaceHolder()) ?>" value="<?= $Page->nm_ibu->EditValue ?>"<?= $Page->nm_ibu->editAttributes() ?>>
...
<input type="hidden" name="z_alamat" id="z_alamat" value="LIKE">
        ...
        <span id="el_pasien_alamat" class="ew-search-field">
<input type="<?= $Page->alamat->getInputTextType() ?>" data-table="pasien" data-field="x_alamat" name="x_alamat" id="x_alamat" size="30" maxlength="200" placeholder="<?= HtmlEncode($Page->alamat->getPlaceHolder()) ?>" value="<?= $Page->alamat->EditValue ?>"<?= $Page->alamat->editAttributes() ?>>
...
?>
<?php if ($Page->no_rkm_medis->Visible) { // no_rkm_medis ?>
        <th data-name="no_rkm_medis" class="<?= $Page->no_rkm_medis->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_pasien_no_rkm_medis" class="pasien_no_rkm_medis"><?= $Page->renderSort($Page->no_rkm_medis) ?></div></th>
<?php } ?>
<?php if ($Page->nm_pasien->Visible) { // nm_pasien ?>
        <th data-name="nm_pasien" class="<?= $Page->nm_pasien->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_pasien_nm_pasien" class="pasien_nm_pasien"><?= $Page->renderSort($Page->nm_pasien) ?></div></th>
<?php } ?>
<?php if ($Page->jk->Visible) { // jk ?>
        <th data-name="jk" class="<?= $Page->jk->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_pasien_jk" class="pasien_jk"><?= $Page->renderSort($Page->jk) ?></div></th>
<?php } ?>
<?php if ($Page->nm_ibu->Visible) { // nm_ibu ?>
        <th data-name="nm_ibu" class="<?= $Page->nm_ibu->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_pasien_nm_ibu" class="pasien_nm_ibu"><?= $Page->renderSort($Page->nm_ibu) ?></div></th>
<?php } ?>
<?php if ($Page->alamat->Visible) { // alamat ?>
        <th data-name="alamat" class="<?= $Page->alamat->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_pasien_alamat" class="pasien_alamat"><?= $Page->renderSort($Page->alamat) ?></div></th>
<?php } ?>
<?php if ($Page->tgl_daftar->Visible) { // tgl_daftar ?>
        <th data-name="tgl_daftar" class="<?= $Page->tgl_daftar->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_pasien_tgl_daftar" class="pasien_tgl_daftar"><?= $Page->renderSort($Page->tgl_daftar) ?></div></th>
<?php } ?>
<?php if ($Page->no_peserta->Visible) { // no_peserta ?>
        <th data-name="no_peserta" class="<?= $Page->no_peserta->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_pasien_no_peserta" class="pasien_no_peserta"><?= $Page->renderSort($Page->no_peserta) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_pasien_no_rkm_medis">
...
<span id="el<?= $Page->RowCount ?>_pasien_nm_pasien">
...
<span id="el<?= $Page->RowCount ?>_pasien_jk">
...
<span id="el<?= $Page->RowCount ?>_pasien_nm_ibu">
...
<span id="el<?= $Page->RowCount ?>_pasien_alamat">
...
<span id="el<?= $Page->RowCount ?>_pasien_tgl_daftar">
...
<?= $Page->tgl_daftar->getViewValue() ?></span>
    ...
    <?php } ?>
    <?php if ($Page->no_peserta->Visible) { // no_peserta ?>
        <td data-name="no_peserta" <?= $Page->no_peserta->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_pasien_no_peserta">

 ...
 * Page class
 */
class CatatanMedisDelete extends CatatanMedis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CatatanMedisDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CatatanMedisList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CatatanMedisList"); // Return to list
                return;
            }
        }

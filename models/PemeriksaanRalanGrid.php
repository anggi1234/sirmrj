 ...
 * Page class
 */
class PemeriksaanRalanGrid extends PemeriksaanRalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PemeriksaanRalanGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpemeriksaan_ralangrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->id_pemeriksaan_ralan->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_suhu_tubuh") && $CurrentForm->hasValue("o_suhu_tubuh") && $this->suhu_tubuh->CurrentValue != $this->suhu_tubuh->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_tensi") && $CurrentForm->hasValue("o_tensi") && $this->tensi->CurrentValue != $this->tensi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_nadi") && $CurrentForm->hasValue("o_nadi") && $this->nadi->CurrentValue != $this->nadi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_respirasi") && $CurrentForm->hasValue("o_respirasi") && $this->respirasi->CurrentValue != $this->respirasi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_tinggi") && $CurrentForm->hasValue("o_tinggi") && $this->tinggi->CurrentValue != $this->tinggi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_berat") && $CurrentForm->hasValue("o_berat") && $this->berat->CurrentValue != $this->berat->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_kesadaran") && $CurrentForm->hasValue("o_kesadaran") && $this->kesadaran->CurrentValue != $this->kesadaran->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_alergi") && $CurrentForm->hasValue("o_alergi") && $this->alergi->CurrentValue != $this->alergi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_lingkar_perut") && $CurrentForm->hasValue("o_lingkar_perut") && $this->lingkar_perut->CurrentValue != $this->lingkar_perut->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->tgl_perawatan->clearErrorMessage();
        $this->jam_rawat->clearErrorMessage();
        $this->suhu_tubuh->clearErrorMessage();
        $this->tensi->clearErrorMessage();
        $this->nadi->clearErrorMessage();
        $this->respirasi->clearErrorMessage();
        $this->tinggi->clearErrorMessage();
        $this->berat->clearErrorMessage();
        $this->spo2->clearErrorMessage();
        $this->gcs->clearErrorMessage();
        $this->kesadaran->clearErrorMessage();
        $this->alergi->clearErrorMessage();
        $this->lingkar_perut->clearErrorMessage();
        $this->nip->clearErrorMessage();
        $this->id_pemeriksaan_ralan->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->tgl_perawatan->CurrentValue = null;
        $this->tgl_perawatan->OldValue = $this->tgl_perawatan->CurrentValue;
        $this->jam_rawat->CurrentValue = null;
        $this->jam_rawat->OldValue = $this->jam_rawat->CurrentValue;
        $this->suhu_tubuh->CurrentValue = null;
        $this->suhu_tubuh->OldValue = $this->suhu_tubuh->CurrentValue;
        $this->tensi->CurrentValue = null;
        $this->tensi->OldValue = $this->tensi->CurrentValue;
        $this->nadi->CurrentValue = null;
        $this->nadi->OldValue = $this->nadi->CurrentValue;
        $this->respirasi->CurrentValue = null;
        $this->respirasi->OldValue = $this->respirasi->CurrentValue;
        ...
        $this->lingkar_perut->CurrentValue = null;
        $this->lingkar_perut->OldValue = $this->lingkar_perut->CurrentValue;
        $this->rtl->CurrentValue = null;
        $this->rtl->OldValue = $this->rtl->CurrentValue;
        $this->penilaian->CurrentValue = null;
        $this->penilaian->OldValue = $this->penilaian->CurrentValue;
        $this->instruksi->CurrentValue = null;
        $this->instruksi->OldValue = $this->instruksi->CurrentValue;
        $this->evaluasi->CurrentValue = null;
        $this->evaluasi->OldValue = $this->evaluasi->CurrentValue;
        $this->nip->CurrentValue = null;
        $this->nip->OldValue = $this->nip->CurrentValue;
        $this->id_pemeriksaan_ralan->CurrentValue = null;
        $this->id_pemeriksaan_ralan->OldValue = $this->id_pemeriksaan_ralan->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_tgl_perawatan")) {
            $this->tgl_perawatan->setOldValue($CurrentForm->getValue("o_tgl_perawatan"));
        }
        ...
        if ($CurrentForm->hasValue("o_jam_rawat")) {
            $this->jam_rawat->setOldValue($CurrentForm->getValue("o_jam_rawat"));
        }
        ...
        if ($CurrentForm->hasValue("o_suhu_tubuh")) {
            $this->suhu_tubuh->setOldValue($CurrentForm->getValue("o_suhu_tubuh"));
        }
        ...
        if ($CurrentForm->hasValue("o_tensi")) {
            $this->tensi->setOldValue($CurrentForm->getValue("o_tensi"));
        }
        ...
        if ($CurrentForm->hasValue("o_respirasi")) {
            $this->respirasi->setOldValue($CurrentForm->getValue("o_respirasi"));
        }
        ...
        if ($CurrentForm->hasValue("o_tinggi")) {
            $this->tinggi->setOldValue($CurrentForm->getValue("o_tinggi"));
        }
        ...
        if ($CurrentForm->hasValue("o_berat")) {
            $this->berat->setOldValue($CurrentForm->getValue("o_berat"));
        }
        ...
        if ($CurrentForm->hasValue("o_kesadaran")) {
            $this->kesadaran->setOldValue($CurrentForm->getValue("o_kesadaran"));
        }
        ...
        if ($CurrentForm->hasValue("o_alergi")) {
            $this->alergi->setOldValue($CurrentForm->getValue("o_alergi"));
        }
        ...
        if ($CurrentForm->hasValue("o_lingkar_perut")) {
            $this->lingkar_perut->setOldValue($CurrentForm->getValue("o_lingkar_perut"));
        }
        ...
        if (!$this->id_pemeriksaan_ralan->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function newRow()
    {
        ...
        $row['tgl_perawatan'] = $this->tgl_perawatan->CurrentValue;
        $row['jam_rawat'] = $this->jam_rawat->CurrentValue;
        $row['suhu_tubuh'] = $this->suhu_tubuh->CurrentValue;
        $row['tensi'] = $this->tensi->CurrentValue;
        $row['nadi'] = $this->nadi->CurrentValue;
        $row['respirasi'] = $this->respirasi->CurrentValue;
        $row['tinggi'] = $this->tinggi->CurrentValue;
        ...
        $row['lingkar_perut'] = $this->lingkar_perut->CurrentValue;
        $row['rtl'] = $this->rtl->CurrentValue;
        $row['penilaian'] = $this->penilaian->CurrentValue;
        $row['instruksi'] = $this->instruksi->CurrentValue;
        $row['evaluasi'] = $this->evaluasi->CurrentValue;
        $row['nip'] = $this->nip->CurrentValue;
        $row['id_pemeriksaan_ralan'] = $this->id_pemeriksaan_ralan->CurrentValue;
        return $row;
    }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['id_pemeriksaan_ralan'];
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'pemeriksaan_ralan'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_vrajal();
        ...
        // suhu_tubuh
        $this->suhu_tubuh->setDbValueDef($rsnew, $this->suhu_tubuh->CurrentValue, null, false);

        // tensi
        $this->tensi->setDbValueDef($rsnew, $this->tensi->CurrentValue, "", false);

        // nadi
        $this->nadi->setDbValueDef($rsnew, $this->nadi->CurrentValue, null, false);

        // respirasi
        $this->respirasi->setDbValueDef($rsnew, $this->respirasi->CurrentValue, null, false);
        ...
        // spo2
        $this->spo2->setDbValueDef($rsnew, $this->spo2->CurrentValue, "", false);

        // gcs
        $this->gcs->setDbValueDef($rsnew, $this->gcs->CurrentValue, null, false);

        // kesadaran
        $this->kesadaran->setDbValueDef($rsnew, $this->kesadaran->CurrentValue, "", false);

        // alergi
        $this->alergi->setDbValueDef($rsnew, $this->alergi->CurrentValue, null, false);

        // lingkar_perut
        $this->lingkar_perut->setDbValueDef($rsnew, $this->lingkar_perut->CurrentValue, null, false);

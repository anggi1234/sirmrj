...
/**
 * Table class for diagnosa_pasien
 */
class DiagnosaPasien extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $id_diagnosa_pasien;
    public $no_rawat;
    public $kd_penyakit;
    public $status;
    public $prioritas;
    public $status_penyakit;
    public $kd_icd9;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'diagnosa_pasien';
        $this->TableName = 'diagnosa_pasien';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`diagnosa_pasien`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // id_diagnosa_pasien
        $this->id_diagnosa_pasien = new DbField('diagnosa_pasien', 'diagnosa_pasien', 'x_id_diagnosa_pasien', 'id_diagnosa_pasien', '`id_diagnosa_pasien`', '`id_diagnosa_pasien`', 3, 6, -1, false, '`id_diagnosa_pasien`', false, false, false, 'FORMATTED TEXT', 'NO');
        $this->id_diagnosa_pasien->IsAutoIncrement = true; // Autoincrement field
        $this->id_diagnosa_pasien->IsPrimaryKey = true; // Primary key field
        $this->id_diagnosa_pasien->Sortable = true; // Allow sort
        $this->id_diagnosa_pasien->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->id_diagnosa_pasien->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->id_diagnosa_pasien->Param, "CustomMsg");
        $this->Fields['id_diagnosa_pasien'] = &$this->id_diagnosa_pasien;

        // no_rawat
        $this->no_rawat = new DbField('diagnosa_pasien', 'diagnosa_pasien', 'x_no_rawat', 'no_rawat', '`no_rawat`', '`no_rawat`', 200, 17, -1, false, '`no_rawat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_penyakit
        $this->kd_penyakit = new DbField('diagnosa_pasien', 'diagnosa_pasien', 'x_kd_penyakit', 'kd_penyakit', '`kd_penyakit`', '`kd_penyakit`', 200, 10, -1, false, '`kd_penyakit`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // status
        $this->status = new DbField('diagnosa_pasien', 'diagnosa_pasien', 'x_status', 'status', '`status`', '`status`', 202, 5, -1, false, '`status`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status->Nullable = false; // NOT NULL field
        $this->status->Required = true; // Required field
        $this->status->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status->Lookup = new Lookup('status', 'diagnosa_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status->Lookup = new Lookup('status', 'diagnosa_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // prioritas
        $this->prioritas = new DbField('diagnosa_pasien', 'diagnosa_pasien', 'x_prioritas', 'prioritas', '`prioritas`', '`prioritas`', 16, 4, -1, false, '`prioritas`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->prioritas->Nullable = false; // NOT NULL field
        $this->prioritas->Required = true; // Required field
        $this->prioritas->Sortable = true; // Allow sort
        $this->prioritas->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->prioritas->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->prioritas->Param, "CustomMsg");
        $this->Fields['prioritas'] = &$this->prioritas;

        // status_penyakit
        $this->status_penyakit = new DbField('diagnosa_pasien', 'diagnosa_pasien', 'x_status_penyakit', 'status_penyakit', '`status_penyakit`', '`status_penyakit`', 202, 4, -1, false, '`status_penyakit`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_penyakit->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_penyakit->Lookup = new Lookup('status_penyakit', 'diagnosa_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_penyakit->Lookup = new Lookup('status_penyakit', 'diagnosa_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->status_penyakit->OptionCount = 2;
        $this->status_penyakit->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->status_penyakit->Param, "CustomMsg");
        $this->Fields['status_penyakit'] = &$this->status_penyakit;

        // kd_icd9
        $this->kd_icd9 = new DbField('diagnosa_pasien', 'diagnosa_pasien', 'x_kd_icd9', 'kd_icd9', '`kd_icd9`', '`kd_icd9`', 200, 10, -1, false, '`kd_icd9`', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`diagnosa_pasien`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id_diagnosa_pasien->setDbValue($conn->lastInsertId());
            $rs['id_diagnosa_pasien'] = $this->id_diagnosa_pasien->DbValue;
        }
        return $success;
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('id_diagnosa_pasien', $rs)) {
                AddFilter($where, QuotedName('id_diagnosa_pasien', $this->Dbid) . '=' . QuotedValue($rs['id_diagnosa_pasien'], $this->id_diagnosa_pasien->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->id_diagnosa_pasien->DbValue = $row['id_diagnosa_pasien'];
        $this->no_rawat->DbValue = $row['no_rawat'];
        $this->kd_penyakit->DbValue = $row['kd_penyakit'];
        $this->status->DbValue = $row['status'];
        $this->prioritas->DbValue = $row['prioritas'];
        $this->status_penyakit->DbValue = $row['status_penyakit'];
    ...
    {
        return "`id_diagnosa_pasien` = @id_diagnosa_pasien@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->id_diagnosa_pasien->CurrentValue : $this->id_diagnosa_pasien->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->id_diagnosa_pasien->CurrentValue = $keys[0];
            } else {
                $this->id_diagnosa_pasien->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('id_diagnosa_pasien', $row) ? $row['id_diagnosa_pasien'] : null;
        } else {
            $val = $this->id_diagnosa_pasien->OldValue !== null ? $this->id_diagnosa_pasien->OldValue : $this->id_diagnosa_pasien->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@id_diagnosa_pasien@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DiagnosaPasienList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "DiagnosaPasienEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DiagnosaPasienAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DiagnosaPasienView";
            case Config("API_ADD_ACTION"):
                return "DiagnosaPasienAdd";
            case Config("API_EDIT_ACTION"):
                return "DiagnosaPasienEdit";
            case Config("API_DELETE_ACTION"):
                return "DiagnosaPasienDelete";
            case Config("API_LIST_ACTION"):
                return "DiagnosaPasienList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DiagnosaPasienView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DiagnosaPasienView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DiagnosaPasienAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DiagnosaPasienAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DiagnosaPasienEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DiagnosaPasienAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DiagnosaPasienDelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "id_diagnosa_pasien:" . JsonEncode($this->id_diagnosa_pasien->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->id_diagnosa_pasien->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->id_diagnosa_pasien->CurrentValue);
        } else {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("id_diagnosa_pasien") ?? Route("id_diagnosa_pasien")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->id_diagnosa_pasien->CurrentValue = $key;
            } else {
                $this->id_diagnosa_pasien->OldValue = $key;
            }
    ...
    public function renderListRow()
    {
        ...
        // id_diagnosa_pasien
        $this->id_diagnosa_pasien->LinkCustomAttributes = "";
        $this->id_diagnosa_pasien->HrefValue = "";
        $this->id_diagnosa_pasien->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // id_diagnosa_pasien
        $this->id_diagnosa_pasien->EditAttrs["class"] = "form-control";
        $this->id_diagnosa_pasien->EditCustomAttributes = "";
        $this->id_diagnosa_pasien->EditValue = $this->id_diagnosa_pasien->CurrentValue;
        $this->id_diagnosa_pasien->ViewCustomAttributes = "";
        ...
        $this->prioritas->EditValue = $this->prioritas->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->prioritas);
                    $doc->exportCaption($this->status_penyakit);
                    $doc->exportCaption($this->kd_icd9);
                } else {
                    $doc->exportCaption($this->id_diagnosa_pasien);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->prioritas);
                        $doc->exportField($this->status_penyakit);
                        $doc->exportField($this->kd_icd9);
                    } else {
                        $doc->exportField($this->id_diagnosa_pasien);

...
class PasienAdd extends Pasien
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // no_rkm_medis
        $this->no_rkm_medis->CurrentValue = GetNextNomr();
        $this->no_rkm_medis->setDbValueDef($rsnew, $this->no_rkm_medis->CurrentValue, null);

        // nm_pasien
        $this->nm_pasien->setDbValueDef($rsnew, $this->nm_pasien->CurrentValue, null, false);

        // no_ktp
        $this->no_ktp->setDbValueDef($rsnew, $this->no_ktp->CurrentValue, null, false);

        // jk
        $this->jk->setDbValueDef($rsnew, $this->jk->CurrentValue, null, false);

        // tmp_lahir
        $this->tmp_lahir->setDbValueDef($rsnew, $this->tmp_lahir->CurrentValue, null, false);

        // tgl_lahir
        $this->tgl_lahir->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_lahir->CurrentValue, 7), null, false);

        // nm_ibu
        $this->nm_ibu->setDbValueDef($rsnew, $this->nm_ibu->CurrentValue, null, false);
        ...
        // stts_nikah
        $this->stts_nikah->setDbValueDef($rsnew, $this->stts_nikah->CurrentValue, null, false);
        ...
        // pnd
        $this->pnd->setDbValueDef($rsnew, $this->pnd->CurrentValue, null, false);

        // kd_pj
        $this->kd_pj->setDbValueDef($rsnew, $this->kd_pj->CurrentValue, null, false);

        // no_peserta
        $this->no_peserta->setDbValueDef($rsnew, $this->no_peserta->CurrentValue, null, false);

        // kd_kel
        $this->kd_kel->setDbValueDef($rsnew, $this->kd_kel->CurrentValue, null, false);

        // kd_kec
        $this->kd_kec->setDbValueDef($rsnew, $this->kd_kec->CurrentValue, null, false);

        // kd_kab
        $this->kd_kab->setDbValueDef($rsnew, $this->kd_kab->CurrentValue, null, false);

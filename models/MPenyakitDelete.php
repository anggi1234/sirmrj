 ...
 * Page class
 */
class MPenyakitDelete extends MPenyakit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MPenyakitDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MPenyakitList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MPenyakitList"); // Return to list
                return;
            }
        }

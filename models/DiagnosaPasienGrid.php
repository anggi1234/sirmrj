 ...
 * Page class
 */
class DiagnosaPasienGrid extends DiagnosaPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DiagnosaPasienGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fdiagnosa_pasiengrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->id_diagnosa_pasien->CurrentValue;
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_kd_penyakit") && $CurrentForm->hasValue("o_kd_penyakit") && $this->kd_penyakit->CurrentValue != $this->kd_penyakit->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_status") && $CurrentForm->hasValue("o_status") && $this->status->CurrentValue != $this->status->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_prioritas") && $CurrentForm->hasValue("o_prioritas") && $this->prioritas->CurrentValue != $this->prioritas->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_status_penyakit") && $CurrentForm->hasValue("o_status_penyakit") && $this->status_penyakit->CurrentValue != $this->status_penyakit->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_kd_icd9") && $CurrentForm->hasValue("o_kd_icd9") && $this->kd_icd9->CurrentValue != $this->kd_icd9->OldValue) {
            return false;
        }
        return true;
    }
    ...
    {
        $this->kd_penyakit->clearErrorMessage();
        $this->status->clearErrorMessage();
        $this->prioritas->clearErrorMessage();
        $this->status_penyakit->clearErrorMessage();
        $this->kd_icd9->clearErrorMessage();
    }
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_diagnosa_pasien->OldValue = $this->id_diagnosa_pasien->CurrentValue;
        ...
        $this->prioritas->CurrentValue = null;
        $this->prioritas->OldValue = $this->prioritas->CurrentValue;
        $this->status_penyakit->CurrentValue = null;
        $this->status_penyakit->OldValue = $this->status_penyakit->CurrentValue;
        $this->kd_icd9->CurrentValue = null;
        $this->kd_icd9->OldValue = $this->kd_icd9->CurrentValue;
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_prioritas")) {
            $this->prioritas->setOldValue($CurrentForm->getValue("o_prioritas"));
        }
        ...
        if ($CurrentForm->hasValue("o_status_penyakit")) {
            $this->status_penyakit->setOldValue($CurrentForm->getValue("o_status_penyakit"));
        }
        ...
        if ($CurrentForm->hasValue("o_kd_icd9")) {
            $this->kd_icd9->setOldValue($CurrentForm->getValue("o_kd_icd9"));
        }
        ...
        if (!$this->id_diagnosa_pasien->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_diagnosa_pasien'] = $this->id_diagnosa_pasien->CurrentValue;
        $row['no_rawat'] = $this->no_rawat->CurrentValue;
        $row['kd_penyakit'] = $this->kd_penyakit->CurrentValue;
        $row['status'] = $this->status->CurrentValue;
        $row['prioritas'] = $this->prioritas->CurrentValue;
        $row['status_penyakit'] = $this->status_penyakit->CurrentValue;
        $row['kd_icd9'] = $this->kd_icd9->CurrentValue;
        return $row;
    }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['id_diagnosa_pasien'];
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'diagnosa_pasien'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_vrajal();
        ...
        // prioritas
        $this->prioritas->setDbValueDef($rsnew, $this->prioritas->CurrentValue, 0, false);

        // status_penyakit
        $this->status_penyakit->setDbValueDef($rsnew, $this->status_penyakit->CurrentValue, null, false);

        // kd_icd9
        $this->kd_icd9->setDbValueDef($rsnew, $this->kd_icd9->CurrentValue, null, false);

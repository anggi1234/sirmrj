 ...
 * Page class
 */
class BillingGrid extends Billing
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BillingGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fbillinggrid";
    ...
    protected function clearInlineMode()
    {
        ...
        $this->tambahan->FormValue = ""; // Clear form value
        $this->totalbiaya->FormValue = ""; // Clear form value
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->id_billing->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_tgl_byr") && $CurrentForm->hasValue("o_tgl_byr") && $this->tgl_byr->CurrentValue != $this->tgl_byr->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_no") && $CurrentForm->hasValue("o_no") && $this->no->CurrentValue != $this->no->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_nm_perawatan") && $CurrentForm->hasValue("o_nm_perawatan") && $this->nm_perawatan->CurrentValue != $this->nm_perawatan->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_pemisah") && $CurrentForm->hasValue("o_pemisah") && $this->pemisah->CurrentValue != $this->pemisah->OldValue) {
            return false;
        }
        ...
        if ($CurrentForm->hasValue("x_totalbiaya") && $CurrentForm->hasValue("o_totalbiaya") && $this->totalbiaya->CurrentValue != $this->totalbiaya->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->tgl_byr->clearErrorMessage();
        $this->no->clearErrorMessage();
        $this->nm_perawatan->clearErrorMessage();
        $this->pemisah->clearErrorMessage();
        $this->biaya->clearErrorMessage();
        $this->jumlah->clearErrorMessage();
        $this->tambahan->clearErrorMessage();
        $this->totalbiaya->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_tgl_byr")) {
            $this->tgl_byr->setOldValue($CurrentForm->getValue("o_tgl_byr"));
        }
        ...
        if ($CurrentForm->hasValue("o_no")) {
            $this->no->setOldValue($CurrentForm->getValue("o_no"));
        }
        ...
        if ($CurrentForm->hasValue("o_nm_perawatan")) {
            $this->nm_perawatan->setOldValue($CurrentForm->getValue("o_nm_perawatan"));
        }
        ...
        if ($CurrentForm->hasValue("o_pemisah")) {
            $this->pemisah->setOldValue($CurrentForm->getValue("o_pemisah"));
        }
        ...
        if ($CurrentForm->hasValue("o_totalbiaya")) {
            $this->totalbiaya->setOldValue($CurrentForm->getValue("o_totalbiaya"));
        }
        ...
        if (!$this->id_billing->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->id_billing->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->id_billing->CurrentValue = $this->id_billing->FormValue;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (strval($this->tambahan->EditValue) != "" && is_numeric($this->tambahan->EditValue)) {
                ...
                $this->tambahan->OldValue = $this->tambahan->EditValue;
            }
            ...
            if (strval($this->totalbiaya->EditValue) != "" && is_numeric($this->totalbiaya->EditValue)) {
                ...
                $this->totalbiaya->OldValue = $this->totalbiaya->EditValue;
            }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            $this->no_reg->setDbValueDef($rsnew, $this->no_reg->CurrentValue, "", $this->no_reg->ReadOnly);

            // tgl_byr
            $this->tgl_byr->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_byr->CurrentValue, 0), null, $this->tgl_byr->ReadOnly);

            // no
            $this->no->setDbValueDef($rsnew, $this->no->CurrentValue, "", $this->no->ReadOnly);

            // nm_perawatan
            $this->nm_perawatan->setDbValueDef($rsnew, $this->nm_perawatan->CurrentValue, "", $this->nm_perawatan->ReadOnly);

            // pemisah
            $this->pemisah->setDbValueDef($rsnew, $this->pemisah->CurrentValue, "", $this->pemisah->ReadOnly);
            ...
            // tambahan
            $this->tambahan->setDbValueDef($rsnew, $this->tambahan->CurrentValue, 0, $this->tambahan->ReadOnly);

            // totalbiaya
            $this->totalbiaya->setDbValueDef($rsnew, $this->totalbiaya->CurrentValue, 0, $this->totalbiaya->ReadOnly);

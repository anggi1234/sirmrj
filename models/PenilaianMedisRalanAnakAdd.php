 ...
 * Page class
 */
class PenilaianMedisRalanAnakAdd extends PenilaianMedisRalanAnak
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisRalanAnakAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PenilaianMedisRalanAnakView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_penilaian_medis_ralan_anak->OldValue = $this->id_penilaian_medis_ralan_anak->CurrentValue;
        ...
        $this->konsul->CurrentValue = null;
        $this->konsul->OldValue = $this->konsul->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_penilaian_medis_ralan_anak'] = $this->id_penilaian_medis_ralan_anak->CurrentValue;
        ...
        $row['konsul'] = $this->konsul->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tht
        $this->tht->setDbValueDef($rsnew, $this->tht->CurrentValue, "", false);
        ...
        // kulit
        $this->kulit->setDbValueDef($rsnew, $this->kulit->CurrentValue, "", false);
        ...
        // konsul
        $this->konsul->setDbValueDef($rsnew, $this->konsul->CurrentValue, "", false);

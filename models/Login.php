...
class Login extends Userlogin
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("userlogin", "userlogin", "username", "username", "username", "", 202, 255, 0, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-control");
        $this->Password = new DbField("userlogin", "userlogin", "password", "password", "password", "", 202, 255, 0, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("userlogin", "userlogin", "type", "logintype", "logintype", "", 202, 255, 0, false, "", false, false, false);
    ...
    public function pageRedirecting(&$url)
    {
        // Example:
        //$url = "your URL";
        //$url = "http://localhost/simrs/MPasienAdd"
    }

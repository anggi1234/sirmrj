...
/**
 * Table class for penilaian_medis_igd
 */
class PenilaianMedisIgd extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'penilaian_medis_igd';
        $this->TableName = 'penilaian_medis_igd';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`penilaian_medis_igd`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->id_penilaian_medis_igd = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_id_penilaian_medis_igd', 'id_penilaian_medis_igd', '`id_penilaian_medis_igd`', '`id_penilaian_medis_igd`', 3, 11, -1, false, '`id_penilaian_medis_igd`', false, false, false, 'FORMATTED TEXT', 'NO');
        $this->id_penilaian_medis_igd->IsAutoIncrement = true; // Autoincrement field
        $this->id_penilaian_medis_igd->IsPrimaryKey = true; // Primary key field
        $this->id_penilaian_medis_igd->Sortable = true; // Allow sort
        $this->id_penilaian_medis_igd->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->id_penilaian_medis_igd->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->id_penilaian_medis_igd->Param, "CustomMsg");
        $this->Fields['id_penilaian_medis_igd'] = &$this->id_penilaian_medis_igd;

        // no_rawat
        $this->no_rawat = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_no_rawat', 'no_rawat', '`no_rawat`', '`no_rawat`', 200, 17, -1, false, '`no_rawat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal
        $this->tanggal = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_tanggal', 'tanggal', '`tanggal`', CastDateFieldForLike("`tanggal`", 0, "DB"), 135, 19, 0, false, '`tanggal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_dokter
        $this->kd_dokter = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_kd_dokter', 'kd_dokter', '`kd_dokter`', '`kd_dokter`', 200, 20, -1, false, '`kd_dokter`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // anamnesis
        $this->anamnesis = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_anamnesis', 'anamnesis', '`anamnesis`', '`anamnesis`', 202, 13, -1, false, '`anamnesis`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->anamnesis->Lookup = new Lookup('anamnesis', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->anamnesis->Lookup = new Lookup('anamnesis', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // hubungan
        $this->hubungan = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_hubungan', 'hubungan', '`hubungan`', '`hubungan`', 200, 100, -1, false, '`hubungan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // keluhan_utama
        $this->keluhan_utama = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_keluhan_utama', 'keluhan_utama', '`keluhan_utama`', '`keluhan_utama`', 201, 2000, -1, false, '`keluhan_utama`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // rps
        $this->rps = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_rps', 'rps', '`rps`', '`rps`', 201, 2000, -1, false, '`rps`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // rpd
        $this->rpd = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_rpd', 'rpd', '`rpd`', '`rpd`', 201, 1000, -1, false, '`rpd`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // rpk
        $this->rpk = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_rpk', 'rpk', '`rpk`', '`rpk`', 201, 1000, -1, false, '`rpk`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // rpo
        $this->rpo = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_rpo', 'rpo', '`rpo`', '`rpo`', 201, 1000, -1, false, '`rpo`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // alergi
        $this->alergi = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_alergi', 'alergi', '`alergi`', '`alergi`', 200, 100, -1, false, '`alergi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // keadaan
        $this->keadaan = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_keadaan', 'keadaan', '`keadaan`', '`keadaan`', 202, 12, -1, false, '`keadaan`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->keadaan->Nullable = false; // NOT NULL field
        $this->keadaan->Required = true; // Required field
        $this->keadaan->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->keadaan->Lookup = new Lookup('keadaan', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->keadaan->Lookup = new Lookup('keadaan', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // gcs
        $this->gcs = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_gcs', 'gcs', '`gcs`', '`gcs`', 200, 10, -1, false, '`gcs`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kesadaran
        $this->kesadaran = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_kesadaran', 'kesadaran', '`kesadaran`', '`kesadaran`', 202, 13, -1, false, '`kesadaran`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->kesadaran->Lookup = new Lookup('kesadaran', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kesadaran->Lookup = new Lookup('kesadaran', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // td
        $this->td = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_td', 'td', '`td`', '`td`', 200, 8, -1, false, '`td`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nadi
        $this->nadi = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_nadi', 'nadi', '`nadi`', '`nadi`', 200, 5, -1, false, '`nadi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rr
        $this->rr = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_rr', 'rr', '`rr`', '`rr`', 200, 5, -1, false, '`rr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // suhu
        $this->suhu = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_suhu', 'suhu', '`suhu`', '`suhu`', 200, 5, -1, false, '`suhu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spo
        $this->spo = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_spo', 'spo', '`spo`', '`spo`', 200, 5, -1, false, '`spo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bb
        $this->bb = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_bb', 'bb', '`bb`', '`bb`', 200, 5, -1, false, '`bb`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tb
        $this->tb = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_tb', 'tb', '`tb`', '`tb`', 200, 5, -1, false, '`tb`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kepala
        $this->kepala = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_kepala', 'kepala', '`kepala`', '`kepala`', 202, 15, -1, false, '`kepala`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->kepala->Nullable = false; // NOT NULL field
        $this->kepala->Required = true; // Required field
        $this->kepala->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->kepala->Lookup = new Lookup('kepala', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kepala->Lookup = new Lookup('kepala', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // mata
        $this->mata = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_mata', 'mata', '`mata`', '`mata`', 202, 15, -1, false, '`mata`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->mata->Nullable = false; // NOT NULL field
        $this->mata->Required = true; // Required field
        $this->mata->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->mata->Lookup = new Lookup('mata', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->mata->Lookup = new Lookup('mata', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->mata->OptionCount = 3;
        $this->mata->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->mata->Param, "CustomMsg");
        $this->Fields['mata'] = &$this->mata;

        // gigi
        $this->gigi = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_gigi', 'gigi', '`gigi`', '`gigi`', 202, 15, -1, false, '`gigi`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->gigi->Nullable = false; // NOT NULL field
        $this->gigi->Required = true; // Required field
        $this->gigi->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->gigi->Lookup = new Lookup('gigi', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->gigi->Lookup = new Lookup('gigi', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // leher
        $this->leher = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_leher', 'leher', '`leher`', '`leher`', 202, 15, -1, false, '`leher`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->leher->Nullable = false; // NOT NULL field
        $this->leher->Required = true; // Required field
        $this->leher->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->leher->Lookup = new Lookup('leher', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->leher->Lookup = new Lookup('leher', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->leher->OptionCount = 3;
        $this->leher->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->leher->Param, "CustomMsg");
        $this->Fields['leher'] = &$this->leher;

        // thoraks
        $this->thoraks = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_thoraks', 'thoraks', '`thoraks`', '`thoraks`', 202, 15, -1, false, '`thoraks`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->thoraks->Nullable = false; // NOT NULL field
        $this->thoraks->Required = true; // Required field
        $this->thoraks->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->thoraks->Lookup = new Lookup('thoraks', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->thoraks->Lookup = new Lookup('thoraks', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // abdomen
        $this->abdomen = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_abdomen', 'abdomen', '`abdomen`', '`abdomen`', 202, 15, -1, false, '`abdomen`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->abdomen->Nullable = false; // NOT NULL field
        $this->abdomen->Required = true; // Required field
        $this->abdomen->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->abdomen->Lookup = new Lookup('abdomen', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->abdomen->Lookup = new Lookup('abdomen', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // genital
        $this->genital = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_genital', 'genital', '`genital`', '`genital`', 202, 15, -1, false, '`genital`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->genital->Nullable = false; // NOT NULL field
        $this->genital->Required = true; // Required field
        $this->genital->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->genital->Lookup = new Lookup('genital', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->genital->Lookup = new Lookup('genital', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // ekstremitas
        $this->ekstremitas = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_ekstremitas', 'ekstremitas', '`ekstremitas`', '`ekstremitas`', 202, 15, -1, false, '`ekstremitas`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->ekstremitas->Lookup = new Lookup('ekstremitas', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ekstremitas->Lookup = new Lookup('ekstremitas', 'penilaian_medis_igd', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // ket_fisik
        $this->ket_fisik = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_ket_fisik', 'ket_fisik', '`ket_fisik`', '`ket_fisik`', 201, 65535, -1, false, '`ket_fisik`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ket_lokalis
        $this->ket_lokalis = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_ket_lokalis', 'ket_lokalis', '`ket_lokalis`', '`ket_lokalis`', 201, 65535, -1, false, '`ket_lokalis`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ekg
        $this->ekg = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_ekg', 'ekg', '`ekg`', '`ekg`', 201, 65535, -1, false, '`ekg`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->ekg->Nullable = false; // NOT NULL field
        $this->ekg->Required = true; // Required field
        $this->ekg->Sortable = true; // Allow sort
        $this->ekg->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ekg->Param, "CustomMsg");
        $this->Fields['ekg'] = &$this->ekg;

        // rad
        $this->rad = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_rad', 'rad', '`rad`', '`rad`', 201, 65535, -1, false, '`rad`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->rad->Nullable = false; // NOT NULL field
        $this->rad->Required = true; // Required field
        $this->rad->Sortable = true; // Allow sort
        $this->rad->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->rad->Param, "CustomMsg");
        $this->Fields['rad'] = &$this->rad;

        // lab
        $this->lab = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_lab', 'lab', '`lab`', '`lab`', 201, 65535, -1, false, '`lab`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->lab->Nullable = false; // NOT NULL field
        $this->lab->Required = true; // Required field
        ...
        // diagnosis
        $this->diagnosis = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_diagnosis', 'diagnosis', '`diagnosis`', '`diagnosis`', 201, 500, -1, false, '`diagnosis`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // tata
        $this->tata = new DbField('penilaian_medis_igd', 'penilaian_medis_igd', 'x_tata', 'tata', '`tata`', '`tata`', 201, 65535, -1, false, '`tata`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`penilaian_medis_igd`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id_penilaian_medis_igd->setDbValue($conn->lastInsertId());
            $rs['id_penilaian_medis_igd'] = $this->id_penilaian_medis_igd->DbValue;
        }
        return $success;
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('id_penilaian_medis_igd', $rs)) {
                AddFilter($where, QuotedName('id_penilaian_medis_igd', $this->Dbid) . '=' . QuotedValue($rs['id_penilaian_medis_igd'], $this->id_penilaian_medis_igd->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->id_penilaian_medis_igd->DbValue = $row['id_penilaian_medis_igd'];
        ...
        $this->ekg->DbValue = $row['ekg'];
        $this->rad->DbValue = $row['rad'];
    ...
    {
        return "`id_penilaian_medis_igd` = @id_penilaian_medis_igd@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->id_penilaian_medis_igd->CurrentValue : $this->id_penilaian_medis_igd->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->id_penilaian_medis_igd->CurrentValue = $keys[0];
            } else {
                $this->id_penilaian_medis_igd->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('id_penilaian_medis_igd', $row) ? $row['id_penilaian_medis_igd'] : null;
        } else {
            $val = $this->id_penilaian_medis_igd->OldValue !== null ? $this->id_penilaian_medis_igd->OldValue : $this->id_penilaian_medis_igd->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@id_penilaian_medis_igd@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PenilaianMedisIgdList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PenilaianMedisIgdEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PenilaianMedisIgdAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PenilaianMedisIgdView";
            case Config("API_ADD_ACTION"):
                return "PenilaianMedisIgdAdd";
            case Config("API_EDIT_ACTION"):
                return "PenilaianMedisIgdEdit";
            case Config("API_DELETE_ACTION"):
                return "PenilaianMedisIgdDelete";
            case Config("API_LIST_ACTION"):
                return "PenilaianMedisIgdList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PenilaianMedisIgdView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PenilaianMedisIgdView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PenilaianMedisIgdAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PenilaianMedisIgdAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PenilaianMedisIgdEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PenilaianMedisIgdAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PenilaianMedisIgdDelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "id_penilaian_medis_igd:" . JsonEncode($this->id_penilaian_medis_igd->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->id_penilaian_medis_igd->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->id_penilaian_medis_igd->CurrentValue);
        } else {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("id_penilaian_medis_igd") ?? Route("id_penilaian_medis_igd")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->id_penilaian_medis_igd->CurrentValue = $key;
            } else {
                $this->id_penilaian_medis_igd->OldValue = $key;
            }
    ...
    public function renderEditRow()
    {
        ...
        // id_penilaian_medis_igd
        $this->id_penilaian_medis_igd->EditAttrs["class"] = "form-control";
        $this->id_penilaian_medis_igd->EditCustomAttributes = "";
        $this->id_penilaian_medis_igd->EditValue = $this->id_penilaian_medis_igd->CurrentValue;
        $this->id_penilaian_medis_igd->ViewCustomAttributes = "";
        ...
        // leher
        $this->leher->EditCustomAttributes = "";
        $this->leher->EditValue = $this->leher->options(false);
        $this->leher->PlaceHolder = RemoveHtml($this->leher->caption());
        ...
        // ekg
        $this->ekg->EditAttrs["class"] = "form-control";
        $this->ekg->EditCustomAttributes = "";
        $this->ekg->EditValue = $this->ekg->CurrentValue;
        $this->ekg->PlaceHolder = RemoveHtml($this->ekg->caption());

        // rad
        $this->rad->EditAttrs["class"] = "form-control";
        $this->rad->EditCustomAttributes = "";
        $this->rad->EditValue = $this->rad->CurrentValue;
        $this->rad->PlaceHolder = RemoveHtml($this->rad->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->id_penilaian_medis_igd);
                    ...
                    $doc->exportCaption($this->mata);
                    $doc->exportCaption($this->gigi);
                    $doc->exportCaption($this->leher);
                    ...
                    $doc->exportCaption($this->ekg);
                    $doc->exportCaption($this->rad);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->id_penilaian_medis_igd);
                        ...
                        $doc->exportField($this->mata);
                        $doc->exportField($this->gigi);
                        $doc->exportField($this->leher);
                        ...
                        $doc->exportField($this->ekg);
                        $doc->exportField($this->rad);

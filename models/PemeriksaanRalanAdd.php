 ...
 * Page class
 */
class PemeriksaanRalanAdd extends PemeriksaanRalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PemeriksaanRalanAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PemeriksaanRalanView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // rtl
        $this->rtl->setDbValueDef($rsnew, $this->rtl->CurrentValue, "", false);

        // penilaian
        $this->penilaian->setDbValueDef($rsnew, $this->penilaian->CurrentValue, "", false);

        // instruksi
        $this->instruksi->setDbValueDef($rsnew, $this->instruksi->CurrentValue, "", false);

        // evaluasi
        $this->evaluasi->setDbValueDef($rsnew, $this->evaluasi->CurrentValue, "", false);

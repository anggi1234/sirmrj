 ...
 * Page class
 */
class PenilaianMedisRalanView extends PenilaianMedisRalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisRalanView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_penilaian_medis_ralan") ?? Route("id_penilaian_medis_ralan")) !== null) {
            $this->RecKey["id_penilaian_medis_ralan"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $this->id_penilaian_medis_ralan->setVisibility();
        ...
        $this->konsulrujuk->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_penilaian_medis_ralan") ?? Route("id_penilaian_medis_ralan")) !== null) {
                ...
                $this->RecKey["id_penilaian_medis_ralan"] = $this->id_penilaian_medis_ralan->QueryStringValue;
            } elseif (Post("id_penilaian_medis_ralan") !== null) {
                $this->id_penilaian_medis_ralan->setFormValue(Post("id_penilaian_medis_ralan"));
                $this->RecKey["id_penilaian_medis_ralan"] = $this->id_penilaian_medis_ralan->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_penilaian_medis_ralan->setQueryStringValue($keyValue);
                $this->RecKey["id_penilaian_medis_ralan"] = $this->id_penilaian_medis_ralan->QueryStringValue;
            } else {
                $returnUrl = "PenilaianMedisRalanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PenilaianMedisRalanList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PenilaianMedisRalanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {

 ...
 * Page class
 */
class PenilaianMedisRalanDelete extends PenilaianMedisRalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisRalanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PenilaianMedisRalanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PenilaianMedisRalanList"); // Return to list
                return;
            }
        }

 ...
 * Page class
 */
class MPasienDelete extends MPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MPasienDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MPasienList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MPasienList"); // Return to list
                return;
            }
        }

 ...
 * Page class
 */
class PasienKunjunganGrid extends PasienKunjungan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PasienKunjunganGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpasien_kunjungangrid";
    ...
    public function resetFormError()
    {
        ...
        $this->jam_reg->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->id_reg->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
        ...
        if ($CurrentForm->hasValue("o_jam_reg")) {
            $this->jam_reg->setOldValue($CurrentForm->getValue("o_jam_reg"));
        }
    }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // Check referential integrity for master table 'vriwayat'
            $validMasterRecord = true;
            $masterFilter = $this->sqlMasterFilter_vriwayat();
            ...
            if ($validMasterRecord) {
                $rsmaster = Container("vriwayat")->loadRs($masterFilter)->fetch();
                $validMasterRecord = $rsmaster !== false;
            }
            if (!$validMasterRecord) {
                $relatedRecordMsg = str_replace("%t", "vriwayat", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'pasien_kunjungan'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_vriwayat();

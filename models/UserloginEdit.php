...
class UserloginEdit extends Userlogin
{
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // userlevels
            if ($Security->canAdmin()) { // System admin
                $this->userlevels->setDbValueDef($rsnew, $this->userlevels->CurrentValue, null, $this->userlevels->ReadOnly);
            }
            ...
            $this->id_akses->setDbValueDef($rsnew, $tmpBool, null, $this->id_akses->ReadOnly);

 ...
 * Page class
 */
class PoliklinikView extends Poliklinik
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoliklinikView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("kd_poli") ?? Route("kd_poli")) !== null) {
                ...
                $this->RecKey["kd_poli"] = $this->kd_poli->QueryStringValue;
            } elseif (Post("kd_poli") !== null) {
                $this->kd_poli->setFormValue(Post("kd_poli"));
                $this->RecKey["kd_poli"] = $this->kd_poli->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->kd_poli->setQueryStringValue($keyValue);
                $this->RecKey["kd_poli"] = $this->kd_poli->QueryStringValue;
            } else {
                $returnUrl = "PoliklinikList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PoliklinikList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PoliklinikList"; // Not page request, return to list
        }
        if ($returnUrl != "") {

...
class Report1Summary extends Report1
{
    ...
    {
        $data = [];
        $data["Jumlah_Pasien"] = $record['Jumlah_Pasien'];
        $data["tgl_daftar"] = $record['tgl_daftar'];
        $this->Rows[] = $data;
        $this->Jumlah_Pasien->setDbValue($record['Jumlah_Pasien']);
        $this->tgl_daftar->setDbValue($record['tgl_daftar']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            $this->Jumlah_Pasien->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "ew-table-row");
            ...
            $this->tgl_daftar->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "ew-table-row");
        ...
        if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
            ...
            // Jumlah_Pasien
            $currentValue = $this->Jumlah_Pasien->CurrentValue;
            $viewValue = &$this->Jumlah_Pasien->ViewValue;
            $viewAttrs = &$this->Jumlah_Pasien->ViewAttrs;
            $cellAttrs = &$this->Jumlah_Pasien->CellAttrs;
            $hrefValue = &$this->Jumlah_Pasien->HrefValue;
            $linkAttrs = &$this->Jumlah_Pasien->LinkAttrs;
            $this->cellRendered($this->Jumlah_Pasien, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // tgl_daftar
            $currentValue = $this->tgl_daftar->CurrentValue;
            $viewValue = &$this->tgl_daftar->ViewValue;
            $viewAttrs = &$this->tgl_daftar->ViewAttrs;
            $cellAttrs = &$this->tgl_daftar->CellAttrs;
            $hrefValue = &$this->tgl_daftar->HrefValue;
            $linkAttrs = &$this->tgl_daftar->LinkAttrs;
            $this->cellRendered($this->tgl_daftar, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->Jumlah_Pasien->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->tgl_daftar->Visible) {
            $this->DetailColumnCount += 1;
        }
    }

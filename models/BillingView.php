...
class BillingView extends Billing
{
    ...
    // Page object name
    public $PageObjName = "BillingView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_billing") ?? Route("id_billing")) !== null) {
            $this->RecKey["id_billing"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_billing") ?? Route("id_billing")) !== null) {
                ...
                $this->RecKey["id_billing"] = $this->id_billing->QueryStringValue;
            } elseif (Post("id_billing") !== null) {
                $this->id_billing->setFormValue(Post("id_billing"));
                $this->RecKey["id_billing"] = $this->id_billing->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_billing->setQueryStringValue($keyValue);
                $this->RecKey["id_billing"] = $this->id_billing->QueryStringValue;
            } else {
                $returnUrl = "BillingList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "BillingList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "BillingList"; // Not page request, return to list
        }
        if ($returnUrl != "") {

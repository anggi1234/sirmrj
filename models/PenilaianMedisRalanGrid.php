 ...
 * Page class
 */
class PenilaianMedisRalanGrid extends PenilaianMedisRalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisRalanGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpenilaian_medis_ralangrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->id_penilaian_medis_ralan->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_keluhan_utama") && $CurrentForm->hasValue("o_keluhan_utama") && $this->keluhan_utama->CurrentValue != $this->keluhan_utama->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_alergi") && $CurrentForm->hasValue("o_alergi") && $this->alergi->CurrentValue != $this->alergi->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_keadaan") && $CurrentForm->hasValue("o_keadaan") && $this->keadaan->CurrentValue != $this->keadaan->OldValue) {
            return false;
        }
    ...
    public function resetFormError()
    {
        ...
        $this->keluhan_utama->clearErrorMessage();
        $this->alergi->clearErrorMessage();
        $this->keadaan->clearErrorMessage();
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_keluhan_utama")) {
            $this->keluhan_utama->setOldValue($CurrentForm->getValue("o_keluhan_utama"));
        }
        ...
        if ($CurrentForm->hasValue("o_keadaan")) {
            $this->keadaan->setOldValue($CurrentForm->getValue("o_keadaan"));
        }
        ...
        if (!$this->id_penilaian_medis_ralan->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->id_penilaian_medis_ralan->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->id_penilaian_medis_ralan->CurrentValue = $this->id_penilaian_medis_ralan->FormValue;
        }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['id_penilaian_medis_ralan'];

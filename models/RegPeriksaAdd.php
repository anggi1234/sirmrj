 ...
 * Page class
 */
class RegPeriksaAdd extends RegPeriksa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RegPeriksaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "RegPeriksaView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // id_reg
        $this->id_reg->setDbValueDef($rsnew, $this->id_reg->CurrentValue, 0, false);

        // Call Row Inserting event
        $insertRow = $this->rowInserting($rsold, $rsnew);

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['no_rawat']) == "") {

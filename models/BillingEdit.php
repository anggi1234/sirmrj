 ...
 * Page class
 */
class BillingEdit extends Billing
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BillingEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_billing") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_billing->setQueryStringValue($keyValue);
                $this->id_billing->setOldValue($this->id_billing->QueryStringValue);
            } elseif (Post("id_billing") !== null) {
                $this->id_billing->setFormValue(Post("id_billing"));
                $this->id_billing->setOldValue($this->id_billing->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->id_billing->IsDetailKey) {

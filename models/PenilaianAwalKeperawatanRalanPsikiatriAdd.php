 ...
 * Page class
 */
class PenilaianAwalKeperawatanRalanPsikiatriAdd extends PenilaianAwalKeperawatanRalanPsikiatri
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianAwalKeperawatanRalanPsikiatriAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PenilaianAwalKeperawatanRalanPsikiatriView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // rkd_keluhan
        $this->rkd_keluhan->setDbValueDef($rsnew, $this->rkd_keluhan->CurrentValue, "", false);

...
/**
 * Table class for vrajal
 */
class Vrajal extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'vrajal';
        $this->TableName = 'vrajal';
        ...
        // id_reg
        $this->id_reg = new DbField('vrajal', 'vrajal', 'x_id_reg', 'id_reg', '`id_reg`', '`id_reg`', 3, 11, -1, false, '`id_reg`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_rkm_medis
        $this->no_rkm_medis = new DbField('vrajal', 'vrajal', 'x_no_rkm_medis', 'no_rkm_medis', '`no_rkm_medis`', '`no_rkm_medis`', 200, 15, -1, false, '`no_rkm_medis`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // no_reg
        $this->no_reg = new DbField('vrajal', 'vrajal', 'x_no_reg', 'no_reg', '`no_reg`', '`no_reg`', 200, 8, -1, false, '`no_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_rawat
        $this->no_rawat = new DbField('vrajal', 'vrajal', 'x_no_rawat', 'no_rawat', '`no_rawat`', '`no_rawat`', 200, 17, -1, false, '`no_rawat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_poli
        $this->kd_poli = new DbField('vrajal', 'vrajal', 'x_kd_poli', 'kd_poli', '`kd_poli`', '`kd_poli`', 200, 5, -1, false, '`kd_poli`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kd_dokter
        $this->kd_dokter = new DbField('vrajal', 'vrajal', 'x_kd_dokter', 'kd_dokter', '`kd_dokter`', '`kd_dokter`', 200, 20, -1, false, '`kd_dokter`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->kd_dokter->Lookup = new Lookup('kd_dokter', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kd_dokter->Lookup = new Lookup('kd_dokter', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // tgl_registrasi
        $this->tgl_registrasi = new DbField('vrajal', 'vrajal', 'x_tgl_registrasi', 'tgl_registrasi', '`tgl_registrasi`', CastDateFieldForLike("`tgl_registrasi`", 7, "DB"), 133, 10, 7, false, '`tgl_registrasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jam_reg
        $this->jam_reg = new DbField('vrajal', 'vrajal', 'x_jam_reg', 'jam_reg', '`jam_reg`', CastDateFieldForLike("`jam_reg`", 4, "DB"), 134, 10, 4, false, '`jam_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // p_jawab
        $this->p_jawab = new DbField('vrajal', 'vrajal', 'x_p_jawab', 'p_jawab', '`p_jawab`', '`p_jawab`', 200, 100, -1, false, '`p_jawab`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // almt_pj
        $this->almt_pj = new DbField('vrajal', 'vrajal', 'x_almt_pj', 'almt_pj', '`almt_pj`', '`almt_pj`', 200, 200, -1, false, '`almt_pj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // hubunganpj
        $this->hubunganpj = new DbField('vrajal', 'vrajal', 'x_hubunganpj', 'hubunganpj', '`hubunganpj`', '`hubunganpj`', 200, 20, -1, false, '`hubunganpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // biaya_reg
        $this->biaya_reg = new DbField('vrajal', 'vrajal', 'x_biaya_reg', 'biaya_reg', '`biaya_reg`', '`biaya_reg`', 5, 22, -1, false, '`biaya_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // stts
        $this->stts = new DbField('vrajal', 'vrajal', 'x_stts', 'stts', '`stts`', '`stts`', 202, 15, -1, false, '`stts`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->stts->Lookup = new Lookup('stts', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->stts->Lookup = new Lookup('stts', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // stts_daftar
        $this->stts_daftar = new DbField('vrajal', 'vrajal', 'x_stts_daftar', 'stts_daftar', '`stts_daftar`', '`stts_daftar`', 202, 4, -1, false, '`stts_daftar`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->stts_daftar->Lookup = new Lookup('stts_daftar', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->stts_daftar->Lookup = new Lookup('stts_daftar', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_lanjut
        $this->status_lanjut = new DbField('vrajal', 'vrajal', 'x_status_lanjut', 'status_lanjut', '`status_lanjut`', '`status_lanjut`', 202, 5, -1, false, '`status_lanjut`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->status_lanjut->Lookup = new Lookup('status_lanjut', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_lanjut->Lookup = new Lookup('status_lanjut', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // kd_pj
        $this->kd_pj = new DbField('vrajal', 'vrajal', 'x_kd_pj', 'kd_pj', '`kd_pj`', '`kd_pj`', 200, 3, -1, false, '`kd_pj`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // umurdaftar
        $this->umurdaftar = new DbField('vrajal', 'vrajal', 'x_umurdaftar', 'umurdaftar', '`umurdaftar`', '`umurdaftar`', 3, 11, -1, false, '`umurdaftar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sttsumur
        $this->sttsumur = new DbField('vrajal', 'vrajal', 'x_sttsumur', 'sttsumur', '`sttsumur`', '`sttsumur`', 202, 2, -1, false, '`sttsumur`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->sttsumur->Lookup = new Lookup('sttsumur', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->sttsumur->Lookup = new Lookup('sttsumur', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_bayar
        $this->status_bayar = new DbField('vrajal', 'vrajal', 'x_status_bayar', 'status_bayar', '`status_bayar`', '`status_bayar`', 202, 11, -1, false, '`status_bayar`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_bayar->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_bayar->Lookup = new Lookup('status_bayar', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_bayar->Lookup = new Lookup('status_bayar', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_poli
        $this->status_poli = new DbField('vrajal', 'vrajal', 'x_status_poli', 'status_poli', '`status_poli`', '`status_poli`', 202, 11, -1, false, '`status_poli`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_poli->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_poli->Lookup = new Lookup('status_poli', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_poli->Lookup = new Lookup('status_poli', 'vrajal', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // cetak
        $this->cetak = new DbField('vrajal', 'vrajal', 'x_cetak', 'cetak', '\'\'', '\'\'', 201, 65530, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "cppt") {
            $detailUrl = Container("cppt")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "billing") {
            $detailUrl = Container("billing")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "konsul") {
            $detailUrl = Container("konsul")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue);
        }
        ...
        if ($this->getCurrentDetailTable() == "resep_dokter") {
            $detailUrl = Container("resep_dokter")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue);
        }
        if ($this->getCurrentDetailTable() == "prmrj") {
            $detailUrl = Container("prmrj")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
    ...
    {
        // Cascade Update detail table 'catatan_medis'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_reg'
            $cascadeUpdate = true;
            $rscascade['no_reg'] = $rs['id_reg'];
        }
        if ($cascadeUpdate) {
            $rswrk = Container("catatan_medis")->loadRs("`no_reg` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_catatan_medis';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("catatan_medis")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("catatan_medis")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("catatan_medis")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'penilaian_awal_keperawatan_ralan'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_rawat'
            $cascadeUpdate = true;
            $rscascade['no_rawat'] = $rs['id_reg'];
        }
        if ($cascadeUpdate) {
            $rswrk = Container("penilaian_awal_keperawatan_ralan")->loadRs("`no_rawat` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_penilaian_awal_keperawatan';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("penilaian_awal_keperawatan_ralan")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("penilaian_awal_keperawatan_ralan")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("penilaian_awal_keperawatan_ralan")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'penilaian_medis_ralan'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_rawat'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("penilaian_medis_ralan")->loadRs("`no_rawat` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_penilaian_medis_ralan';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("penilaian_medis_ralan")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("penilaian_medis_ralan")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("penilaian_medis_ralan")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'penilaian_awal_keperawatan_ralan_psikiatri'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_rawat'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("penilaian_awal_keperawatan_ralan_psikiatri")->loadRs("`no_rawat` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_penilaian_awal_keperawatan_ralan_psikiatri';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("penilaian_awal_keperawatan_ralan_psikiatri")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("penilaian_awal_keperawatan_ralan_psikiatri")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("penilaian_awal_keperawatan_ralan_psikiatri")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'penilaian_psikologi'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_rawat'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("penilaian_psikologi")->loadRs("`no_rawat` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_penilaian_psikologi';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("penilaian_psikologi")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("penilaian_psikologi")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("penilaian_psikologi")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'diagnosa_pasien'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_rawat'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("diagnosa_pasien")->loadRs("`no_rawat` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_diagnosa_pasien';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("diagnosa_pasien")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("diagnosa_pasien")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("diagnosa_pasien")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'cppt'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_reg'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("cppt")->loadRs("`no_reg` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_cppt';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("cppt")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("cppt")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("cppt")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'billing'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_reg'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("billing")->loadRs("`no_reg` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_billing';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("billing")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("billing")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("billing")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'konsul'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_reg'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("konsul")->loadRs("`no_reg` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_konsul';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("konsul")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("konsul")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("konsul")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'pemeriksaan_ralan'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_rawat'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("pemeriksaan_ralan")->loadRs("`no_rawat` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_pemeriksaan_ralan';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("pemeriksaan_ralan")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("pemeriksaan_ralan")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("pemeriksaan_ralan")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'tindak_lanjut'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_reg'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("tindak_lanjut")->loadRs("`no_reg` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_tindak_lanjut';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("tindak_lanjut")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("tindak_lanjut")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("tindak_lanjut")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'resep_dokter'
        $cascadeUpdate = false;
        $rscascade = [];
        if ($rsold && (isset($rs['id_reg']) && $rsold['id_reg'] != $rs['id_reg'])) { // Update detail field 'no_reg'
            $cascadeUpdate = true;
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("resep_dokter")->loadRs("`no_reg` = " . QuotedValue($rsold['id_reg'], DATATYPE_NUMBER, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $fldname = 'id_resep_dokter';
                $rskey[$fldname] = $rsdtlold[$fldname];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("resep_dokter")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("resep_dokter")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("resep_dokter")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }

        // Cascade Update detail table 'prmrj'
        $cascadeUpdate = false;
        $rscascade = [];
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("prmrj")->loadRs("pasien_kunjungan.no_rkm_medis = " . QuotedValue($rsold['no_rkm_medis'], DATATYPE_STRING, 'DB'))->fetchAll(\PDO::FETCH_ASSOC);
            foreach ($rswrk as $rsdtlold) {
                $rskey = [];
                $rsdtlnew = array_merge($rsdtlold, $rscascade);
                // Call Row_Updating event
                $success = Container("prmrj")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("prmrj")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("prmrj")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }
    ...
    public function delete(&$rs, $where = "", $curfilter = false)
    {
        ...
        // Cascade delete detail table 'catatan_medis'
        $dtlrows = Container("catatan_medis")->loadRs("`no_reg` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("catatan_medis")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("catatan_medis")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("catatan_medis")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'penilaian_awal_keperawatan_ralan'
        $dtlrows = Container("penilaian_awal_keperawatan_ralan")->loadRs("`no_rawat` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("penilaian_awal_keperawatan_ralan")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("penilaian_awal_keperawatan_ralan")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("penilaian_awal_keperawatan_ralan")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'penilaian_medis_ralan'
        $dtlrows = Container("penilaian_medis_ralan")->loadRs("`no_rawat` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("penilaian_medis_ralan")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("penilaian_medis_ralan")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("penilaian_medis_ralan")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'penilaian_awal_keperawatan_ralan_psikiatri'
        $dtlrows = Container("penilaian_awal_keperawatan_ralan_psikiatri")->loadRs("`no_rawat` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("penilaian_awal_keperawatan_ralan_psikiatri")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("penilaian_awal_keperawatan_ralan_psikiatri")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("penilaian_awal_keperawatan_ralan_psikiatri")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'penilaian_psikologi'
        $dtlrows = Container("penilaian_psikologi")->loadRs("`no_rawat` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("penilaian_psikologi")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("penilaian_psikologi")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("penilaian_psikologi")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'diagnosa_pasien'
        $dtlrows = Container("diagnosa_pasien")->loadRs("`no_rawat` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("diagnosa_pasien")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("diagnosa_pasien")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("diagnosa_pasien")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'cppt'
        $dtlrows = Container("cppt")->loadRs("`no_reg` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("cppt")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("cppt")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("cppt")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'billing'
        $dtlrows = Container("billing")->loadRs("`no_reg` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("billing")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("billing")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("billing")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'konsul'
        $dtlrows = Container("konsul")->loadRs("`no_reg` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("konsul")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("konsul")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("konsul")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'pemeriksaan_ralan'
        $dtlrows = Container("pemeriksaan_ralan")->loadRs("`no_rawat` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("pemeriksaan_ralan")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("pemeriksaan_ralan")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("pemeriksaan_ralan")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'tindak_lanjut'
        $dtlrows = Container("tindak_lanjut")->loadRs("`no_reg` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("tindak_lanjut")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("tindak_lanjut")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("tindak_lanjut")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'resep_dokter'
        $dtlrows = Container("resep_dokter")->loadRs("`no_reg` = " . QuotedValue($rs['id_reg'], DATATYPE_NUMBER, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("resep_dokter")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("resep_dokter")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("resep_dokter")->rowDeleted($dtlrow);
            }
        }

        // Cascade delete detail table 'prmrj'
        $dtlrows = Container("prmrj")->loadRs("pasien_kunjungan.no_rkm_medis = " . QuotedValue($rs['no_rkm_medis'], DATATYPE_STRING, "DB"))->fetchAll(\PDO::FETCH_ASSOC);
        // Call Row Deleting event
        foreach ($dtlrows as $dtlrow) {
            $success = Container("prmrj")->rowDeleting($dtlrow);
            if (!$success) {
                break;
            }
        }
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                $success = Container("prmrj")->delete($dtlrow); // Delete
                if (!$success) {
                    break;
                }
            }
        ...
        if ($success) {
            foreach ($dtlrows as $dtlrow) {
                Container("prmrj")->rowDeleted($dtlrow);
            }
        }
        if ($success) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VrajalList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "VrajalEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VrajalAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VrajalView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VrajalView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VrajalAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VrajalAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VrajalEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VrajalEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VrajalAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VrajalAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VrajalDelete", $this->getUrlParm());
    }

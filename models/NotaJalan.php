...
/**
 * Table class for nota_jalan
 */
class NotaJalan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'nota_jalan';
        $this->TableName = 'nota_jalan';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`nota_jalan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // no_rawat
        $this->no_rawat = new DbField('nota_jalan', 'nota_jalan', 'x_no_rawat', 'no_rawat', '`no_rawat`', '`no_rawat`', 200, 17, -1, false, '`no_rawat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_nota
        $this->no_nota = new DbField('nota_jalan', 'nota_jalan', 'x_no_nota', 'no_nota', '`no_nota`', '`no_nota`', 200, 17, -1, false, '`no_nota`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->no_nota->Sortable = true; // Allow sort
        $this->no_nota->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->no_nota->Param, "CustomMsg");
        $this->Fields['no_nota'] = &$this->no_nota;

        // tanggal
        $this->tanggal = new DbField('nota_jalan', 'nota_jalan', 'x_tanggal', 'tanggal', '`tanggal`', CastDateFieldForLike("`tanggal`", 0, "DB"), 133, 10, 0, false, '`tanggal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jam
        $this->jam = new DbField('nota_jalan', 'nota_jalan', 'x_jam', 'jam', '`jam`', CastDateFieldForLike("`jam`", 4, "DB"), 134, 10, 4, false, '`jam`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->jam->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->jam->Param, "CustomMsg");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`nota_jalan`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->no_nota->DbValue = $row['no_nota'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("NotaJalanList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "NotaJalanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "NotaJalanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "NotaJalanView";
            case Config("API_ADD_ACTION"):
                return "NotaJalanAdd";
            case Config("API_EDIT_ACTION"):
                return "NotaJalanEdit";
            case Config("API_DELETE_ACTION"):
                return "NotaJalanDelete";
            case Config("API_LIST_ACTION"):
                return "NotaJalanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("NotaJalanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("NotaJalanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "NotaJalanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "NotaJalanAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("NotaJalanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("NotaJalanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("NotaJalanDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function renderEditRow()
    {
        ...
        $this->no_nota->EditValue = $this->no_nota->CurrentValue;
        ...
        $this->jam->EditValue = FormatDateTime($this->jam->CurrentValue, 4);
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->no_nota);

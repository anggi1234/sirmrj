...
class MPasien extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id_pasien
        $this->id_pasien = new DbField('m_pasien', 'm_pasien', 'x_id_pasien', 'id_pasien', '`id_pasien`', '`id_pasien`', 3, 255, -1, false, '`id_pasien`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_rkm_medis
        $this->no_rkm_medis = new DbField('m_pasien', 'm_pasien', 'x_no_rkm_medis', 'no_rkm_medis', '`no_rkm_medis`', '`no_rkm_medis`', 200, 15, -1, false, '`no_rkm_medis`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->no_rkm_medis->Nullable = false; // NOT NULL field
        ...
        // nm_pasien
        $this->nm_pasien = new DbField('m_pasien', 'm_pasien', 'x_nm_pasien', 'nm_pasien', '`nm_pasien`', '`nm_pasien`', 200, 40, -1, false, '`nm_pasien`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_ktp
        $this->no_ktp = new DbField('m_pasien', 'm_pasien', 'x_no_ktp', 'no_ktp', '`no_ktp`', '`no_ktp`', 200, 20, -1, false, '`no_ktp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->no_ktp->Nullable = false; // NOT NULL field
        ...
        // jk
        $this->jk = new DbField('m_pasien', 'm_pasien', 'x_jk', 'jk', '`jk`', '`jk`', 202, 1, -1, false, '`jk`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->jk->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->jk->Lookup = new Lookup('jk', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->jk->Lookup = new Lookup('jk', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // tmp_lahir
        $this->tmp_lahir = new DbField('m_pasien', 'm_pasien', 'x_tmp_lahir', 'tmp_lahir', '`tmp_lahir`', '`tmp_lahir`', 200, 15, -1, false, '`tmp_lahir`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_lahir
        $this->tgl_lahir = new DbField('m_pasien', 'm_pasien', 'x_tgl_lahir', 'tgl_lahir', '`tgl_lahir`', CastDateFieldForLike("`tgl_lahir`", 0, "DB"), 133, 10, 0, false, '`tgl_lahir`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nm_ibu
        $this->nm_ibu = new DbField('m_pasien', 'm_pasien', 'x_nm_ibu', 'nm_ibu', '`nm_ibu`', '`nm_ibu`', 200, 40, -1, false, '`nm_ibu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->nm_ibu->Nullable = false; // NOT NULL field
        ...
        // alamat
        $this->alamat = new DbField('m_pasien', 'm_pasien', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, 200, -1, false, '`alamat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->alamat->Sortable = true; // Allow sort
        $this->alamat->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->alamat->Param, "CustomMsg");
        $this->Fields['alamat'] = &$this->alamat;

        // gol_darah
        $this->gol_darah = new DbField('m_pasien', 'm_pasien', 'x_gol_darah', 'gol_darah', '`gol_darah`', '`gol_darah`', 202, 2, -1, false, '`gol_darah`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->gol_darah->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->gol_darah->Lookup = new Lookup('gol_darah', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->gol_darah->Lookup = new Lookup('gol_darah', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // pekerjaan
        $this->pekerjaan = new DbField('m_pasien', 'm_pasien', 'x_pekerjaan', 'pekerjaan', '`pekerjaan`', '`pekerjaan`', 200, 60, -1, false, '`pekerjaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // stts_nikah
        $this->stts_nikah = new DbField('m_pasien', 'm_pasien', 'x_stts_nikah', 'stts_nikah', '`stts_nikah`', '`stts_nikah`', 202, 13, -1, false, '`stts_nikah`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->stts_nikah->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->stts_nikah->Lookup = new Lookup('stts_nikah', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->stts_nikah->Lookup = new Lookup('stts_nikah', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // agama
        $this->agama = new DbField('m_pasien', 'm_pasien', 'x_agama', 'agama', '`agama`', '`agama`', 200, 12, -1, false, '`agama`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // tgl_daftar
        $this->tgl_daftar = new DbField('m_pasien', 'm_pasien', 'x_tgl_daftar', 'tgl_daftar', '`tgl_daftar`', CastDateFieldForLike("`tgl_daftar`", 0, "DB"), 133, 10, 0, false, '`tgl_daftar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_tlp
        $this->no_tlp = new DbField('m_pasien', 'm_pasien', 'x_no_tlp', 'no_tlp', '`no_tlp`', '`no_tlp`', 200, 40, -1, false, '`no_tlp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // umur
        $this->umur = new DbField('m_pasien', 'm_pasien', 'x_umur', 'umur', '`umur`', '`umur`', 200, 30, -1, false, '`umur`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->umur->Nullable = false; // NOT NULL field
        ...
        // pnd
        $this->pnd = new DbField('m_pasien', 'm_pasien', 'x_pnd', 'pnd', '`pnd`', '`pnd`', 202, 14, -1, false, '`pnd`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->pnd->Nullable = false; // NOT NULL field
        $this->pnd->Required = true; // Required field
        $this->pnd->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->pnd->Lookup = new Lookup('pnd', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->pnd->Lookup = new Lookup('pnd', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // keluarga
        $this->keluarga = new DbField('m_pasien', 'm_pasien', 'x_keluarga', 'keluarga', '`keluarga`', '`keluarga`', 202, 7, -1, false, '`keluarga`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->keluarga->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->keluarga->Lookup = new Lookup('keluarga', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->keluarga->Lookup = new Lookup('keluarga', 'm_pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // namakeluarga
        $this->namakeluarga = new DbField('m_pasien', 'm_pasien', 'x_namakeluarga', 'namakeluarga', '`namakeluarga`', '`namakeluarga`', 200, 50, -1, false, '`namakeluarga`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->namakeluarga->Nullable = false; // NOT NULL field
        ...
        // kd_pj
        $this->kd_pj = new DbField('m_pasien', 'm_pasien', 'x_kd_pj', 'kd_pj', '`kd_pj`', '`kd_pj`', 200, 3, -1, false, '`kd_pj`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // no_peserta
        $this->no_peserta = new DbField('m_pasien', 'm_pasien', 'x_no_peserta', 'no_peserta', '`no_peserta`', '`no_peserta`', 200, 25, -1, false, '`no_peserta`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_kel
        $this->kd_kel = new DbField('m_pasien', 'm_pasien', 'x_kd_kel', 'kd_kel', '`kd_kel`', '`kd_kel`', 3, 11, -1, false, '`kd_kel`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->kd_kel->Nullable = false; // NOT NULL field
        ...
        // kd_kec
        $this->kd_kec = new DbField('m_pasien', 'm_pasien', 'x_kd_kec', 'kd_kec', '`kd_kec`', '`kd_kec`', 3, 11, -1, false, '`kd_kec`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->kd_kec->Nullable = false; // NOT NULL field
        ...
        // kd_kab
        $this->kd_kab = new DbField('m_pasien', 'm_pasien', 'x_kd_kab', 'kd_kab', '`kd_kab`', '`kd_kab`', 3, 11, -1, false, '`kd_kab`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->kd_kab->Nullable = false; // NOT NULL field
        ...
        // kd_prop
        $this->kd_prop = new DbField('m_pasien', 'm_pasien', 'x_kd_prop', 'kd_prop', '`kd_prop`', '`kd_prop`', 3, 11, -1, false, '`kd_prop`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // pekerjaanpj
        $this->pekerjaanpj = new DbField('m_pasien', 'm_pasien', 'x_pekerjaanpj', 'pekerjaanpj', '`pekerjaanpj`', '`pekerjaanpj`', 200, 35, -1, false, '`pekerjaanpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->pekerjaanpj->Nullable = false; // NOT NULL field
        ...
        // alamatpj
        $this->alamatpj = new DbField('m_pasien', 'm_pasien', 'x_alamatpj', 'alamatpj', '`alamatpj`', '`alamatpj`', 200, 100, -1, false, '`alamatpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->alamatpj->Nullable = false; // NOT NULL field
        ...
        // kelurahanpj
        $this->kelurahanpj = new DbField('m_pasien', 'm_pasien', 'x_kelurahanpj', 'kelurahanpj', '`kelurahanpj`', '`kelurahanpj`', 200, 60, -1, false, '`kelurahanpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->kelurahanpj->Nullable = false; // NOT NULL field
        ...
        // kecamatanpj
        $this->kecamatanpj = new DbField('m_pasien', 'm_pasien', 'x_kecamatanpj', 'kecamatanpj', '`kecamatanpj`', '`kecamatanpj`', 200, 60, -1, false, '`kecamatanpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->kecamatanpj->Nullable = false; // NOT NULL field
        ...
        // kabupatenpj
        $this->kabupatenpj = new DbField('m_pasien', 'm_pasien', 'x_kabupatenpj', 'kabupatenpj', '`kabupatenpj`', '`kabupatenpj`', 200, 60, -1, false, '`kabupatenpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->kabupatenpj->Nullable = false; // NOT NULL field
        ...
        // perusahaan_pasien
        $this->perusahaan_pasien = new DbField('m_pasien', 'm_pasien', 'x_perusahaan_pasien', 'perusahaan_pasien', '`perusahaan_pasien`', '`perusahaan_pasien`', 200, 8, -1, false, '`perusahaan_pasien`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->perusahaan_pasien->Nullable = false; // NOT NULL field
        ...
        // suku_bangsa
        $this->suku_bangsa = new DbField('m_pasien', 'm_pasien', 'x_suku_bangsa', 'suku_bangsa', '`suku_bangsa`', '`suku_bangsa`', 3, 11, -1, false, '`suku_bangsa`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // bahasa_pasien
        $this->bahasa_pasien = new DbField('m_pasien', 'm_pasien', 'x_bahasa_pasien', 'bahasa_pasien', '`bahasa_pasien`', '`bahasa_pasien`', 3, 11, -1, false, '`bahasa_pasien`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // cacat_fisik
        $this->cacat_fisik = new DbField('m_pasien', 'm_pasien', 'x_cacat_fisik', 'cacat_fisik', '`cacat_fisik`', '`cacat_fisik`', 3, 11, -1, false, '`cacat_fisik`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // email
        $this->_email = new DbField('m_pasien', 'm_pasien', 'x__email', 'email', '`email`', '`email`', 200, 50, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nip
        $this->nip = new DbField('m_pasien', 'm_pasien', 'x_nip', 'nip', '`nip`', '`nip`', 200, 30, -1, false, '`nip`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // propinsipj
        $this->propinsipj = new DbField('m_pasien', 'm_pasien', 'x_propinsipj', 'propinsipj', '`propinsipj`', '`propinsipj`', 200, 30, -1, false, '`propinsipj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`m_pasien`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MPasienList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "MPasienEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MPasienAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MPasienView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MPasienView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MPasienAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MPasienAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MPasienEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MPasienAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MPasienDelete", $this->getUrlParm());
    }

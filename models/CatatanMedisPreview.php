 ...
 * Page class
 */
class CatatanMedisPreview extends CatatanMedis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CatatanMedisPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "vigd") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->no_reg->QueryStringValue) . "";
        }
        if ($masterTblVar == "vrajal") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->no_reg->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "vigd") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->no_reg->setQueryStringValue($val);
            }
        }
        if ($masterTblVar == "vrajal") {
            $find = "`no_reg`=";

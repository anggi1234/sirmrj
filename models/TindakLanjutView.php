 ...
 * Page class
 */
class TindakLanjutView extends TindakLanjut
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TindakLanjutView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_tindak_lanjut") ?? Route("id_tindak_lanjut")) !== null) {
            $this->RecKey["id_tindak_lanjut"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $this->id_tindak_lanjut->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_tindak_lanjut") ?? Route("id_tindak_lanjut")) !== null) {
                ...
                $this->RecKey["id_tindak_lanjut"] = $this->id_tindak_lanjut->QueryStringValue;
            } elseif (Post("id_tindak_lanjut") !== null) {
                $this->id_tindak_lanjut->setFormValue(Post("id_tindak_lanjut"));
                $this->RecKey["id_tindak_lanjut"] = $this->id_tindak_lanjut->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_tindak_lanjut->setQueryStringValue($keyValue);
                $this->RecKey["id_tindak_lanjut"] = $this->id_tindak_lanjut->QueryStringValue;
            } else {
                $returnUrl = "TindakLanjutList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TindakLanjutList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TindakLanjutList"; // Not page request, return to list
        }
        if ($returnUrl != "") {

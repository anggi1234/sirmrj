...
/**
 * Table class for reg_periksa
 */
class RegPeriksa extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'reg_periksa';
        $this->TableName = 'reg_periksa';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`reg_periksa`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // no_reg
        $this->no_reg = new DbField('reg_periksa', 'reg_periksa', 'x_no_reg', 'no_reg', '`no_reg`', '`no_reg`', 200, 8, -1, false, '`no_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_rawat
        $this->no_rawat = new DbField('reg_periksa', 'reg_periksa', 'x_no_rawat', 'no_rawat', '`no_rawat`', '`no_rawat`', 200, 17, -1, false, '`no_rawat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_registrasi
        $this->tgl_registrasi = new DbField('reg_periksa', 'reg_periksa', 'x_tgl_registrasi', 'tgl_registrasi', '`tgl_registrasi`', CastDateFieldForLike("`tgl_registrasi`", 0, "DB"), 133, 10, 0, false, '`tgl_registrasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tgl_registrasi->Sortable = true; // Allow sort
        $this->tgl_registrasi->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        ...
        // jam_reg
        $this->jam_reg = new DbField('reg_periksa', 'reg_periksa', 'x_jam_reg', 'jam_reg', '`jam_reg`', CastDateFieldForLike("`jam_reg`", 4, "DB"), 134, 10, 4, false, '`jam_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_dokter
        $this->kd_dokter = new DbField('reg_periksa', 'reg_periksa', 'x_kd_dokter', 'kd_dokter', '`kd_dokter`', '`kd_dokter`', 200, 20, -1, false, '`kd_dokter`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_rkm_medis
        $this->no_rkm_medis = new DbField('reg_periksa', 'reg_periksa', 'x_no_rkm_medis', 'no_rkm_medis', '`no_rkm_medis`', '`no_rkm_medis`', 200, 15, -1, false, '`no_rkm_medis`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->no_rkm_medis->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->no_rkm_medis->Lookup = new Lookup('no_rkm_medis', 'm_pasien', false, 'no_rkm_medis', ["no_rkm_medis","nm_pasien","alamat","nm_ibu"], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->no_rkm_medis->Lookup = new Lookup('no_rkm_medis', 'm_pasien', false, 'no_rkm_medis', ["no_rkm_medis","nm_pasien","alamat","nm_ibu"], [], [], [], [], [], [], '', '');
                break;
        ...
        // kd_poli
        $this->kd_poli = new DbField('reg_periksa', 'reg_periksa', 'x_kd_poli', 'kd_poli', '`kd_poli`', '`kd_poli`', 200, 5, -1, false, '`kd_poli`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // p_jawab
        $this->p_jawab = new DbField('reg_periksa', 'reg_periksa', 'x_p_jawab', 'p_jawab', '`p_jawab`', '`p_jawab`', 200, 100, -1, false, '`p_jawab`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // almt_pj
        $this->almt_pj = new DbField('reg_periksa', 'reg_periksa', 'x_almt_pj', 'almt_pj', '`almt_pj`', '`almt_pj`', 200, 200, -1, false, '`almt_pj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // hubunganpj
        $this->hubunganpj = new DbField('reg_periksa', 'reg_periksa', 'x_hubunganpj', 'hubunganpj', '`hubunganpj`', '`hubunganpj`', 200, 20, -1, false, '`hubunganpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // biaya_reg
        $this->biaya_reg = new DbField('reg_periksa', 'reg_periksa', 'x_biaya_reg', 'biaya_reg', '`biaya_reg`', '`biaya_reg`', 5, 22, -1, false, '`biaya_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // stts
        $this->stts = new DbField('reg_periksa', 'reg_periksa', 'x_stts', 'stts', '`stts`', '`stts`', 202, 15, -1, false, '`stts`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->stts->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->stts->Lookup = new Lookup('stts', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->stts->Lookup = new Lookup('stts', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // stts_daftar
        $this->stts_daftar = new DbField('reg_periksa', 'reg_periksa', 'x_stts_daftar', 'stts_daftar', '`stts_daftar`', '`stts_daftar`', 202, 4, -1, false, '`stts_daftar`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->stts_daftar->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->stts_daftar->Lookup = new Lookup('stts_daftar', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->stts_daftar->Lookup = new Lookup('stts_daftar', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_lanjut
        $this->status_lanjut = new DbField('reg_periksa', 'reg_periksa', 'x_status_lanjut', 'status_lanjut', '`status_lanjut`', '`status_lanjut`', 202, 5, -1, false, '`status_lanjut`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_lanjut->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_lanjut->Lookup = new Lookup('status_lanjut', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_lanjut->Lookup = new Lookup('status_lanjut', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // kd_pj
        $this->kd_pj = new DbField('reg_periksa', 'reg_periksa', 'x_kd_pj', 'kd_pj', '`kd_pj`', '`kd_pj`', 200, 3, -1, false, '`kd_pj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // umurdaftar
        $this->umurdaftar = new DbField('reg_periksa', 'reg_periksa', 'x_umurdaftar', 'umurdaftar', '`umurdaftar`', '`umurdaftar`', 3, 11, -1, false, '`umurdaftar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sttsumur
        $this->sttsumur = new DbField('reg_periksa', 'reg_periksa', 'x_sttsumur', 'sttsumur', '`sttsumur`', '`sttsumur`', 202, 2, -1, false, '`sttsumur`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->sttsumur->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->sttsumur->Lookup = new Lookup('sttsumur', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->sttsumur->Lookup = new Lookup('sttsumur', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_bayar
        $this->status_bayar = new DbField('reg_periksa', 'reg_periksa', 'x_status_bayar', 'status_bayar', '`status_bayar`', '`status_bayar`', 202, 11, -1, false, '`status_bayar`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_bayar->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_bayar->Lookup = new Lookup('status_bayar', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_bayar->Lookup = new Lookup('status_bayar', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_poli
        $this->status_poli = new DbField('reg_periksa', 'reg_periksa', 'x_status_poli', 'status_poli', '`status_poli`', '`status_poli`', 202, 11, -1, false, '`status_poli`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_poli->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_poli->Lookup = new Lookup('status_poli', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_poli->Lookup = new Lookup('status_poli', 'reg_periksa', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // id_reg
        $this->id_reg = new DbField('reg_periksa', 'reg_periksa', 'x_id_reg', 'id_reg', '`id_reg`', '`id_reg`', 3, 11, -1, false, '`id_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->id_reg->Nullable = false; // NOT NULL field
        $this->id_reg->Required = true; // Required field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`reg_periksa`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RegPeriksaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "RegPeriksaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RegPeriksaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "RegPeriksaView";
            case Config("API_ADD_ACTION"):
                return "RegPeriksaAdd";
            case Config("API_EDIT_ACTION"):
                return "RegPeriksaEdit";
            case Config("API_DELETE_ACTION"):
                return "RegPeriksaDelete";
            case Config("API_LIST_ACTION"):
                return "RegPeriksaList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RegPeriksaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RegPeriksaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RegPeriksaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RegPeriksaAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("RegPeriksaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RegPeriksaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RegPeriksaDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->no_rawat->CurrentValue = $key;
            } else {
                $this->no_rawat->OldValue = $key;
            }

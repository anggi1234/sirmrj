 ...
 * Page class
 */
class BillingList extends Billing
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BillingList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fbillinglist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "BillingAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "BillingDelete";
        $this->MultiUpdateUrl = "BillingUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fbillinglistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->id_billing->AdvancedSearch->toJson(), ","); // Field id_billing
        $filterList = Concat($filterList, $this->no_reg->AdvancedSearch->toJson(), ","); // Field no_reg
        $filterList = Concat($filterList, $this->tgl_byr->AdvancedSearch->toJson(), ","); // Field tgl_byr
        $filterList = Concat($filterList, $this->no->AdvancedSearch->toJson(), ","); // Field no
        $filterList = Concat($filterList, $this->nm_perawatan->AdvancedSearch->toJson(), ","); // Field nm_perawatan
        $filterList = Concat($filterList, $this->pemisah->AdvancedSearch->toJson(), ","); // Field pemisah
        ...
        $filterList = Concat($filterList, $this->totalbiaya->AdvancedSearch->toJson(), ","); // Field totalbiaya
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fbillinglistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field id_billing
        $this->id_billing->AdvancedSearch->SearchValue = @$filter["x_id_billing"];
        $this->id_billing->AdvancedSearch->SearchOperator = @$filter["z_id_billing"];
        $this->id_billing->AdvancedSearch->SearchCondition = @$filter["v_id_billing"];
        $this->id_billing->AdvancedSearch->SearchValue2 = @$filter["y_id_billing"];
        $this->id_billing->AdvancedSearch->SearchOperator2 = @$filter["w_id_billing"];
        $this->id_billing->AdvancedSearch->save();
        ...
        // Field tgl_byr
        $this->tgl_byr->AdvancedSearch->SearchValue = @$filter["x_tgl_byr"];
        $this->tgl_byr->AdvancedSearch->SearchOperator = @$filter["z_tgl_byr"];
        $this->tgl_byr->AdvancedSearch->SearchCondition = @$filter["v_tgl_byr"];
        $this->tgl_byr->AdvancedSearch->SearchValue2 = @$filter["y_tgl_byr"];
        $this->tgl_byr->AdvancedSearch->SearchOperator2 = @$filter["w_tgl_byr"];
        $this->tgl_byr->AdvancedSearch->save();
        ...
        // Field nm_perawatan
        $this->nm_perawatan->AdvancedSearch->SearchValue = @$filter["x_nm_perawatan"];
        $this->nm_perawatan->AdvancedSearch->SearchOperator = @$filter["z_nm_perawatan"];
        $this->nm_perawatan->AdvancedSearch->SearchCondition = @$filter["v_nm_perawatan"];
        $this->nm_perawatan->AdvancedSearch->SearchValue2 = @$filter["y_nm_perawatan"];
        $this->nm_perawatan->AdvancedSearch->SearchOperator2 = @$filter["w_nm_perawatan"];
        $this->nm_perawatan->AdvancedSearch->save();

        // Field pemisah
        $this->pemisah->AdvancedSearch->SearchValue = @$filter["x_pemisah"];
        $this->pemisah->AdvancedSearch->SearchOperator = @$filter["z_pemisah"];
        $this->pemisah->AdvancedSearch->SearchCondition = @$filter["v_pemisah"];
        $this->pemisah->AdvancedSearch->SearchValue2 = @$filter["y_pemisah"];
        $this->pemisah->AdvancedSearch->SearchOperator2 = @$filter["w_pemisah"];
        $this->pemisah->AdvancedSearch->save();
        ...
        // Field totalbiaya
        $this->totalbiaya->AdvancedSearch->SearchValue = @$filter["x_totalbiaya"];
        $this->totalbiaya->AdvancedSearch->SearchOperator = @$filter["z_totalbiaya"];
        $this->totalbiaya->AdvancedSearch->SearchCondition = @$filter["v_totalbiaya"];
        $this->totalbiaya->AdvancedSearch->SearchValue2 = @$filter["y_totalbiaya"];
        $this->totalbiaya->AdvancedSearch->SearchOperator2 = @$filter["w_totalbiaya"];
        $this->totalbiaya->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->no, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->nm_perawatan, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->pemisah, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->tgl_byr); // tgl_byr
            $this->updateSort($this->no); // no
            $this->updateSort($this->nm_perawatan); // nm_perawatan
            $this->updateSort($this->pemisah); // pemisah
            $this->updateSort($this->biaya); // biaya
            $this->updateSort($this->jumlah); // jumlah
            $this->updateSort($this->tambahan); // tambahan
            $this->updateSort($this->totalbiaya); // totalbiaya
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->id_billing->setSort("");
                $this->no_reg->setSort("");
                $this->tgl_byr->setSort("");
                $this->no->setSort("");
                $this->nm_perawatan->setSort("");
                $this->pemisah->setSort("");
                $this->biaya->setSort("");
                $this->jumlah->setSort("");
                $this->tambahan->setSort("");
                $this->totalbiaya->setSort("");
                $this->status->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if (IsMobile()) {
                    ...
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"billing\" data-caption=\"" . $viewcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,url:'" . HtmlEncode(GetUrl($this->ViewUrl)) . "',btn:null});\">" . $Language->phrase("ViewLink") . "</a>";
                }
            } else {
                $opt->Body = "";
            }
            ...
            if ($Security->canEdit()) {
                if (IsMobile()) {
                    ...
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"billing\" data-caption=\"" . $editcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SaveBtn',url:'" . HtmlEncode(GetUrl($this->EditUrl)) . "'});\">" . $Language->phrase("EditLink") . "</a>";
                }
            } else {
                $opt->Body = "";
            }
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_billing->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if (IsMobile()) {
            ...
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"billing\" data-caption=\"" . $addcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'AddBtn',url:'" . HtmlEncode(GetUrl($this->AddUrl)) . "'});\">" . $Language->phrase("AddLink") . "</a>";
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fbillinglistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fbillinglistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fbillinglist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fbillinglist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fbillinglist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fbillinglist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_billing" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_billing\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fbillinglist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fbillinglistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;

 ...
 * Page class
 */
class VrajalEdit extends Vrajal
{
    use MessagesTrait;
    ...
    protected function validateForm()
    {
        ...
        if (in_array("cppt", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }
        $detailPage = Container("BillingGrid");
        if (in_array("billing", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }
        $detailPage = Container("KonsulGrid");
        if (in_array("konsul", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }
        ...
        if (in_array("resep_dokter", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }
        $detailPage = Container("PrmrjGrid");
        if (in_array("prmrj", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->validateGridForm();
        }

...
/**
 * Table class for penilaian_medis_ralan_anak
 */
class PenilaianMedisRalanAnak extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $id_penilaian_medis_ralan_anak;
    public $no_rawat;
    public $tanggal;
    public $kd_dokter;
    public $anamnesis;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'penilaian_medis_ralan_anak';
        $this->TableName = 'penilaian_medis_ralan_anak';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`penilaian_medis_ralan_anak`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->id_penilaian_medis_ralan_anak = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_id_penilaian_medis_ralan_anak', 'id_penilaian_medis_ralan_anak', '`id_penilaian_medis_ralan_anak`', '`id_penilaian_medis_ralan_anak`', 3, 11, -1, false, '`id_penilaian_medis_ralan_anak`', false, false, false, 'FORMATTED TEXT', 'NO');
        $this->id_penilaian_medis_ralan_anak->IsAutoIncrement = true; // Autoincrement field
        $this->id_penilaian_medis_ralan_anak->IsPrimaryKey = true; // Primary key field
        $this->id_penilaian_medis_ralan_anak->Sortable = true; // Allow sort
        $this->id_penilaian_medis_ralan_anak->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->id_penilaian_medis_ralan_anak->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->id_penilaian_medis_ralan_anak->Param, "CustomMsg");
        $this->Fields['id_penilaian_medis_ralan_anak'] = &$this->id_penilaian_medis_ralan_anak;

        // no_rawat
        $this->no_rawat = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_no_rawat', 'no_rawat', '`no_rawat`', '`no_rawat`', 200, 17, -1, false, '`no_rawat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal
        $this->tanggal = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_tanggal', 'tanggal', '`tanggal`', CastDateFieldForLike("`tanggal`", 0, "DB"), 135, 19, 0, false, '`tanggal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_dokter
        $this->kd_dokter = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_kd_dokter', 'kd_dokter', '`kd_dokter`', '`kd_dokter`', 200, 20, -1, false, '`kd_dokter`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // anamnesis
        $this->anamnesis = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_anamnesis', 'anamnesis', '`anamnesis`', '`anamnesis`', 202, 13, -1, false, '`anamnesis`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->anamnesis->Lookup = new Lookup('anamnesis', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->anamnesis->Lookup = new Lookup('anamnesis', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // hubungan
        $this->hubungan = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_hubungan', 'hubungan', '`hubungan`', '`hubungan`', 200, 100, -1, false, '`hubungan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // keluhan_utama
        $this->keluhan_utama = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_keluhan_utama', 'keluhan_utama', '`keluhan_utama`', '`keluhan_utama`', 201, 2000, -1, false, '`keluhan_utama`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // rps
        $this->rps = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_rps', 'rps', '`rps`', '`rps`', 201, 2000, -1, false, '`rps`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // rpd
        $this->rpd = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_rpd', 'rpd', '`rpd`', '`rpd`', 201, 1000, -1, false, '`rpd`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // rpk
        $this->rpk = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_rpk', 'rpk', '`rpk`', '`rpk`', 201, 1000, -1, false, '`rpk`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // rpo
        $this->rpo = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_rpo', 'rpo', '`rpo`', '`rpo`', 201, 1000, -1, false, '`rpo`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // alergi
        $this->alergi = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_alergi', 'alergi', '`alergi`', '`alergi`', 200, 100, -1, false, '`alergi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // keadaan
        $this->keadaan = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_keadaan', 'keadaan', '`keadaan`', '`keadaan`', 202, 12, -1, false, '`keadaan`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->keadaan->Nullable = false; // NOT NULL field
        $this->keadaan->Required = true; // Required field
        $this->keadaan->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->keadaan->Lookup = new Lookup('keadaan', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->keadaan->Lookup = new Lookup('keadaan', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // gcs
        $this->gcs = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_gcs', 'gcs', '`gcs`', '`gcs`', 200, 10, -1, false, '`gcs`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kesadaran
        $this->kesadaran = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_kesadaran', 'kesadaran', '`kesadaran`', '`kesadaran`', 202, 13, -1, false, '`kesadaran`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->kesadaran->Lookup = new Lookup('kesadaran', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kesadaran->Lookup = new Lookup('kesadaran', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // td
        $this->td = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_td', 'td', '`td`', '`td`', 200, 8, -1, false, '`td`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nadi
        $this->nadi = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_nadi', 'nadi', '`nadi`', '`nadi`', 200, 5, -1, false, '`nadi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rr
        $this->rr = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_rr', 'rr', '`rr`', '`rr`', 200, 5, -1, false, '`rr`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // suhu
        $this->suhu = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_suhu', 'suhu', '`suhu`', '`suhu`', 200, 5, -1, false, '`suhu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // spo
        $this->spo = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_spo', 'spo', '`spo`', '`spo`', 200, 5, -1, false, '`spo`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bb
        $this->bb = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_bb', 'bb', '`bb`', '`bb`', 200, 5, -1, false, '`bb`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tb
        $this->tb = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_tb', 'tb', '`tb`', '`tb`', 200, 5, -1, false, '`tb`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kepala
        $this->kepala = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_kepala', 'kepala', '`kepala`', '`kepala`', 202, 15, -1, false, '`kepala`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->kepala->Nullable = false; // NOT NULL field
        $this->kepala->Required = true; // Required field
        $this->kepala->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->kepala->Lookup = new Lookup('kepala', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kepala->Lookup = new Lookup('kepala', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // mata
        $this->mata = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_mata', 'mata', '`mata`', '`mata`', 202, 15, -1, false, '`mata`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->mata->Nullable = false; // NOT NULL field
        $this->mata->Required = true; // Required field
        $this->mata->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->mata->Lookup = new Lookup('mata', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->mata->Lookup = new Lookup('mata', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // gigi
        $this->gigi = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_gigi', 'gigi', '`gigi`', '`gigi`', 202, 15, -1, false, '`gigi`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->gigi->Nullable = false; // NOT NULL field
        $this->gigi->Required = true; // Required field
        $this->gigi->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->gigi->Lookup = new Lookup('gigi', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->gigi->Lookup = new Lookup('gigi', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // tht
        $this->tht = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_tht', 'tht', '`tht`', '`tht`', 202, 15, -1, false, '`tht`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->tht->Nullable = false; // NOT NULL field
        $this->tht->Required = true; // Required field
        $this->tht->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->tht->Lookup = new Lookup('tht', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->tht->Lookup = new Lookup('tht', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // thoraks
        $this->thoraks = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_thoraks', 'thoraks', '`thoraks`', '`thoraks`', 202, 15, -1, false, '`thoraks`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->thoraks->Nullable = false; // NOT NULL field
        $this->thoraks->Required = true; // Required field
        $this->thoraks->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->thoraks->Lookup = new Lookup('thoraks', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->thoraks->Lookup = new Lookup('thoraks', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // abdomen
        $this->abdomen = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_abdomen', 'abdomen', '`abdomen`', '`abdomen`', 202, 15, -1, false, '`abdomen`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->abdomen->Nullable = false; // NOT NULL field
        $this->abdomen->Required = true; // Required field
        $this->abdomen->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->abdomen->Lookup = new Lookup('abdomen', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->abdomen->Lookup = new Lookup('abdomen', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // genital
        $this->genital = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_genital', 'genital', '`genital`', '`genital`', 202, 15, -1, false, '`genital`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->genital->Nullable = false; // NOT NULL field
        $this->genital->Required = true; // Required field
        $this->genital->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->genital->Lookup = new Lookup('genital', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->genital->Lookup = new Lookup('genital', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // ekstremitas
        $this->ekstremitas = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_ekstremitas', 'ekstremitas', '`ekstremitas`', '`ekstremitas`', 202, 15, -1, false, '`ekstremitas`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->ekstremitas->Lookup = new Lookup('ekstremitas', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ekstremitas->Lookup = new Lookup('ekstremitas', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // kulit
        $this->kulit = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_kulit', 'kulit', '`kulit`', '`kulit`', 202, 15, -1, false, '`kulit`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->kulit->Nullable = false; // NOT NULL field
        $this->kulit->Required = true; // Required field
        $this->kulit->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->kulit->Lookup = new Lookup('kulit', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kulit->Lookup = new Lookup('kulit', 'penilaian_medis_ralan_anak', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // ket_fisik
        $this->ket_fisik = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_ket_fisik', 'ket_fisik', '`ket_fisik`', '`ket_fisik`', 201, 65535, -1, false, '`ket_fisik`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ket_lokalis
        $this->ket_lokalis = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_ket_lokalis', 'ket_lokalis', '`ket_lokalis`', '`ket_lokalis`', 201, 65535, -1, false, '`ket_lokalis`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // penunjang
        $this->penunjang = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_penunjang', 'penunjang', '`penunjang`', '`penunjang`', 201, 65535, -1, false, '`penunjang`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // diagnosis
        $this->diagnosis = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_diagnosis', 'diagnosis', '`diagnosis`', '`diagnosis`', 201, 500, -1, false, '`diagnosis`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // tata
        $this->tata = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_tata', 'tata', '`tata`', '`tata`', 201, 65535, -1, false, '`tata`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // konsul
        $this->konsul = new DbField('penilaian_medis_ralan_anak', 'penilaian_medis_ralan_anak', 'x_konsul', 'konsul', '`konsul`', '`konsul`', 201, 1000, -1, false, '`konsul`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->konsul->Nullable = false; // NOT NULL field
        $this->konsul->Required = true; // Required field
        $this->konsul->Sortable = true; // Allow sort
        $this->konsul->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->konsul->Param, "CustomMsg");
        $this->Fields['konsul'] = &$this->konsul;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`penilaian_medis_ralan_anak`";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($success) {
            ...
            $this->id_penilaian_medis_ralan_anak->setDbValue($conn->lastInsertId());
            $rs['id_penilaian_medis_ralan_anak'] = $this->id_penilaian_medis_ralan_anak->DbValue;
        }
        return $success;
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('id_penilaian_medis_ralan_anak', $rs)) {
                AddFilter($where, QuotedName('id_penilaian_medis_ralan_anak', $this->Dbid) . '=' . QuotedValue($rs['id_penilaian_medis_ralan_anak'], $this->id_penilaian_medis_ralan_anak->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->id_penilaian_medis_ralan_anak->DbValue = $row['id_penilaian_medis_ralan_anak'];
        ...
        $this->konsul->DbValue = $row['konsul'];
    }
    ...
    {
        return "`id_penilaian_medis_ralan_anak` = @id_penilaian_medis_ralan_anak@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->id_penilaian_medis_ralan_anak->CurrentValue : $this->id_penilaian_medis_ralan_anak->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->id_penilaian_medis_ralan_anak->CurrentValue = $keys[0];
            } else {
                $this->id_penilaian_medis_ralan_anak->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('id_penilaian_medis_ralan_anak', $row) ? $row['id_penilaian_medis_ralan_anak'] : null;
        } else {
            $val = $this->id_penilaian_medis_ralan_anak->OldValue !== null ? $this->id_penilaian_medis_ralan_anak->OldValue : $this->id_penilaian_medis_ralan_anak->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@id_penilaian_medis_ralan_anak@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PenilaianMedisRalanAnakList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PenilaianMedisRalanAnakEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PenilaianMedisRalanAnakAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PenilaianMedisRalanAnakView";
            case Config("API_ADD_ACTION"):
                return "PenilaianMedisRalanAnakAdd";
            case Config("API_EDIT_ACTION"):
                return "PenilaianMedisRalanAnakEdit";
            case Config("API_DELETE_ACTION"):
                return "PenilaianMedisRalanAnakDelete";
            case Config("API_LIST_ACTION"):
                return "PenilaianMedisRalanAnakList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PenilaianMedisRalanAnakView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PenilaianMedisRalanAnakView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PenilaianMedisRalanAnakAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PenilaianMedisRalanAnakAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PenilaianMedisRalanAnakEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PenilaianMedisRalanAnakAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PenilaianMedisRalanAnakDelete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "id_penilaian_medis_ralan_anak:" . JsonEncode($this->id_penilaian_medis_ralan_anak->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->id_penilaian_medis_ralan_anak->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->id_penilaian_medis_ralan_anak->CurrentValue);
        } else {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("id_penilaian_medis_ralan_anak") ?? Route("id_penilaian_medis_ralan_anak")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->id_penilaian_medis_ralan_anak->CurrentValue = $key;
            } else {
                $this->id_penilaian_medis_ralan_anak->OldValue = $key;
            }
    ...
    public function renderEditRow()
    {
        ...
        $this->konsul->EditValue = $this->konsul->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->id_penilaian_medis_ralan_anak);
        ...
        while (!$recordset->EOF && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->id_penilaian_medis_ralan_anak);

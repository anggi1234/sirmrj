 ...
 * Page class
 */
class PenilaianMedisIgdList extends PenilaianMedisIgd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisIgdList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpenilaian_medis_igdlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PenilaianMedisIgdAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PenilaianMedisIgdDelete";
        $this->MultiUpdateUrl = "PenilaianMedisIgdUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpenilaian_medis_igdlistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->id_penilaian_medis_igd->AdvancedSearch->toJson(), ","); // Field id_penilaian_medis_igd
        ...
        $filterList = Concat($filterList, $this->leher->AdvancedSearch->toJson(), ","); // Field leher
        ...
        $filterList = Concat($filterList, $this->ekg->AdvancedSearch->toJson(), ","); // Field ekg
        $filterList = Concat($filterList, $this->rad->AdvancedSearch->toJson(), ","); // Field rad
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpenilaian_medis_igdlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field id_penilaian_medis_igd
        $this->id_penilaian_medis_igd->AdvancedSearch->SearchValue = @$filter["x_id_penilaian_medis_igd"];
        $this->id_penilaian_medis_igd->AdvancedSearch->SearchOperator = @$filter["z_id_penilaian_medis_igd"];
        $this->id_penilaian_medis_igd->AdvancedSearch->SearchCondition = @$filter["v_id_penilaian_medis_igd"];
        $this->id_penilaian_medis_igd->AdvancedSearch->SearchValue2 = @$filter["y_id_penilaian_medis_igd"];
        $this->id_penilaian_medis_igd->AdvancedSearch->SearchOperator2 = @$filter["w_id_penilaian_medis_igd"];
        $this->id_penilaian_medis_igd->AdvancedSearch->save();
        ...
        // Field leher
        $this->leher->AdvancedSearch->SearchValue = @$filter["x_leher"];
        $this->leher->AdvancedSearch->SearchOperator = @$filter["z_leher"];
        $this->leher->AdvancedSearch->SearchCondition = @$filter["v_leher"];
        $this->leher->AdvancedSearch->SearchValue2 = @$filter["y_leher"];
        $this->leher->AdvancedSearch->SearchOperator2 = @$filter["w_leher"];
        $this->leher->AdvancedSearch->save();
        ...
        // Field ekg
        $this->ekg->AdvancedSearch->SearchValue = @$filter["x_ekg"];
        $this->ekg->AdvancedSearch->SearchOperator = @$filter["z_ekg"];
        $this->ekg->AdvancedSearch->SearchCondition = @$filter["v_ekg"];
        $this->ekg->AdvancedSearch->SearchValue2 = @$filter["y_ekg"];
        $this->ekg->AdvancedSearch->SearchOperator2 = @$filter["w_ekg"];
        $this->ekg->AdvancedSearch->save();

        // Field rad
        $this->rad->AdvancedSearch->SearchValue = @$filter["x_rad"];
        $this->rad->AdvancedSearch->SearchOperator = @$filter["z_rad"];
        $this->rad->AdvancedSearch->SearchCondition = @$filter["v_rad"];
        $this->rad->AdvancedSearch->SearchValue2 = @$filter["y_rad"];
        $this->rad->AdvancedSearch->SearchOperator2 = @$filter["w_rad"];
        $this->rad->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->ekg, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->rad, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->lab, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->leher); // leher
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->id_penilaian_medis_igd->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if (IsMobile()) {
                    ...
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"penilaian_medis_igd\" data-caption=\"" . $viewcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,url:'" . HtmlEncode(GetUrl($this->ViewUrl)) . "',btn:null});\">" . $Language->phrase("ViewLink") . "</a>";
                }
            } else {
                $opt->Body = "";
            }
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_penilaian_medis_igd->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if (IsMobile()) {
            ...
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"penilaian_medis_igd\" data-caption=\"" . $addcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'AddBtn',url:'" . HtmlEncode(GetUrl($this->AddUrl)) . "'});\">" . $Language->phrase("AddLink") . "</a>";
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpenilaian_medis_igdlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpenilaian_medis_igdlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpenilaian_medis_igdlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fpenilaian_medis_igdlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fpenilaian_medis_igdlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fpenilaian_medis_igdlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_penilaian_medis_igd" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_penilaian_medis_igd\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fpenilaian_medis_igdlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpenilaian_medis_igdlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;

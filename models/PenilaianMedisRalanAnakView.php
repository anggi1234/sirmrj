 ...
 * Page class
 */
class PenilaianMedisRalanAnakView extends PenilaianMedisRalanAnak
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisRalanAnakView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_penilaian_medis_ralan_anak") ?? Route("id_penilaian_medis_ralan_anak")) !== null) {
            $this->RecKey["id_penilaian_medis_ralan_anak"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_penilaian_medis_ralan_anak") ?? Route("id_penilaian_medis_ralan_anak")) !== null) {
                ...
                $this->RecKey["id_penilaian_medis_ralan_anak"] = $this->id_penilaian_medis_ralan_anak->QueryStringValue;
                ...
                $this->RecKey["id_penilaian_medis_ralan_anak"] = $this->id_penilaian_medis_ralan_anak->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_penilaian_medis_ralan_anak->setQueryStringValue($keyValue);
                $this->RecKey["id_penilaian_medis_ralan_anak"] = $this->id_penilaian_medis_ralan_anak->QueryStringValue;
            } else {
                $returnUrl = "PenilaianMedisRalanAnakList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PenilaianMedisRalanAnakList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PenilaianMedisRalanAnakList"; // Not page request, return to list
        }
        if ($returnUrl != "") {

 ...
 * Page class
 */
class BayiLahirAdd extends BayiLahir
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BayiLahirAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "BayiLahirView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_bayi->OldValue = $this->id_bayi->CurrentValue;
        $this->nik_ibu_kandung->CurrentValue = null;
        $this->nik_ibu_kandung->OldValue = $this->nik_ibu_kandung->CurrentValue;
        ...
        $this->jam_lahir->CurrentValue = null;
        $this->jam_lahir->OldValue = $this->jam_lahir->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_bayi'] = $this->id_bayi->CurrentValue;
        $row['nik_ibu_kandung'] = $this->nik_ibu_kandung->CurrentValue;
        $row['no_rekam_medis'] = $this->no_rekam_medis->CurrentValue;
        $row['tanggal_lahir'] = $this->tanggal_lahir->CurrentValue;
        $row['jam_lahir'] = $this->jam_lahir->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // nik_ibu_kandung
        $this->nik_ibu_kandung->setDbValueDef($rsnew, $this->nik_ibu_kandung->CurrentValue, null, false);
        ...
        // jam_lahir
        $this->jam_lahir->setDbValueDef($rsnew, $this->jam_lahir->CurrentValue, null, false);

...
/**
 * Table class for catatan_perawatan
 */
class CatatanPerawatan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'catatan_perawatan';
        $this->TableName = 'catatan_perawatan';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`catatan_perawatan`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // tanggal
        $this->tanggal = new DbField('catatan_perawatan', 'catatan_perawatan', 'x_tanggal', 'tanggal', '`tanggal`', CastDateFieldForLike("`tanggal`", 0, "DB"), 133, 10, 0, false, '`tanggal`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jam
        $this->jam = new DbField('catatan_perawatan', 'catatan_perawatan', 'x_jam', 'jam', '`jam`', CastDateFieldForLike("`jam`", 4, "DB"), 134, 10, 4, false, '`jam`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_rawat
        $this->no_rawat = new DbField('catatan_perawatan', 'catatan_perawatan', 'x_no_rawat', 'no_rawat', '`no_rawat`', '`no_rawat`', 200, 17, -1, false, '`no_rawat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_dokter
        $this->kd_dokter = new DbField('catatan_perawatan', 'catatan_perawatan', 'x_kd_dokter', 'kd_dokter', '`kd_dokter`', '`kd_dokter`', 200, 20, -1, false, '`kd_dokter`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // catatan
        $this->catatan = new DbField('catatan_perawatan', 'catatan_perawatan', 'x_catatan', 'catatan', '`catatan`', '`catatan`', 201, 700, -1, false, '`catatan`', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`catatan_perawatan`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CatatanPerawatanList");
    }
    ...
    {
        global $Language;
        if ($pageName == "CatatanPerawatanView") {
            return $Language->phrase("View");
        } elseif ($pageName == "CatatanPerawatanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CatatanPerawatanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CatatanPerawatanView";
            case Config("API_ADD_ACTION"):
                return "CatatanPerawatanAdd";
            case Config("API_EDIT_ACTION"):
                return "CatatanPerawatanEdit";
            case Config("API_DELETE_ACTION"):
                return "CatatanPerawatanDelete";
            case Config("API_LIST_ACTION"):
                return "CatatanPerawatanList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CatatanPerawatanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("CatatanPerawatanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "CatatanPerawatanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "CatatanPerawatanAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CatatanPerawatanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CatatanPerawatanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("CatatanPerawatanDelete", $this->getUrlParm());
    }

 ...
 * Page class
 */
class TindakLanjutGrid extends TindakLanjut
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TindakLanjutGrid";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "ftindak_lanjutgrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->id_tindak_lanjut->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if ($CurrentForm->hasValue("x_tindak_lanjut") && $CurrentForm->hasValue("o_tindak_lanjut") && $this->tindak_lanjut->CurrentValue != $this->tindak_lanjut->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_no_kontrol") && $CurrentForm->hasValue("o_no_kontrol") && $this->no_kontrol->CurrentValue != $this->no_kontrol->OldValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_tgl_kontrol") && $CurrentForm->hasValue("o_tgl_kontrol") && $this->tgl_kontrol->CurrentValue != $this->tgl_kontrol->OldValue) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->tindak_lanjut->clearErrorMessage();
        $this->no_kontrol->clearErrorMessage();
        $this->tgl_input->clearErrorMessage();
        $this->tgl_kontrol->clearErrorMessage();
    }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_tindak_lanjut")) {
            $this->tindak_lanjut->setOldValue($CurrentForm->getValue("o_tindak_lanjut"));
        }
        ...
        if ($CurrentForm->hasValue("o_no_kontrol")) {
            $this->no_kontrol->setOldValue($CurrentForm->getValue("o_no_kontrol"));
        }
        ...
        if ($CurrentForm->hasValue("o_tgl_kontrol")) {
            $this->tgl_kontrol->setOldValue($CurrentForm->getValue("o_tgl_kontrol"));
        }

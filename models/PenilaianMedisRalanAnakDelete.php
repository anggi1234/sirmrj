 ...
 * Page class
 */
class PenilaianMedisRalanAnakDelete extends PenilaianMedisRalanAnak
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisRalanAnakDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PenilaianMedisRalanAnakList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PenilaianMedisRalanAnakList"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['id_penilaian_medis_ralan_anak'];

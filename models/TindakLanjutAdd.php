 ...
 * Page class
 */
class TindakLanjutAdd extends TindakLanjut
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TindakLanjutAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "TindakLanjutView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_tindak_lanjut->OldValue = $this->id_tindak_lanjut->CurrentValue;
        $this->no_reg->CurrentValue = null;
        $this->no_reg->OldValue = $this->no_reg->CurrentValue;
        $this->tindak_lanjut->CurrentValue = null;
        $this->tindak_lanjut->OldValue = $this->tindak_lanjut->CurrentValue;
        $this->no_kontrol->CurrentValue = null;
        $this->no_kontrol->OldValue = $this->no_kontrol->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_tindak_lanjut'] = $this->id_tindak_lanjut->CurrentValue;
        $row['no_reg'] = $this->no_reg->CurrentValue;
        $row['tindak_lanjut'] = $this->tindak_lanjut->CurrentValue;
        $row['no_kontrol'] = $this->no_kontrol->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'tindak_lanjut'
        $validMasterRecord = true;
        $masterFilter = $this->sqlMasterFilter_vrajal();
        if ($this->no_reg->getSessionValue() != "") {
        $masterFilter = str_replace("@id_reg@", AdjustSql($this->no_reg->getSessionValue(), "DB"), $masterFilter);
        } else {
        ...
        // tindak_lanjut
        $this->tindak_lanjut->setDbValueDef($rsnew, $this->tindak_lanjut->CurrentValue, null, false);

        // no_kontrol
        $this->no_kontrol->setDbValueDef($rsnew, $this->no_kontrol->CurrentValue, null, false);
        ...
        // tgl_kontrol
        $this->tgl_kontrol->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_kontrol->CurrentValue, 7), null, false);

        // no_reg
        if ($this->no_reg->getSessionValue() != "") {
            $rsnew['no_reg'] = $this->no_reg->getSessionValue();
        }
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['id_tindak_lanjut']) == "") {

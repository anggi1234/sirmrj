 ...
 * Page class
 */
class CatatanPasienAdd extends CatatanPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CatatanPasienAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CatatanPasienView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // no_rkm_medis
        $this->no_rkm_medis->setDbValueDef($rsnew, $this->no_rkm_medis->CurrentValue, "", false);
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['no_rkm_medis']) == "") {

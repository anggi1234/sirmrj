 ...
 * Page class
 */
class VrajalList extends Vrajal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VrajalList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fvrajallist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "VrajalAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "VrajalDelete";
        $this->MultiUpdateUrl = "VrajalUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fvrajallistsrch";
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fvrajallistsrch", $filters);
    ...
    protected function setupListOptions()
    {
        ...
        // "detail_cppt"
        $item = &$this->ListOptions->add("detail_cppt");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'cppt') && !$this->ShowMultipleDetails;
        $item->OnLeft = false;
        $item->ShowInButtonGroup = false;

        // "detail_billing"
        $item = &$this->ListOptions->add("detail_billing");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'billing') && !$this->ShowMultipleDetails;
        $item->OnLeft = false;
        $item->ShowInButtonGroup = false;

        // "detail_konsul"
        $item = &$this->ListOptions->add("detail_konsul");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'konsul') && !$this->ShowMultipleDetails;
        $item->OnLeft = false;
        $item->ShowInButtonGroup = false;
        ...
        // "detail_resep_dokter"
        $item = &$this->ListOptions->add("detail_resep_dokter");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'resep_dokter') && !$this->ShowMultipleDetails;
        $item->OnLeft = false;
        $item->ShowInButtonGroup = false;

        // "detail_prmrj"
        $item = &$this->ListOptions->add("detail_prmrj");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'prmrj') && !$this->ShowMultipleDetails;
        $item->OnLeft = false;
        $item->ShowInButtonGroup = false;
    ...
    public function renderListOptions()
    {
        ...
        if ($Security->allowList(CurrentProjectID() . 'catatan_medis')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("CatatanMedisList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("CatatanMedisGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'vrajal')) {
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'vrajal')) {
        ...
        if ($Security->allowList(CurrentProjectID() . 'penilaian_awal_keperawatan_ralan')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("PenilaianAwalKeperawatanRalanList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        if ($Security->allowList(CurrentProjectID() . 'penilaian_medis_ralan')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("PenilaianMedisRalanList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        if ($Security->allowList(CurrentProjectID() . 'penilaian_awal_keperawatan_ralan_psikiatri')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("PenilaianAwalKeperawatanRalanPsikiatriList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        if ($Security->allowList(CurrentProjectID() . 'penilaian_psikologi')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("PenilaianPsikologiList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        if ($Security->allowList(CurrentProjectID() . 'diagnosa_pasien')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("DiagnosaPasienList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        // "detail_cppt"
        $opt = $this->ListOptions["detail_cppt"];
        if ($Security->allowList(CurrentProjectID() . 'cppt')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("cppt", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("CpptList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("CpptGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=cppt");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=cppt");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
        ...
        // "detail_billing"
        $opt = $this->ListOptions["detail_billing"];
        if ($Security->allowList(CurrentProjectID() . 'billing')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("billing", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("BillingList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("BillingGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=billing");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=billing");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
        ...
        // "detail_konsul"
        $opt = $this->ListOptions["detail_konsul"];
        if ($Security->allowList(CurrentProjectID() . 'konsul')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("konsul", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("KonsulList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("KonsulGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=konsul");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=konsul");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
        ...
        if ($Security->allowList(CurrentProjectID() . 'pemeriksaan_ralan')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("PemeriksaanRalanList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        if ($Security->allowList(CurrentProjectID() . 'tindak_lanjut')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("TindakLanjutList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        // "detail_resep_dokter"
        $opt = $this->ListOptions["detail_resep_dokter"];
        if ($Security->allowList(CurrentProjectID() . 'resep_dokter')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("resep_dokter", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("ResepDokterList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ResepDokterGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=resep_dokter");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=resep_dokter");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
        ...
        // "detail_prmrj"
        $opt = $this->ListOptions["detail_prmrj"];
        if ($Security->allowList(CurrentProjectID() . 'prmrj')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("prmrj", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("PrmrjList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_no_rkm_medis", $this->no_rkm_medis->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("PrmrjGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=prmrj");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'vrajal')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=prmrj");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
        ...
        if ($Security->allowList(CurrentProjectID() . 'vhistory')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("VhistoryList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_no_rkm_medis", $this->no_rkm_medis->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
    ...
    protected function setupOtherOptions()
    {
        ...
        $detailTableLink = "";
                ...
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'vrajal') && $Security->canAdd());
                if ($item->Visible) {
                    if ($detailTableLink != "") {
                        $detailTableLink .= ",";
                    }
                ...
                $item = &$option->add("detailadd_cppt");
                $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=cppt");
                $detailPage = Container("CpptGrid");
                $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
                $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'vrajal') && $Security->canAdd());
                ...
                $item = &$option->add("detailadd_billing");
                $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=billing");
                $detailPage = Container("BillingGrid");
                $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
                $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'vrajal') && $Security->canAdd());
                ...
                $item = &$option->add("detailadd_konsul");
                $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=konsul");
                $detailPage = Container("KonsulGrid");
                $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
                $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'vrajal') && $Security->canAdd());
                ...
                $item = &$option->add("detailadd_resep_dokter");
                $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=resep_dokter");
                $detailPage = Container("ResepDokterGrid");
                $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
                $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'vrajal') && $Security->canAdd());
                ...
                $item = &$option->add("detailadd_prmrj");
                $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=prmrj");
                $detailPage = Container("PrmrjGrid");
                $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
                $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'vrajal') && $Security->canAdd());
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fvrajallistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fvrajallistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fvrajallist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function renderListOptionsExt()
    {
        ...
        if ($this->DetailPages && $this->DetailPages["catatan_medis"] && $this->DetailPages["catatan_medis"]->Visible) {
            ...
            $url = "CatatanMedisPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            $btngrp = "<div data-table=\"catatan_medis\" data-url=\"" . $url . "\">";
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("CatatanMedisList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
        ...
        if ($this->DetailPages && $this->DetailPages["penilaian_awal_keperawatan_ralan"] && $this->DetailPages["penilaian_awal_keperawatan_ralan"]->Visible) {
            ...
            $url = "PenilaianAwalKeperawatanRalanPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("PenilaianAwalKeperawatanRalanList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
        ...
        if ($this->DetailPages && $this->DetailPages["penilaian_medis_ralan"] && $this->DetailPages["penilaian_medis_ralan"]->Visible) {
            ...
            $url = "PenilaianMedisRalanPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("PenilaianMedisRalanList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
        ...
        if ($this->DetailPages && $this->DetailPages["penilaian_awal_keperawatan_ralan_psikiatri"] && $this->DetailPages["penilaian_awal_keperawatan_ralan_psikiatri"]->Visible) {
            ...
            $url = "PenilaianAwalKeperawatanRalanPsikiatriPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("PenilaianAwalKeperawatanRalanPsikiatriList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
        ...
        if ($this->DetailPages && $this->DetailPages["penilaian_psikologi"] && $this->DetailPages["penilaian_psikologi"]->Visible) {
            ...
            $url = "PenilaianPsikologiPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("PenilaianPsikologiList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
        ...
        if ($this->DetailPages && $this->DetailPages["diagnosa_pasien"] && $this->DetailPages["diagnosa_pasien"]->Visible) {
            ...
            $url = "DiagnosaPasienPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("DiagnosaPasienList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
        ...
        // Column "detail_cppt"
        if ($this->DetailPages && $this->DetailPages["cppt"] && $this->DetailPages["cppt"]->Visible) {
            $link = "";
            $option = $this->ListOptions["detail_cppt"];
            $url = "CpptPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            $btngrp = "<div data-table=\"cppt\" data-url=\"" . $url . "\">";
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                $label = $Language->TablePhrase("cppt", "TblCaption");
                $link = "<li class=\"nav-item\"><a href=\"#\" class=\"nav-link\" data-toggle=\"tab\" data-table=\"cppt\" data-url=\"" . $url . "\">" . $label . "</a></li>";
                $links .= $link;
                $detaillnk = JsEncodeAttribute("CpptList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
                $btngrp .= "<a href=\"#\" class=\"mr-2\" title=\"" . $Language->TablePhrase("cppt", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "';return false;\">" . $Language->phrase("MasterDetailListLink") . "</a>";
            }
        ...
        // Column "detail_billing"
        if ($this->DetailPages && $this->DetailPages["billing"] && $this->DetailPages["billing"]->Visible) {
            $link = "";
            $option = $this->ListOptions["detail_billing"];
            $url = "BillingPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            $btngrp = "<div data-table=\"billing\" data-url=\"" . $url . "\">";
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                $label = $Language->TablePhrase("billing", "TblCaption");
                $link = "<li class=\"nav-item\"><a href=\"#\" class=\"nav-link\" data-toggle=\"tab\" data-table=\"billing\" data-url=\"" . $url . "\">" . $label . "</a></li>";
                $links .= $link;
                $detaillnk = JsEncodeAttribute("BillingList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
                $btngrp .= "<a href=\"#\" class=\"mr-2\" title=\"" . $Language->TablePhrase("billing", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "';return false;\">" . $Language->phrase("MasterDetailListLink") . "</a>";
            }
        ...
        // Column "detail_konsul"
        if ($this->DetailPages && $this->DetailPages["konsul"] && $this->DetailPages["konsul"]->Visible) {
            $link = "";
            $option = $this->ListOptions["detail_konsul"];
            $url = "KonsulPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            $btngrp = "<div data-table=\"konsul\" data-url=\"" . $url . "\">";
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                $label = $Language->TablePhrase("konsul", "TblCaption");
                $link = "<li class=\"nav-item\"><a href=\"#\" class=\"nav-link\" data-toggle=\"tab\" data-table=\"konsul\" data-url=\"" . $url . "\">" . $label . "</a></li>";
                $links .= $link;
                $detaillnk = JsEncodeAttribute("KonsulList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
                $btngrp .= "<a href=\"#\" class=\"mr-2\" title=\"" . $Language->TablePhrase("konsul", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "';return false;\">" . $Language->phrase("MasterDetailListLink") . "</a>";
            }
        ...
        if ($this->DetailPages && $this->DetailPages["pemeriksaan_ralan"] && $this->DetailPages["pemeriksaan_ralan"]->Visible) {
            ...
            $url = "PemeriksaanRalanPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("PemeriksaanRalanList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
        ...
        if ($this->DetailPages && $this->DetailPages["tindak_lanjut"] && $this->DetailPages["tindak_lanjut"]->Visible) {
            ...
            $url = "TindakLanjutPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("TindakLanjutList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
        ...
        // Column "detail_resep_dokter"
        if ($this->DetailPages && $this->DetailPages["resep_dokter"] && $this->DetailPages["resep_dokter"]->Visible) {
            $link = "";
            $option = $this->ListOptions["detail_resep_dokter"];
            $url = "ResepDokterPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            $btngrp = "<div data-table=\"resep_dokter\" data-url=\"" . $url . "\">";
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                $label = $Language->TablePhrase("resep_dokter", "TblCaption");
                $link = "<li class=\"nav-item\"><a href=\"#\" class=\"nav-link\" data-toggle=\"tab\" data-table=\"resep_dokter\" data-url=\"" . $url . "\">" . $label . "</a></li>";
                $links .= $link;
                $detaillnk = JsEncodeAttribute("ResepDokterList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "");
                $btngrp .= "<a href=\"#\" class=\"mr-2\" title=\"" . $Language->TablePhrase("resep_dokter", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "';return false;\">" . $Language->phrase("MasterDetailListLink") . "</a>";
            }
        ...
        // Column "detail_prmrj"
        if ($this->DetailPages && $this->DetailPages["prmrj"] && $this->DetailPages["prmrj"]->Visible) {
            $link = "";
            $option = $this->ListOptions["detail_prmrj"];
            $url = "PrmrjPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            $btngrp = "<div data-table=\"prmrj\" data-url=\"" . $url . "\">";
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                $label = $Language->TablePhrase("prmrj", "TblCaption");
                $link = "<li class=\"nav-item\"><a href=\"#\" class=\"nav-link\" data-toggle=\"tab\" data-table=\"prmrj\" data-url=\"" . $url . "\">" . $label . "</a></li>";
                $links .= $link;
                $detaillnk = JsEncodeAttribute("PrmrjList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_no_rkm_medis", $this->no_rkm_medis->CurrentValue) . "");
                $btngrp .= "<a href=\"#\" class=\"mr-2\" title=\"" . $Language->TablePhrase("prmrj", "TblCaption") . "\" onclick=\"window.location='" . $detaillnk . "';return false;\">" . $Language->phrase("MasterDetailListLink") . "</a>";
            }
        ...
        if ($this->DetailPages && $this->DetailPages["vhistory"] && $this->DetailPages["vhistory"]->Visible) {
            ...
            $url = "VhistoryPreview?t=vrajal&f=" . Encrypt($sqlwrk);
            ...
            if ($Security->allowList(CurrentProjectID() . 'vrajal')) {
                ...
                $links .= $link;
                $detaillnk = JsEncodeAttribute("VhistoryList?" . Config("TABLE_SHOW_MASTER") . "=vrajal&" . GetForeignKeyUrl("fk_no_rkm_medis", $this->no_rkm_medis->CurrentValue) . "");
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fvrajallist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fvrajallist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fvrajallist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_vrajal" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_vrajal\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fvrajallist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fvrajallistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;

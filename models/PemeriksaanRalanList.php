 ...
 * Page class
 */
class PemeriksaanRalanList extends PemeriksaanRalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PemeriksaanRalanList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fpemeriksaan_ralanlist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "PemeriksaanRalanAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PemeriksaanRalanDelete";
        $this->MultiUpdateUrl = "PemeriksaanRalanUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fpemeriksaan_ralanlistsrch";
    ...
    {
        if ($this->isAddOrEdit()) {
            $this->tgl_perawatan->Visible = false;
        }
        if ($this->isAddOrEdit()) {
            $this->jam_rawat->Visible = false;
        }
    ...
    public function run()
    {
        ...
        $this->keluhan->Visible = false;
        $this->pemeriksaan->Visible = false;
        $this->alergi->setVisibility();
        $this->lingkar_perut->setVisibility();
        $this->rtl->Visible = false;
        $this->penilaian->Visible = false;
        $this->instruksi->Visible = false;
        $this->evaluasi->Visible = false;
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->tgl_perawatan->AdvancedSearch->toJson(), ","); // Field tgl_perawatan
        $filterList = Concat($filterList, $this->jam_rawat->AdvancedSearch->toJson(), ","); // Field jam_rawat
        $filterList = Concat($filterList, $this->suhu_tubuh->AdvancedSearch->toJson(), ","); // Field suhu_tubuh
        $filterList = Concat($filterList, $this->tensi->AdvancedSearch->toJson(), ","); // Field tensi
        $filterList = Concat($filterList, $this->nadi->AdvancedSearch->toJson(), ","); // Field nadi
        $filterList = Concat($filterList, $this->respirasi->AdvancedSearch->toJson(), ","); // Field respirasi
        $filterList = Concat($filterList, $this->tinggi->AdvancedSearch->toJson(), ","); // Field tinggi
        ...
        $filterList = Concat($filterList, $this->keluhan->AdvancedSearch->toJson(), ","); // Field keluhan
        ...
        $filterList = Concat($filterList, $this->lingkar_perut->AdvancedSearch->toJson(), ","); // Field lingkar_perut
        $filterList = Concat($filterList, $this->rtl->AdvancedSearch->toJson(), ","); // Field rtl
        $filterList = Concat($filterList, $this->penilaian->AdvancedSearch->toJson(), ","); // Field penilaian
        $filterList = Concat($filterList, $this->instruksi->AdvancedSearch->toJson(), ","); // Field instruksi
        $filterList = Concat($filterList, $this->evaluasi->AdvancedSearch->toJson(), ","); // Field evaluasi
        $filterList = Concat($filterList, $this->nip->AdvancedSearch->toJson(), ","); // Field nip
        $filterList = Concat($filterList, $this->id_pemeriksaan_ralan->AdvancedSearch->toJson(), ","); // Field id_pemeriksaan_ralan
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpemeriksaan_ralanlistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field tgl_perawatan
        $this->tgl_perawatan->AdvancedSearch->SearchValue = @$filter["x_tgl_perawatan"];
        $this->tgl_perawatan->AdvancedSearch->SearchOperator = @$filter["z_tgl_perawatan"];
        $this->tgl_perawatan->AdvancedSearch->SearchCondition = @$filter["v_tgl_perawatan"];
        $this->tgl_perawatan->AdvancedSearch->SearchValue2 = @$filter["y_tgl_perawatan"];
        $this->tgl_perawatan->AdvancedSearch->SearchOperator2 = @$filter["w_tgl_perawatan"];
        $this->tgl_perawatan->AdvancedSearch->save();

        // Field jam_rawat
        $this->jam_rawat->AdvancedSearch->SearchValue = @$filter["x_jam_rawat"];
        $this->jam_rawat->AdvancedSearch->SearchOperator = @$filter["z_jam_rawat"];
        $this->jam_rawat->AdvancedSearch->SearchCondition = @$filter["v_jam_rawat"];
        $this->jam_rawat->AdvancedSearch->SearchValue2 = @$filter["y_jam_rawat"];
        $this->jam_rawat->AdvancedSearch->SearchOperator2 = @$filter["w_jam_rawat"];
        $this->jam_rawat->AdvancedSearch->save();

        // Field suhu_tubuh
        $this->suhu_tubuh->AdvancedSearch->SearchValue = @$filter["x_suhu_tubuh"];
        $this->suhu_tubuh->AdvancedSearch->SearchOperator = @$filter["z_suhu_tubuh"];
        $this->suhu_tubuh->AdvancedSearch->SearchCondition = @$filter["v_suhu_tubuh"];
        $this->suhu_tubuh->AdvancedSearch->SearchValue2 = @$filter["y_suhu_tubuh"];
        $this->suhu_tubuh->AdvancedSearch->SearchOperator2 = @$filter["w_suhu_tubuh"];
        $this->suhu_tubuh->AdvancedSearch->save();

        // Field tensi
        $this->tensi->AdvancedSearch->SearchValue = @$filter["x_tensi"];
        $this->tensi->AdvancedSearch->SearchOperator = @$filter["z_tensi"];
        $this->tensi->AdvancedSearch->SearchCondition = @$filter["v_tensi"];
        $this->tensi->AdvancedSearch->SearchValue2 = @$filter["y_tensi"];
        $this->tensi->AdvancedSearch->SearchOperator2 = @$filter["w_tensi"];
        $this->tensi->AdvancedSearch->save();
        ...
        // Field respirasi
        $this->respirasi->AdvancedSearch->SearchValue = @$filter["x_respirasi"];
        $this->respirasi->AdvancedSearch->SearchOperator = @$filter["z_respirasi"];
        $this->respirasi->AdvancedSearch->SearchCondition = @$filter["v_respirasi"];
        $this->respirasi->AdvancedSearch->SearchValue2 = @$filter["y_respirasi"];
        $this->respirasi->AdvancedSearch->SearchOperator2 = @$filter["w_respirasi"];
        $this->respirasi->AdvancedSearch->save();
        ...
        // Field keluhan
        $this->keluhan->AdvancedSearch->SearchValue = @$filter["x_keluhan"];
        $this->keluhan->AdvancedSearch->SearchOperator = @$filter["z_keluhan"];
        $this->keluhan->AdvancedSearch->SearchCondition = @$filter["v_keluhan"];
        $this->keluhan->AdvancedSearch->SearchValue2 = @$filter["y_keluhan"];
        $this->keluhan->AdvancedSearch->SearchOperator2 = @$filter["w_keluhan"];
        $this->keluhan->AdvancedSearch->save();
        ...
        // Field lingkar_perut
        $this->lingkar_perut->AdvancedSearch->SearchValue = @$filter["x_lingkar_perut"];
        $this->lingkar_perut->AdvancedSearch->SearchOperator = @$filter["z_lingkar_perut"];
        $this->lingkar_perut->AdvancedSearch->SearchCondition = @$filter["v_lingkar_perut"];
        $this->lingkar_perut->AdvancedSearch->SearchValue2 = @$filter["y_lingkar_perut"];
        $this->lingkar_perut->AdvancedSearch->SearchOperator2 = @$filter["w_lingkar_perut"];
        $this->lingkar_perut->AdvancedSearch->save();

        // Field rtl
        $this->rtl->AdvancedSearch->SearchValue = @$filter["x_rtl"];
        $this->rtl->AdvancedSearch->SearchOperator = @$filter["z_rtl"];
        $this->rtl->AdvancedSearch->SearchCondition = @$filter["v_rtl"];
        $this->rtl->AdvancedSearch->SearchValue2 = @$filter["y_rtl"];
        $this->rtl->AdvancedSearch->SearchOperator2 = @$filter["w_rtl"];
        $this->rtl->AdvancedSearch->save();

        // Field penilaian
        $this->penilaian->AdvancedSearch->SearchValue = @$filter["x_penilaian"];
        $this->penilaian->AdvancedSearch->SearchOperator = @$filter["z_penilaian"];
        $this->penilaian->AdvancedSearch->SearchCondition = @$filter["v_penilaian"];
        $this->penilaian->AdvancedSearch->SearchValue2 = @$filter["y_penilaian"];
        $this->penilaian->AdvancedSearch->SearchOperator2 = @$filter["w_penilaian"];
        $this->penilaian->AdvancedSearch->save();

        // Field instruksi
        $this->instruksi->AdvancedSearch->SearchValue = @$filter["x_instruksi"];
        $this->instruksi->AdvancedSearch->SearchOperator = @$filter["z_instruksi"];
        $this->instruksi->AdvancedSearch->SearchCondition = @$filter["v_instruksi"];
        $this->instruksi->AdvancedSearch->SearchValue2 = @$filter["y_instruksi"];
        $this->instruksi->AdvancedSearch->SearchOperator2 = @$filter["w_instruksi"];
        $this->instruksi->AdvancedSearch->save();

        // Field evaluasi
        $this->evaluasi->AdvancedSearch->SearchValue = @$filter["x_evaluasi"];
        $this->evaluasi->AdvancedSearch->SearchOperator = @$filter["z_evaluasi"];
        $this->evaluasi->AdvancedSearch->SearchCondition = @$filter["v_evaluasi"];
        $this->evaluasi->AdvancedSearch->SearchValue2 = @$filter["y_evaluasi"];
        $this->evaluasi->AdvancedSearch->SearchOperator2 = @$filter["w_evaluasi"];
        $this->evaluasi->AdvancedSearch->save();
        ...
        // Field id_pemeriksaan_ralan
        $this->id_pemeriksaan_ralan->AdvancedSearch->SearchValue = @$filter["x_id_pemeriksaan_ralan"];
        $this->id_pemeriksaan_ralan->AdvancedSearch->SearchOperator = @$filter["z_id_pemeriksaan_ralan"];
        $this->id_pemeriksaan_ralan->AdvancedSearch->SearchCondition = @$filter["v_id_pemeriksaan_ralan"];
        $this->id_pemeriksaan_ralan->AdvancedSearch->SearchValue2 = @$filter["y_id_pemeriksaan_ralan"];
        $this->id_pemeriksaan_ralan->AdvancedSearch->SearchOperator2 = @$filter["w_id_pemeriksaan_ralan"];
        $this->id_pemeriksaan_ralan->AdvancedSearch->save();
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->suhu_tubuh, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->tensi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->nadi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->respirasi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->tinggi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->berat, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->spo2, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->gcs, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->keluhan, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->pemeriksaan, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->alergi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->lingkar_perut, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->rtl, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->penilaian, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->instruksi, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->evaluasi, $arKeywords, $type);
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->tgl_perawatan); // tgl_perawatan
            $this->updateSort($this->jam_rawat); // jam_rawat
            $this->updateSort($this->suhu_tubuh); // suhu_tubuh
            $this->updateSort($this->tensi); // tensi
            $this->updateSort($this->nadi); // nadi
            $this->updateSort($this->respirasi); // respirasi
            ...
            $this->updateSort($this->lingkar_perut); // lingkar_perut
            $this->updateSort($this->nip); // nip
            $this->updateSort($this->id_pemeriksaan_ralan); // id_pemeriksaan_ralan
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->tgl_perawatan->setSort("");
                $this->jam_rawat->setSort("");
                $this->suhu_tubuh->setSort("");
                $this->tensi->setSort("");
                $this->nadi->setSort("");
                $this->respirasi->setSort("");
                $this->tinggi->setSort("");
                $this->berat->setSort("");
                $this->spo2->setSort("");
                $this->gcs->setSort("");
                $this->kesadaran->setSort("");
                $this->keluhan->setSort("");
                $this->pemeriksaan->setSort("");
                $this->alergi->setSort("");
                $this->lingkar_perut->setSort("");
                $this->rtl->setSort("");
                $this->penilaian->setSort("");
                $this->instruksi->setSort("");
                $this->evaluasi->setSort("");
                $this->nip->setSort("");
                $this->id_pemeriksaan_ralan->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canEdit()) {
                if (IsMobile()) {
                    ...
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"pemeriksaan_ralan\" data-caption=\"" . $editcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'SaveBtn',url:'" . HtmlEncode(GetUrl($this->EditUrl)) . "'});\">" . $Language->phrase("EditLink") . "</a>";
                }
            } else {
                $opt->Body = "";
            }
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_pemeriksaan_ralan->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if (IsMobile()) {
            ...
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"pemeriksaan_ralan\" data-caption=\"" . $addcaption . "\" href=\"#\" onclick=\"return ew.modalDialogShow({lnk:this,btn:'AddBtn',url:'" . HtmlEncode(GetUrl($this->AddUrl)) . "'});\">" . $Language->phrase("AddLink") . "</a>";
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpemeriksaan_ralanlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpemeriksaan_ralanlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fpemeriksaan_ralanlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.fpemeriksaan_ralanlist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.fpemeriksaan_ralanlist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.fpemeriksaan_ralanlist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_pemeriksaan_ralan" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_pemeriksaan_ralan\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.fpemeriksaan_ralanlist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fpemeriksaan_ralanlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;

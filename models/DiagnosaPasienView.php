 ...
 * Page class
 */
class DiagnosaPasienView extends DiagnosaPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DiagnosaPasienView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_diagnosa_pasien") ?? Route("id_diagnosa_pasien")) !== null) {
            $this->RecKey["id_diagnosa_pasien"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        $this->id_diagnosa_pasien->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_diagnosa_pasien") ?? Route("id_diagnosa_pasien")) !== null) {
                ...
                $this->RecKey["id_diagnosa_pasien"] = $this->id_diagnosa_pasien->QueryStringValue;
            } elseif (Post("id_diagnosa_pasien") !== null) {
                $this->id_diagnosa_pasien->setFormValue(Post("id_diagnosa_pasien"));
                $this->RecKey["id_diagnosa_pasien"] = $this->id_diagnosa_pasien->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_diagnosa_pasien->setQueryStringValue($keyValue);
                $this->RecKey["id_diagnosa_pasien"] = $this->id_diagnosa_pasien->QueryStringValue;
            } else {
                $returnUrl = "DiagnosaPasienList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "DiagnosaPasienList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "DiagnosaPasienList"; // Not page request, return to list
        }
        if ($returnUrl != "") {

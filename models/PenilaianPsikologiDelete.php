 ...
 * Page class
 */
class PenilaianPsikologiDelete extends PenilaianPsikologi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianPsikologiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PenilaianPsikologiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PenilaianPsikologiList"); // Return to list
                return;
            }
        }

 ...
 * Page class
 */
class UserloginView extends Userlogin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserloginView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "UserloginList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "UserloginList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "UserloginList"; // Not page request, return to list
        }
        if ($returnUrl != "") {

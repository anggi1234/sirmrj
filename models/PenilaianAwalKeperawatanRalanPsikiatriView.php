 ...
 * Page class
 */
class PenilaianAwalKeperawatanRalanPsikiatriView extends PenilaianAwalKeperawatanRalanPsikiatri
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianAwalKeperawatanRalanPsikiatriView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_penilaian_awal_keperawatan_ralan_psikiatri") ?? Route("id_penilaian_awal_keperawatan_ralan_psikiatri")) !== null) {
            $this->RecKey["id_penilaian_awal_keperawatan_ralan_psikiatri"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_penilaian_awal_keperawatan_ralan_psikiatri") ?? Route("id_penilaian_awal_keperawatan_ralan_psikiatri")) !== null) {
                ...
                $this->RecKey["id_penilaian_awal_keperawatan_ralan_psikiatri"] = $this->id_penilaian_awal_keperawatan_ralan_psikiatri->QueryStringValue;
                ...
                $this->RecKey["id_penilaian_awal_keperawatan_ralan_psikiatri"] = $this->id_penilaian_awal_keperawatan_ralan_psikiatri->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_penilaian_awal_keperawatan_ralan_psikiatri->setQueryStringValue($keyValue);
                $this->RecKey["id_penilaian_awal_keperawatan_ralan_psikiatri"] = $this->id_penilaian_awal_keperawatan_ralan_psikiatri->QueryStringValue;
            } else {
                $returnUrl = "PenilaianAwalKeperawatanRalanPsikiatriList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PenilaianAwalKeperawatanRalanPsikiatriList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PenilaianAwalKeperawatanRalanPsikiatriList"; // Not page request, return to list
        }
        if ($returnUrl != "") {

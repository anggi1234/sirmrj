 ...
 * Page class
 */
class MPasienEdit extends MPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MPasienEdit";
    ...
    public function run()
    {
        ...
        $this->no_rkm_medis->Required = false;
        $this->kd_kel->Required = false;
        $this->kd_kec->Required = false;
        $this->kd_kab->Required = false;
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("MPasienList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->GetViewUrl();
                if (GetPageName($returnUrl) == "MPasienList") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // kd_pj
            $this->kd_pj->setDbValueDef($rsnew, $this->kd_pj->CurrentValue, "", $this->kd_pj->ReadOnly);

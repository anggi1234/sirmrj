 ...
 * Page class
 */
class PenilaianMedisIgdEdit extends PenilaianMedisIgd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisIgdEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_penilaian_medis_igd") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_penilaian_medis_igd->setQueryStringValue($keyValue);
                $this->id_penilaian_medis_igd->setOldValue($this->id_penilaian_medis_igd->QueryStringValue);
            } elseif (Post("id_penilaian_medis_igd") !== null) {
                $this->id_penilaian_medis_igd->setFormValue(Post("id_penilaian_medis_igd"));
                $this->id_penilaian_medis_igd->setOldValue($this->id_penilaian_medis_igd->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->id_penilaian_medis_igd->IsDetailKey) {
            $this->id_penilaian_medis_igd->setFormValue($val);
        }
    ...
    {
        global $CurrentForm;
        $this->id_penilaian_medis_igd->CurrentValue = $this->id_penilaian_medis_igd->FormValue;
    ...
    protected function validateForm()
    {
        ...
        if ($this->id_penilaian_medis_igd->Required) {
            if (!$this->id_penilaian_medis_igd->IsDetailKey && EmptyValue($this->id_penilaian_medis_igd->FormValue)) {
                $this->id_penilaian_medis_igd->addErrorMessage(str_replace("%s", $this->id_penilaian_medis_igd->caption(), $this->id_penilaian_medis_igd->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // leher
            $this->leher->setDbValueDef($rsnew, $this->leher->CurrentValue, "", $this->leher->ReadOnly);
            ...
            // ekg
            $this->ekg->setDbValueDef($rsnew, $this->ekg->CurrentValue, "", $this->ekg->ReadOnly);

            // rad
            $this->rad->setDbValueDef($rsnew, $this->rad->CurrentValue, "", $this->rad->ReadOnly);

            // lab
            $this->lab->setDbValueDef($rsnew, $this->lab->CurrentValue, "", $this->lab->ReadOnly);

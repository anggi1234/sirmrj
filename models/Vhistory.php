...
/**
 * Table class for vhistory
 */
class Vhistory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'vhistory';
        $this->TableName = 'vhistory';
        ...
        // id_reg
        $this->id_reg = new DbField('vhistory', 'vhistory', 'x_id_reg', 'id_reg', 'pasien_kunjungan.id_reg', 'pasien_kunjungan.id_reg', 3, 11, -1, false, 'pasien_kunjungan.id_reg', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_rkm_medis
        $this->no_rkm_medis = new DbField('vhistory', 'vhistory', 'x_no_rkm_medis', 'no_rkm_medis', 'pasien_kunjungan.no_rkm_medis', 'pasien_kunjungan.no_rkm_medis', 200, 15, -1, false, 'pasien_kunjungan.no_rkm_medis', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kd_poli
        $this->kd_poli = new DbField('vhistory', 'vhistory', 'x_kd_poli', 'kd_poli', 'pasien_kunjungan.kd_poli', 'pasien_kunjungan.kd_poli', 200, 5, -1, false, 'pasien_kunjungan.kd_poli', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kd_dokter
        $this->kd_dokter = new DbField('vhistory', 'vhistory', 'x_kd_dokter', 'kd_dokter', 'pasien_kunjungan.kd_dokter', 'pasien_kunjungan.kd_dokter', 200, 20, -1, false, 'pasien_kunjungan.kd_dokter', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->kd_dokter->Lookup = new Lookup('kd_dokter', 'vhistory', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kd_dokter->Lookup = new Lookup('kd_dokter', 'vhistory', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // tgl_registrasi
        $this->tgl_registrasi = new DbField('vhistory', 'vhistory', 'x_tgl_registrasi', 'tgl_registrasi', 'pasien_kunjungan.tgl_registrasi', CastDateFieldForLike("pasien_kunjungan.tgl_registrasi", 7, "DB"), 133, 10, 7, false, 'pasien_kunjungan.tgl_registrasi', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jam_reg
        $this->jam_reg = new DbField('vhistory', 'vhistory', 'x_jam_reg', 'jam_reg', 'pasien_kunjungan.jam_reg', CastDateFieldForLike("pasien_kunjungan.jam_reg", 4, "DB"), 134, 10, 4, false, 'pasien_kunjungan.jam_reg', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // cetak
        $this->cetak = new DbField('vhistory', 'vhistory', 'x_cetak', 'cetak', '\'\'', '\'\'', 201, 65530, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("pasien_kunjungan.id_reg, pasien_kunjungan.no_rkm_medis, pasien_kunjungan.kd_poli, pasien_kunjungan.kd_dokter, pasien_kunjungan.tgl_registrasi, pasien_kunjungan.jam_reg, '' AS `cetak`");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VhistoryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VhistoryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VhistoryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VhistoryAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VhistoryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VhistoryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VhistoryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VhistoryAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VhistoryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VhistoryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VhistoryDelete", $this->getUrlParm());
    }

 ...
 * Page class
 */
class RegPeriksaDelete extends RegPeriksa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RegPeriksaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RegPeriksaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("RegPeriksaList"); // Return to list
                return;
            }
        }

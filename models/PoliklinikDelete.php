 ...
 * Page class
 */
class PoliklinikDelete extends Poliklinik
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PoliklinikDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PoliklinikList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PoliklinikList"); // Return to list
                return;
            }
        }

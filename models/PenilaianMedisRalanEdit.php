 ...
 * Page class
 */
class PenilaianMedisRalanEdit extends PenilaianMedisRalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenilaianMedisRalanEdit";
    ...
    public function run()
    {
        ...
        $this->no_rawat->Required = false;
        $this->kd_dokter->Required = false;
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("id_penilaian_medis_ralan") ?? Key(0) ?? Route(2)) !== null) {
                $this->id_penilaian_medis_ralan->setQueryStringValue($keyValue);
                $this->id_penilaian_medis_ralan->setOldValue($this->id_penilaian_medis_ralan->QueryStringValue);
            } elseif (Post("id_penilaian_medis_ralan") !== null) {
                $this->id_penilaian_medis_ralan->setFormValue(Post("id_penilaian_medis_ralan"));
                $this->id_penilaian_medis_ralan->setOldValue($this->id_penilaian_medis_ralan->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->id_penilaian_medis_ralan->IsDetailKey) {

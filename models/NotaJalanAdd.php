 ...
 * Page class
 */
class NotaJalanAdd extends NotaJalan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "NotaJalanAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "NotaJalanView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->no_nota->CurrentValue = null;
        $this->no_nota->OldValue = $this->no_nota->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['no_nota'] = $this->no_nota->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->no_nota->CurrentValue != "") { // Check field with unique index
            $filter = "(`no_nota` = '" . AdjustSql($this->no_nota->CurrentValue, $this->Dbid) . "')";
        ...
        // no_nota
        $this->no_nota->setDbValueDef($rsnew, $this->no_nota->CurrentValue, null, false);

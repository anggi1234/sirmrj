...
class Pasien extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // id_pasien
        $this->id_pasien = new DbField('pasien', 'pasien', 'x_id_pasien', 'id_pasien', '`id_pasien`', '`id_pasien`', 3, 255, -1, false, '`id_pasien`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_rkm_medis
        $this->no_rkm_medis = new DbField('pasien', 'pasien', 'x_no_rkm_medis', 'no_rkm_medis', '`no_rkm_medis`', '`no_rkm_medis`', 200, 15, -1, false, '`no_rkm_medis`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nm_pasien
        $this->nm_pasien = new DbField('pasien', 'pasien', 'x_nm_pasien', 'nm_pasien', '`nm_pasien`', '`nm_pasien`', 200, 40, -1, false, '`nm_pasien`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_ktp
        $this->no_ktp = new DbField('pasien', 'pasien', 'x_no_ktp', 'no_ktp', '`no_ktp`', '`no_ktp`', 200, 20, -1, false, '`no_ktp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jk
        $this->jk = new DbField('pasien', 'pasien', 'x_jk', 'jk', '`jk`', '`jk`', 202, 1, -1, false, '`jk`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->jk->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->jk->Lookup = new Lookup('jk', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->jk->Lookup = new Lookup('jk', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // tmp_lahir
        $this->tmp_lahir = new DbField('pasien', 'pasien', 'x_tmp_lahir', 'tmp_lahir', '`tmp_lahir`', '`tmp_lahir`', 200, 15, -1, false, '`tmp_lahir`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tgl_lahir
        $this->tgl_lahir = new DbField('pasien', 'pasien', 'x_tgl_lahir', 'tgl_lahir', '`tgl_lahir`', CastDateFieldForLike("`tgl_lahir`", 7, "DB"), 133, 10, 7, false, '`tgl_lahir`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nm_ibu
        $this->nm_ibu = new DbField('pasien', 'pasien', 'x_nm_ibu', 'nm_ibu', '`nm_ibu`', '`nm_ibu`', 200, 40, -1, false, '`nm_ibu`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // alamat
        $this->alamat = new DbField('pasien', 'pasien', 'x_alamat', 'alamat', '`alamat`', '`alamat`', 200, 200, -1, false, '`alamat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->alamat->Sortable = true; // Allow sort
        $this->alamat->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->alamat->Param, "CustomMsg");
        $this->Fields['alamat'] = &$this->alamat;

        // gol_darah
        $this->gol_darah = new DbField('pasien', 'pasien', 'x_gol_darah', 'gol_darah', '`gol_darah`', '`gol_darah`', 202, 2, -1, false, '`gol_darah`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->gol_darah->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->gol_darah->Lookup = new Lookup('gol_darah', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->gol_darah->Lookup = new Lookup('gol_darah', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // pekerjaan
        $this->pekerjaan = new DbField('pasien', 'pasien', 'x_pekerjaan', 'pekerjaan', '`pekerjaan`', '`pekerjaan`', 200, 60, -1, false, '`pekerjaan`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // stts_nikah
        $this->stts_nikah = new DbField('pasien', 'pasien', 'x_stts_nikah', 'stts_nikah', '`stts_nikah`', '`stts_nikah`', 202, 13, -1, false, '`stts_nikah`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->stts_nikah->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->stts_nikah->Lookup = new Lookup('stts_nikah', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->stts_nikah->Lookup = new Lookup('stts_nikah', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // agama
        $this->agama = new DbField('pasien', 'pasien', 'x_agama', 'agama', '`agama`', '`agama`', 3, 2, -1, false, '`agama`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->agama->Lookup = new Lookup('agama', 'agama', false, 'id_agama', ["agama","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->agama->Lookup = new Lookup('agama', 'agama', false, 'id_agama', ["agama","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // tgl_daftar
        $this->tgl_daftar = new DbField('pasien', 'pasien', 'x_tgl_daftar', 'tgl_daftar', '`tgl_daftar`', CastDateFieldForLike("`tgl_daftar`", 0, "DB"), 133, 10, 0, false, '`tgl_daftar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_tlp
        $this->no_tlp = new DbField('pasien', 'pasien', 'x_no_tlp', 'no_tlp', '`no_tlp`', '`no_tlp`', 200, 40, -1, false, '`no_tlp`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // umur
        $this->umur = new DbField('pasien', 'pasien', 'x_umur', 'umur', '`umur`', '`umur`', 200, 30, -1, false, '`umur`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // pnd
        $this->pnd = new DbField('pasien', 'pasien', 'x_pnd', 'pnd', '`pnd`', '`pnd`', 202, 14, -1, false, '`pnd`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->pnd->Required = true; // Required field
        $this->pnd->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->pnd->Lookup = new Lookup('pnd', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->pnd->Lookup = new Lookup('pnd', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // keluarga
        $this->keluarga = new DbField('pasien', 'pasien', 'x_keluarga', 'keluarga', '`keluarga`', '`keluarga`', 202, 7, -1, false, '`keluarga`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->keluarga->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->keluarga->Lookup = new Lookup('keluarga', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->keluarga->Lookup = new Lookup('keluarga', 'pasien', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // namakeluarga
        $this->namakeluarga = new DbField('pasien', 'pasien', 'x_namakeluarga', 'namakeluarga', '`namakeluarga`', '`namakeluarga`', 200, 50, -1, false, '`namakeluarga`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_pj
        $this->kd_pj = new DbField('pasien', 'pasien', 'x_kd_pj', 'kd_pj', '`kd_pj`', '`kd_pj`', 200, 3, -1, false, '`kd_pj`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // no_peserta
        $this->no_peserta = new DbField('pasien', 'pasien', 'x_no_peserta', 'no_peserta', '`no_peserta`', '`no_peserta`', 200, 25, -1, false, '`no_peserta`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_kel
        $this->kd_kel = new DbField('pasien', 'pasien', 'x_kd_kel', 'kd_kel', '`kd_kel`', '`kd_kel`', 3, 11, -1, false, '`kd_kel`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kd_kec
        $this->kd_kec = new DbField('pasien', 'pasien', 'x_kd_kec', 'kd_kec', '`kd_kec`', '`kd_kec`', 3, 11, -1, false, '`kd_kec`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kd_kab
        $this->kd_kab = new DbField('pasien', 'pasien', 'x_kd_kab', 'kd_kab', '`kd_kab`', '`kd_kab`', 3, 11, -1, false, '`kd_kab`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kd_prop
        $this->kd_prop = new DbField('pasien', 'pasien', 'x_kd_prop', 'kd_prop', '`kd_prop`', '`kd_prop`', 3, 11, -1, false, '`kd_prop`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // pekerjaanpj
        $this->pekerjaanpj = new DbField('pasien', 'pasien', 'x_pekerjaanpj', 'pekerjaanpj', '`pekerjaanpj`', '`pekerjaanpj`', 200, 35, -1, false, '`pekerjaanpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // alamatpj
        $this->alamatpj = new DbField('pasien', 'pasien', 'x_alamatpj', 'alamatpj', '`alamatpj`', '`alamatpj`', 200, 100, -1, false, '`alamatpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kelurahanpj
        $this->kelurahanpj = new DbField('pasien', 'pasien', 'x_kelurahanpj', 'kelurahanpj', '`kelurahanpj`', '`kelurahanpj`', 200, 60, -1, false, '`kelurahanpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kecamatanpj
        $this->kecamatanpj = new DbField('pasien', 'pasien', 'x_kecamatanpj', 'kecamatanpj', '`kecamatanpj`', '`kecamatanpj`', 200, 60, -1, false, '`kecamatanpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kabupatenpj
        $this->kabupatenpj = new DbField('pasien', 'pasien', 'x_kabupatenpj', 'kabupatenpj', '`kabupatenpj`', '`kabupatenpj`', 200, 60, -1, false, '`kabupatenpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // perusahaan_pasien
        $this->perusahaan_pasien = new DbField('pasien', 'pasien', 'x_perusahaan_pasien', 'perusahaan_pasien', '`perusahaan_pasien`', '`perusahaan_pasien`', 200, 8, -1, false, '`perusahaan_pasien`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // suku_bangsa
        $this->suku_bangsa = new DbField('pasien', 'pasien', 'x_suku_bangsa', 'suku_bangsa', '`suku_bangsa`', '`suku_bangsa`', 3, 11, -1, false, '`suku_bangsa`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // bahasa_pasien
        $this->bahasa_pasien = new DbField('pasien', 'pasien', 'x_bahasa_pasien', 'bahasa_pasien', '`bahasa_pasien`', '`bahasa_pasien`', 3, 11, -1, false, '`bahasa_pasien`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // cacat_fisik
        $this->cacat_fisik = new DbField('pasien', 'pasien', 'x_cacat_fisik', 'cacat_fisik', '`cacat_fisik`', '`cacat_fisik`', 3, 11, -1, false, '`cacat_fisik`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // email
        $this->_email = new DbField('pasien', 'pasien', 'x__email', 'email', '`email`', '`email`', 200, 50, -1, false, '`email`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // nip
        $this->nip = new DbField('pasien', 'pasien', 'x_nip', 'nip', '`nip`', '`nip`', 200, 30, -1, false, '`nip`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // propinsipj
        $this->propinsipj = new DbField('pasien', 'pasien', 'x_propinsipj', 'propinsipj', '`propinsipj`', '`propinsipj`', 200, 30, -1, false, '`propinsipj`', false, false, false, 'FORMATTED TEXT', 'TEXT');

 ...
 * Page class
 */
class DiagnosaPasienDelete extends DiagnosaPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DiagnosaPasienDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DiagnosaPasienList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DiagnosaPasienList"); // Return to list
                return;
            }
        }

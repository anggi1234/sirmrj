 ...
 * Page class
 */
class PasienKunjunganPreview extends PasienKunjungan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PasienKunjunganPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "vriwayat") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=vriwayat&" . GetForeignKeyUrl("fk_no_rkm_medis", $this->no_rkm_medis->QueryStringValue) . "";
        }
        return $url;
    }

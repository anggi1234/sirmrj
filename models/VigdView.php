...
class VigdView extends Vigd
{
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_reg") ?? Route("id_reg")) !== null) {
                ...
                $returnUrl = "VigdList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VigdList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VigdList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PenilaianAwalKeperawatanRalanList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("CatatanMedisList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PenilaianMedisRalanList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PenilaianAwalKeperawatanRalanPsikiatriList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PenilaianPsikologiList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("DiagnosaPasienList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("TindakLanjutList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("PemeriksaanRalanList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_id_reg", $this->id_reg->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("VhistoryList?" . Config("TABLE_SHOW_MASTER") . "=vigd&" . GetForeignKeyUrl("fk_no_rkm_medis", $this->no_rkm_medis->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";

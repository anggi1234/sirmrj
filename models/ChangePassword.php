...
class ChangePassword extends Userlogin
{
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("userlogin", "userlogin", "opwd", "opwd", "opwd", "", 202, 255, 0, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-control");
        $this->NewPassword = new DbField("userlogin", "userlogin", "npwd", "npwd", "npwd", "", 202, 255, 0, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-control");
        $this->ConfirmPassword = new DbField("userlogin", "userlogin", "cpwd", "cpwd", "cpwd", "", 202, 255, 0, false, "", false, false, false);

 ...
 * Page class
 */
class MasterPasienEdit extends MasterPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MasterPasienEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // no_identitas_lain
            $this->no_identitas_lain->setDbValueDef($rsnew, $this->no_identitas_lain->CurrentValue, null, $this->no_identitas_lain->ReadOnly);
            ...
            // suku
            $this->suku->setDbValueDef($rsnew, $this->suku->CurrentValue, null, $this->suku->ReadOnly);

            // bahasa
            $this->bahasa->setDbValueDef($rsnew, $this->bahasa->CurrentValue, null, $this->bahasa->ReadOnly);
            ...
            // keluarahan_desa
            $this->keluarahan_desa->setDbValueDef($rsnew, $this->keluarahan_desa->CurrentValue, null, $this->keluarahan_desa->ReadOnly);

            // kecamatan
            $this->kecamatan->setDbValueDef($rsnew, $this->kecamatan->CurrentValue, null, $this->kecamatan->ReadOnly);

            // kabupaten_kota
            $this->kabupaten_kota->setDbValueDef($rsnew, $this->kabupaten_kota->CurrentValue, null, $this->kabupaten_kota->ReadOnly);
            ...
            // negara
            $this->negara->setDbValueDef($rsnew, $this->negara->CurrentValue, null, $this->negara->ReadOnly);

            // alamat_domisili
            $this->alamat_domisili->setDbValueDef($rsnew, $this->alamat_domisili->CurrentValue, null, $this->alamat_domisili->ReadOnly);

            // rt_domisili
            $this->rt_domisili->setDbValueDef($rsnew, $this->rt_domisili->CurrentValue, null, $this->rt_domisili->ReadOnly);

            // rw_domisili
            $this->rw_domisili->setDbValueDef($rsnew, $this->rw_domisili->CurrentValue, null, $this->rw_domisili->ReadOnly);

            // kel_desa_domisili
            $this->kel_desa_domisili->setDbValueDef($rsnew, $this->kel_desa_domisili->CurrentValue, null, $this->kel_desa_domisili->ReadOnly);

            // kec_domisili
            $this->kec_domisili->setDbValueDef($rsnew, $this->kec_domisili->CurrentValue, null, $this->kec_domisili->ReadOnly);

            // kota_kab_domisili
            $this->kota_kab_domisili->setDbValueDef($rsnew, $this->kota_kab_domisili->CurrentValue, null, $this->kota_kab_domisili->ReadOnly);

            // kodepos_domisili
            $this->kodepos_domisili->setDbValueDef($rsnew, $this->kodepos_domisili->CurrentValue, null, $this->kodepos_domisili->ReadOnly);

            // prov_domisili
            $this->prov_domisili->setDbValueDef($rsnew, $this->prov_domisili->CurrentValue, null, $this->prov_domisili->ReadOnly);

            // negara_domisili
            $this->negara_domisili->setDbValueDef($rsnew, $this->negara_domisili->CurrentValue, null, $this->negara_domisili->ReadOnly);
            ...
            // status_kawin
            $this->status_kawin->setDbValueDef($rsnew, $this->status_kawin->CurrentValue, null, $this->status_kawin->ReadOnly);

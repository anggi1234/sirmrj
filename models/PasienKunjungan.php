...
/**
 * Table class for pasien_kunjungan
 */
class PasienKunjungan extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pasien_kunjungan';
        $this->TableName = 'pasien_kunjungan';
        ...
        // id_reg
        $this->id_reg = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_id_reg', 'id_reg', '`id_reg`', '`id_reg`', 3, 11, -1, false, '`id_reg`', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_rkm_medis
        $this->no_rkm_medis = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_no_rkm_medis', 'no_rkm_medis', '`no_rkm_medis`', '`no_rkm_medis`', 200, 15, -1, false, '`no_rkm_medis`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // no_reg
        $this->no_reg = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_no_reg', 'no_reg', '`no_reg`', '`no_reg`', 200, 8, -1, false, '`no_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // no_rawat
        $this->no_rawat = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_no_rawat', 'no_rawat', '`no_rawat`', '`no_rawat`', 200, 17, -1, false, '`no_rawat`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // kd_poli
        $this->kd_poli = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_kd_poli', 'kd_poli', '`kd_poli`', '`kd_poli`', 200, 5, -1, false, '`kd_poli`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // kd_dokter
        $this->kd_dokter = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_kd_dokter', 'kd_dokter', '`kd_dokter`', '`kd_dokter`', 200, 20, -1, false, '`kd_dokter`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->kd_dokter->Lookup = new Lookup('kd_dokter', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->kd_dokter->Lookup = new Lookup('kd_dokter', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // tgl_registrasi
        $this->tgl_registrasi = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_tgl_registrasi', 'tgl_registrasi', '`tgl_registrasi`', CastDateFieldForLike("`tgl_registrasi`", 7, "DB"), 133, 10, 7, false, '`tgl_registrasi`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // jam_reg
        $this->jam_reg = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_jam_reg', 'jam_reg', '`jam_reg`', CastDateFieldForLike("`jam_reg`", 4, "DB"), 134, 10, 4, false, '`jam_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // p_jawab
        $this->p_jawab = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_p_jawab', 'p_jawab', '`p_jawab`', '`p_jawab`', 200, 100, -1, false, '`p_jawab`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // almt_pj
        $this->almt_pj = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_almt_pj', 'almt_pj', '`almt_pj`', '`almt_pj`', 200, 200, -1, false, '`almt_pj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // hubunganpj
        $this->hubunganpj = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_hubunganpj', 'hubunganpj', '`hubunganpj`', '`hubunganpj`', 200, 20, -1, false, '`hubunganpj`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // biaya_reg
        $this->biaya_reg = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_biaya_reg', 'biaya_reg', '`biaya_reg`', '`biaya_reg`', 5, 22, -1, false, '`biaya_reg`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // stts
        $this->stts = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_stts', 'stts', '`stts`', '`stts`', 202, 15, -1, false, '`stts`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->stts->Lookup = new Lookup('stts', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->stts->Lookup = new Lookup('stts', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // stts_daftar
        $this->stts_daftar = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_stts_daftar', 'stts_daftar', '`stts_daftar`', '`stts_daftar`', 202, 4, -1, false, '`stts_daftar`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->stts_daftar->Lookup = new Lookup('stts_daftar', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->stts_daftar->Lookup = new Lookup('stts_daftar', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_lanjut
        $this->status_lanjut = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_status_lanjut', 'status_lanjut', '`status_lanjut`', '`status_lanjut`', 202, 5, -1, false, '`status_lanjut`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->status_lanjut->Lookup = new Lookup('status_lanjut', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_lanjut->Lookup = new Lookup('status_lanjut', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // kd_pj
        $this->kd_pj = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_kd_pj', 'kd_pj', '`kd_pj`', '`kd_pj`', 200, 3, -1, false, '`kd_pj`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // umurdaftar
        $this->umurdaftar = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_umurdaftar', 'umurdaftar', '`umurdaftar`', '`umurdaftar`', 3, 11, -1, false, '`umurdaftar`', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sttsumur
        $this->sttsumur = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_sttsumur', 'sttsumur', '`sttsumur`', '`sttsumur`', 202, 2, -1, false, '`sttsumur`', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->sttsumur->Lookup = new Lookup('sttsumur', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->sttsumur->Lookup = new Lookup('sttsumur', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_bayar
        $this->status_bayar = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_status_bayar', 'status_bayar', '`status_bayar`', '`status_bayar`', 202, 11, -1, false, '`status_bayar`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_bayar->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_bayar->Lookup = new Lookup('status_bayar', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_bayar->Lookup = new Lookup('status_bayar', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // status_poli
        $this->status_poli = new DbField('pasien_kunjungan', 'pasien_kunjungan', 'x_status_poli', 'status_poli', '`status_poli`', '`status_poli`', 202, 11, -1, false, '`status_poli`', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->status_poli->Sortable = true; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->status_poli->Lookup = new Lookup('status_poli', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->status_poli->Lookup = new Lookup('status_poli', 'pasien_kunjungan', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
    ...
    public function getMasterFilter()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "vriwayat") {
    ...
    public function getDetailFilter()
    {
        ...
        if ($this->getCurrentMasterTable() == "vriwayat") {
            if ($this->no_rkm_medis->getSessionValue() != "") {
                $detailFilter .= "" . GetForeignKeySql("`no_rkm_medis`", $this->no_rkm_medis->getSessionValue(), DATATYPE_STRING, "DB");
            } else {
                return "";
            }
        }
    ...
    // Master filter
    public function sqlMasterFilter_vriwayat()
    {
        return "`no_rkm_medis`='@no_rkm_medis@'";
    }
    // Detail filter
    public function sqlDetailFilter_vriwayat()
    {
        return "`no_rkm_medis`='@no_rkm_medis@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PasienKunjunganList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PasienKunjunganEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PasienKunjunganAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PasienKunjunganView";
            case Config("API_ADD_ACTION"):
                return "PasienKunjunganAdd";
            case Config("API_EDIT_ACTION"):
                return "PasienKunjunganEdit";
            case Config("API_DELETE_ACTION"):
                return "PasienKunjunganDelete";
            case Config("API_LIST_ACTION"):
                return "PasienKunjunganList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PasienKunjunganView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PasienKunjunganView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PasienKunjunganAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PasienKunjunganAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PasienKunjunganEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PasienKunjunganAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PasienKunjunganDelete", $this->getUrlParm());
    }

    // Add master url
    public function addMasterUrl($url)
    {
        if ($this->getCurrentMasterTable() == "vriwayat" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {

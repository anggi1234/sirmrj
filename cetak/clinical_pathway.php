...
<body>
    <table width="100%" border="0" cellpadding="-3px" cellspacing="0px">
        <tr>
            <td width="10%" rowspan="3" align="right"><img src="http://localhost/sirmrj/images/hospital.png" height="70px" /></td>
            <td width="90%" align="center" style="font-size: 16px">CLINICAL PATHWAY</td>
        </tr>
        <tr>
            <td align="center"><strong style="font-size: 21px">RUMAH SAKIT X</strong></td>
        </tr>
    </table>
    <hr>

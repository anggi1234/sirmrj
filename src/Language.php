...
class Language
{
    ...
    public function languageLoad()
    {
        ...
        if (CurrentLanguageID() == "en") {
    			$this->setPhrase("AddBtn", "Tambah");
    			$this->setPhrase("SaveBtn", "Simpan");
    			$this->setPhrase("CancelBtn", "Batal");
    			$this->setPhrase("SearchBtn", "Cari");
    			$this->setPhrase("MasterDetailViewLink", "LIHAT DATA");
    			$this->setPhrase("MasterDetailEditLink", "UBAH DATA");
    			$this->setPhrase("SelectBtn", "Pilih");
    	}
    }
}

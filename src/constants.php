...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "17.0.15");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "project4sikdec"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{32D7105C-03CC-4C1F-9991-3D2A48D20516}"); // Project ID
